|	$NetBSD: slogn.sa,v 1.5 2021/12/05 03:10:53 msaitoh Exp $
...
BOUNDS1:
	.long	0x3FFEF07D,0x3FFF8841
BOUNDS2:
	.long	0x3FFE8000,0x3FFFC000
...
|----Note that this code assumes the denormalized input is NON-ZERO.
	...
	clrl	%D3		|...%D3 is exponent of smallest norm. #
	movel	%A0@(4),%D4
...
|--A FINITE, NON-ZERO, NORMALIZED NUMBER.
	...
	tstl	%D0		|...CHECK IF X IS NEGATIVE
...
|--WHILE THE CONVERSION IS GOING ON, WE GET F AND ADDRESS OF 1/F
	...
	clrl	%a6@(F+8)
	fsubx	%a6@(F),%FP0		|...Y-F
	fmovemx	%FP2/%fp3,%sp@-		|...SAVE %FP2 WHILE %FP0 IS NOT READY
...
|--AN RE-ENTRY POINT FOR LOGNP1
	...
	fmovex	%FP1,%a6@(KLOG2)		|...PUT K*LOG2 IN MEMORY, FREE %FP1
...
|--[U + V*(%A1+V*(%A3+V*%A5))]  +  [U*V*(%A2+V*(%A4+V*%A6))]
	...
	fmovemx	%sp@+,%FP2/%fp3		|...RESTORE %FP2
...
|--U + U*V*(  [B1 + W*(B3 + W*B5)]  +  [V*(B2 + W*B4)]  )
	...
	fmovemx	%sp@+,%FP2/%fp3		|...%FP2 RESTORED
