...
enum opt_code
{
  ...
  OPT_cpp = 758,                             /* -cpp */
  OPT_cpp_ = 759,                            /* -cpp= */
  OPT_cxx_isystem = 760,                     /* -cxx-isystem */
  OPT_d = 761,                               /* -d */
  ...
  OPT_fdebug_regex_map_ = 919,               /* -fdebug-regex-map= */
  ...
  OPT_fgraphite = 1060,                      /* -fgraphite */
  OPT_fgraphite_identity = 1061,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1062,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1063,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1064, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1065, */                    /* -fhelp */
  /* OPT_fhelp_ = 1066, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1067,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1068,                     /* -fhonor-std */
  OPT_fhosted = 1069,                        /* -fhosted */
  OPT_fhuge_objects = 1070,                  /* -fhuge-objects */
  OPT_fident = 1071,                         /* -fident */
  OPT_fif_conversion = 1072,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1073,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1074,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1075,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1076,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1077,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1078,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1079,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1080,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1081,               /* -finit-character= */
  OPT_finit_derived = 1082,                  /* -finit-derived */
  OPT_finit_integer_ = 1083,                 /* -finit-integer= */
  OPT_finit_local_zero = 1084,               /* -finit-local-zero */
  OPT_finit_logical_ = 1085,                 /* -finit-logical= */
  OPT_finit_real_ = 1086,                    /* -finit-real= */
  OPT_finline = 1087,                        /* -finline */
  OPT_finline_arg_packing = 1088,            /* -finline-arg-packing */
  OPT_finline_atomics = 1089,                /* -finline-atomics */
  OPT_finline_functions = 1090,              /* -finline-functions */
  OPT_finline_functions_called_once = 1091,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1092, */           /* -finline-limit- */
  OPT_finline_limit_ = 1093,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1094,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1095,        /* -finline-small-functions */
  OPT_finput_charset_ = 1096,                /* -finput-charset= */
  OPT_finstrument_functions = 1097,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1098,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1099,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1100,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1101,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1102,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1103,                    /* -finvariants */
  OPT_fipa_bit_cp = 1104,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1105,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1106, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1107,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1108,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1109,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1110,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1111, */        /* -fipa-matrix-reorg */
  OPT_fipa_profile = 1112,                   /* -fipa-profile */
  OPT_fipa_pta = 1113,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1114,                /* -fipa-pure-const */
  OPT_fipa_ra = 1115,                        /* -fipa-ra */
  OPT_fipa_reference = 1116,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1117,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1118,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1119,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1120, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1121,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1122,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1123,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1124,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1125,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1126,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1127,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1128,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1129,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1130,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1131,              /* -fivar-visibility= */
  OPT_fivopts = 1132,                        /* -fivopts */
  OPT_fjump_tables = 1133,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1134,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1135,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1136,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1137,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1138,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1139,                     /* -flabels-ok */
  OPT_flax_vector_conversions = 1140,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1141,            /* -fleading-underscore */
  OPT_flifetime_dse = 1142,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1143,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1144,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1145,                /* -flinker-output= */
  /* OPT_flive_patching = 1146, */           /* -flive-patching */
  OPT_flive_patching_ = 1147,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1148,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1149,                   /* -flocal-ivars */
  /* OPT_floop_block = 1150, */              /* -floop-block */
  /* OPT_floop_flatten = 1151, */            /* -floop-flatten */
  OPT_floop_interchange = 1152,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1153,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1154, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1155,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1156, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1157,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1158,                     /* -flra-remat */
  OPT_flto = 1159,                           /* -flto */
  OPT_flto_compression_level_ = 1160,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1161, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1162,                /* -flto-partition= */
  OPT_flto_report = 1163,                    /* -flto-report */
  OPT_flto_report_wpa = 1164,                /* -flto-report-wpa */
  OPT_flto_ = 1165,                          /* -flto= */
  OPT_fltrans = 1166,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1167,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1168,             /* -fmacro-prefix-map= */
  OPT_fmain = 1169,                          /* -fmain */
  OPT_fmath_errno = 1170,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1171,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1172,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1173,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1174,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1175,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1176,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1177,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1178,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1179,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1180,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1181,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1182,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1183,                  /* -fmodule-file= */
  OPT_fmodule_private = 1184,                /* -fmodule-private */
  OPT_fmoduleinfo = 1185,                    /* -fmoduleinfo */
  OPT_fmodulo_sched = 1186,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1187,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1188,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1189,                 /* -fms-extensions */
  OPT_fmudflap = 1190,                       /* -fmudflap */
  OPT_fmudflapir = 1191,                     /* -fmudflapir */
  OPT_fmudflapth = 1192,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1193,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1194,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1195,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1196,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1197,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1198,                 /* -fnil-receivers */
  OPT_fnon_call_exceptions = 1199,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1200,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1201,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1202,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1203,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1204,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1205,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1206,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1207,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1208,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1209,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1210,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1211,                  /* -foffload-abi= */
  OPT_foffload_ = 1212,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1213,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1214,                         /* -fonly= */
  OPT_fopenacc = 1215,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1216,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1217,                        /* -fopenmp */
  OPT_fopenmp_simd = 1218,                   /* -fopenmp-simd */
  OPT_foperator_names = 1219,                /* -foperator-names */
  OPT_fopt_info = 1220,                      /* -fopt-info */
  OPT_fopt_info_ = 1221,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1222, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1223,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1224,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1225, */          /* -foptional-diags */
  OPT_fpack_derived = 1226,                  /* -fpack-derived */
  OPT_fpack_struct = 1227,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1228,                  /* -fpack-struct= */
  OPT_fpad_source = 1229,                    /* -fpad-source */
  OPT_fpartial_inlining = 1230,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1231,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1232,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1233,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1234,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1235,                    /* -fpeel-loops */
  OPT_fpeephole = 1236,                      /* -fpeephole */
  OPT_fpeephole2 = 1237,                     /* -fpeephole2 */
  OPT_fpermissive = 1238,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1239,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1240,                           /* -fpic */
  OPT_fpie = 1241,                           /* -fpie */
  OPT_fplan9_extensions = 1242,              /* -fplan9-extensions */
  OPT_fplt = 1243,                           /* -fplt */
  OPT_fplugin_arg_ = 1244,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1245,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1246,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1247,                /* -fpostconditions */
  OPT_fpre_include_ = 1248,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1249,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1250,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1251,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1252,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1253,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1254,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1255,           /* -fprintf-return-value */
  OPT_fprofile = 1256,                       /* -fprofile */
  OPT_fprofile_abs_path = 1257,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1258,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1259,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1260,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1261,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1262,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1263,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1264,             /* -fprofile-generate= */
  OPT_fprofile_note_ = 1265,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1266,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_path_ = 1267,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1268,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1269,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1270,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1271,               /* -fprofile-update= */
  OPT_fprofile_use = 1272,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1273,                  /* -fprofile-use= */
  OPT_fprofile_values = 1274,                /* -fprofile-values */
  OPT_fprotect_parens = 1275,                /* -fprotect-parens */
  OPT_frandom_seed = 1276,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1277,                  /* -frandom-seed= */
  OPT_frange_check = 1278,                   /* -frange-check */
  OPT_freal_4_real_10 = 1279,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1280,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1281,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1282,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1283,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1284,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1285,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1286,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1287,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1288,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1289,               /* -frecord-marker=8 */
  OPT_frecursive = 1290,                     /* -frecursive */
  OPT_free = 1291,                           /* -free */
  OPT_freg_struct_return = 1292,             /* -freg-struct-return */
  /* OPT_fregmove = 1293, */                 /* -fregmove */
  OPT_frelease = 1294,                       /* -frelease */
  OPT_frename_registers = 1295,              /* -frename-registers */
  OPT_freorder_blocks = 1296,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1297,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1298,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1299,             /* -freorder-functions */
  OPT_frepack_arrays = 1300,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1301,          /* -freplace-objc-classes */
  OPT_frepo = 1302,                          /* -frepo */
  OPT_freport_bug = 1303,                    /* -freport-bug */
  OPT_frerun_cse_after_loop = 1304,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1305, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1306,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1307,                   /* -fresolution= */
  OPT_frounding_math = 1308,                 /* -frounding-math */
  OPT_frtti = 1309,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1310,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1311,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1312,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1313,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1314,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1315,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1316,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1317,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1318, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1319,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1320,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1321,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1322,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1323,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1324,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1325,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1326,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1327,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1328,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1329,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1330,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1331,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1332,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1333,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1334,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1335, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1336,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1337,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1338,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1339,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1340,               /* -fsection-anchors */
  /* OPT_fsee = 1341, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1342,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1343,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1344,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1345,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1346,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1347,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1348,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1349,                   /* -fshort-enums */
  OPT_fshort_wchar = 1350,                   /* -fshort-wchar */
  OPT_fshow_column = 1351,                   /* -fshow-column */
  OPT_fshrink_wrap = 1352,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1353,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1354,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1355,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1356,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1357,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1358,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1359,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1360,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1361,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1362,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1363,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1364,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1365,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1366,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1367,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1368,                      /* -fsquangle */
  OPT_fssa_backprop = 1369,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1370,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1371,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1372,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1373, */             /* -fstack-check */
  OPT_fstack_check_ = 1374,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1375,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1376,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1377,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1378,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1379,               /* -fstack-protector */
  OPT_fstack_protector_all = 1380,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1381,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1382,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1383,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1384,                   /* -fstack-usage */
  OPT_fstats = 1385,                         /* -fstats */
  OPT_fstdarg_opt = 1386,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1387,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1388, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1389,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1390,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1391,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1392,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1393,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1394, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1395,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1396,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1397,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1398,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1399,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1400, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1401,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1402, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1403,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1404, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1405,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1406,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1407,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1408,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1409,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1410,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1411,                   /* -ftime-report */
  OPT_ftime_report_details = 1412,           /* -ftime-report-details */
  OPT_ftls_model_ = 1413,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1414,              /* -ftoplevel-reorder */
  OPT_ftracer = 1415,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1416,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1417,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1418,                   /* -ftrampolines */
  OPT_ftransition_all = 1419,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1420,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1421,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1422,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1423,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1424,              /* -ftransition=field */
  OPT_ftransition_import = 1425,             /* -ftransition=import */
  OPT_ftransition_nogc = 1426,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1427,                /* -ftransition=tls */
  OPT_ftrapping_math = 1428,                 /* -ftrapping-math */
  OPT_ftrapv = 1429,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1430,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1431,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1432,                      /* -ftree-ccp */
  OPT_ftree_ch = 1433,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1434, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1435,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1436,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1437, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1438,                   /* -ftree-cselim */
  OPT_ftree_dce = 1439,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1440,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1441,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1442,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1443,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1444, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1445,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1446,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1447, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1448,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1449,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1450, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1451,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1452,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1453,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1454,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1455,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1456,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1457,                      /* -ftree-pre */
  OPT_ftree_pta = 1458,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1459,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1460, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1461,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1462,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1463,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1464,                     /* -ftree-slsr */
  OPT_ftree_sra = 1465,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1466, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1467, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1468,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1469,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1470,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1471, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1472,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1473, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1474,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1475,         /* -funconstrained-commons */
  OPT_funderscoring = 1476,                  /* -funderscoring */
  OPT_funit_at_a_time = 1477,                /* -funit-at-a-time */
  OPT_funittest = 1478,                      /* -funittest */
  OPT_funroll_all_loops = 1479,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1480,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1481,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1482, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1483,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1484,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1485,                 /* -funsigned-char */
  OPT_funswitch_loops = 1486,                /* -funswitch-loops */
  OPT_funwind_tables = 1487,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1488,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1489,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1490,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1491,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1492,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1493,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1494,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1495,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1496,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1497,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1498,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1499, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1500,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1501,                   /* -fverbose-asm */
  /* OPT_fversion = 1502, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1503,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1504,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1505,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1506,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1507,                   /* -fvisibility= */
  OPT_fvpt = 1508,                           /* -fvpt */
  OPT_fvtable_gc = 1509,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1510,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1511,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1512,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1513,                     /* -fvtv-debug */
  OPT_fweak = 1514,                          /* -fweak */
  OPT_fweb = 1515,                           /* -fweb */
  /* OPT_fwhole_file = 1516, */              /* -fwhole-file */
  OPT_fwhole_program = 1517,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1518,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1519,             /* -fworking-directory */
  OPT_fwpa = 1520,                           /* -fwpa */
  OPT_fwpa_ = 1521,                          /* -fwpa= */
  OPT_fwrapv = 1522,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1523,                 /* -fwrapv-pointer */
  OPT_fxref = 1524,                          /* -fxref */
  /* OPT_fzee = 1525, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1526,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1527,                     /* -fzero-link */
  OPT_g = 1528,                              /* -g */
  OPT_gas_loc_support = 1529,                /* -gas-loc-support */
  OPT_gas_locview_support = 1530,            /* -gas-locview-support */
  OPT_gcoff = 1531,                          /* -gcoff */
  OPT_gcoff1 = 1532,                         /* -gcoff1 */
  OPT_gcoff2 = 1533,                         /* -gcoff2 */
  OPT_gcoff3 = 1534,                         /* -gcoff3 */
  OPT_gcolumn_info = 1535,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1536,                 /* -gdescribe-dies */
  OPT_gdwarf = 1537,                         /* -gdwarf */
  OPT_gdwarf_ = 1538,                        /* -gdwarf- */
  OPT_gen_decls = 1539,                      /* -gen-decls */
  OPT_ggdb = 1540,                           /* -ggdb */
  OPT_ggnu_pubnames = 1541,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1542,                   /* -gimple-stats */
  OPT_ginline_points = 1543,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1544, /* -ginternal-reset-location-views */
  OPT_gno_ = 1545,                           /* -gno- */
  OPT_gno_pubnames = 1546,                   /* -gno-pubnames */
  OPT_gpubnames = 1547,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1548,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1549,                   /* -gsplit-dwarf */
  OPT_gstabs = 1550,                         /* -gstabs */
  OPT_gstabs_ = 1551,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1552,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1553,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1554,                        /* -gtoggle */
  OPT_gvariable_location_views = 1555,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1556,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1557,                           /* -gvms */
  OPT_gxcoff = 1558,                         /* -gxcoff */
  OPT_gxcoff_ = 1559,                        /* -gxcoff+ */
  OPT_gz = 1560,                             /* -gz */
  OPT_gz_ = 1561,                            /* -gz= */
  OPT_h = 1562,                              /* -h */
  OPT_help = 1563,                           /* -help */
  OPT_idirafter = 1564,                      /* -idirafter */
  OPT_imacros = 1565,                        /* -imacros */
  OPT_imultiarch = 1566,                     /* -imultiarch */
  OPT_imultilib = 1567,                      /* -imultilib */
  OPT_include = 1568,                        /* -include */
  OPT_iplugindir_ = 1569,                    /* -iplugindir= */
  OPT_iprefix = 1570,                        /* -iprefix */
  OPT_iquote = 1571,                         /* -iquote */
  OPT_iremap = 1572,                         /* -iremap */
  OPT_isysroot = 1573,                       /* -isysroot */
  OPT_isystem = 1574,                        /* -isystem */
  OPT_iwithprefix = 1575,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1576,              /* -iwithprefixbefore */
  OPT_l = 1577,                              /* -l */
  OPT_lang_asm = 1578,                       /* -lang-asm */
  OPT_list = 1579,                           /* -list */
  /* OPT_m5200 = 1580, */                    /* -m5200 */
  /* OPT_m5206e = 1581, */                   /* -m5206e */
  /* OPT_m528x = 1582, */                    /* -m528x */
  /* OPT_m5307 = 1583, */                    /* -m5307 */
  /* OPT_m5407 = 1584, */                    /* -m5407 */
  /* OPT_m68000 = 1585, */                   /* -m68000 */
  /* OPT_m68010 = 1586, */                   /* -m68010 */
  /* OPT_m68020 = 1587, */                   /* -m68020 */
  OPT_m68020_40 = 1588,                      /* -m68020-40 */
  OPT_m68020_60 = 1589,                      /* -m68020-60 */
  /* OPT_m68030 = 1590, */                   /* -m68030 */
  /* OPT_m68040 = 1591, */                   /* -m68040 */
  /* OPT_m68060 = 1592, */                   /* -m68060 */
  /* OPT_m68302 = 1593, */                   /* -m68302 */
  /* OPT_m68332 = 1594, */                   /* -m68332 */
  OPT_m68851 = 1595,                         /* -m68851 */
  OPT_m68881 = 1596,                         /* -m68881 */
  OPT_malign_int = 1597,                     /* -malign-int */
  OPT_march_ = 1598,                         /* -march= */
  OPT_mbitfield = 1599,                      /* -mbitfield */
  /* OPT_mc68000 = 1600, */                  /* -mc68000 */
  /* OPT_mc68020 = 1601, */                  /* -mc68020 */
  /* OPT_mcfv4e = 1602, */                   /* -mcfv4e */
  /* OPT_mcpu32 = 1603, */                   /* -mcpu32 */
  OPT_mcpu_ = 1604,                          /* -mcpu= */
  OPT_mdiv = 1605,                           /* -mdiv */
  OPT_mfidoa = 1606,                         /* -mfidoa */
  OPT_mhard_float = 1607,                    /* -mhard-float */
  OPT_mid_shared_library = 1608,             /* -mid-shared-library */
  OPT_mlong_jump_table_offsets = 1609,       /* -mlong-jump-table-offsets */
  OPT_mnobitfield = 1610,                    /* -mnobitfield */
  OPT_mnortd = 1611,                         /* -mnortd */
  OPT_mnoshort = 1612,                       /* -mnoshort */
  OPT_mpcrel = 1613,                         /* -mpcrel */
  OPT_mrtd = 1614,                           /* -mrtd */
  OPT_msep_data = 1615,                      /* -msep-data */
  OPT_mshared_library_id_ = 1616,            /* -mshared-library-id= */
  OPT_mshort = 1617,                         /* -mshort */
  OPT_msoft_float = 1618,                    /* -msoft-float */
  OPT_mstrict_align = 1619,                  /* -mstrict-align */
  OPT_mtune_ = 1620,                         /* -mtune= */
  OPT_mxgot = 1621,                          /* -mxgot */
  OPT_mxtls = 1622,                          /* -mxtls */
  OPT_n = 1623,                              /* -n */
  ...
  OPT_nolibc = 1630,                         /* -nolibc */
  OPT_nophoboslib = 1631,                    /* -nophoboslib */
  OPT_nostartfiles = 1632,                   /* -nostartfiles */
  OPT_nostdinc = 1633,                       /* -nostdinc */
  OPT_nostdinc__ = 1634,                     /* -nostdinc++ */
  OPT_nostdlib = 1635,                       /* -nostdlib */
  OPT_o = 1636,                              /* -o */
  OPT_objects = 1637,                        /* -objects */
  OPT_p = 1638,                              /* -p */
  OPT_pass_exit_codes = 1639,                /* -pass-exit-codes */
  /* OPT_pedantic = 1640, */                 /* -pedantic */
  OPT_pedantic_errors = 1641,                /* -pedantic-errors */
  OPT_pg = 1642,                             /* -pg */
  OPT_pie = 1643,                            /* -pie */
  OPT_pipe = 1644,                           /* -pipe */
  OPT_posix = 1645,                          /* -posix */
  OPT_print_file_name_ = 1646,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1647,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1648,          /* -print-multi-directory */
  OPT_print_multi_lib = 1649,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1650,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1651,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1652,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1653,               /* -print-prog-name= */
  OPT_print_search_dirs = 1654,              /* -print-search-dirs */
  OPT_print_sysroot = 1655,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1656,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1657,                    /* -print-value */
  OPT_pthread = 1658,                        /* -pthread */
  OPT_quiet = 1659,                          /* -quiet */
  OPT_r = 1660,                              /* -r */
  OPT_rdynamic = 1661,                       /* -rdynamic */
  OPT_remap = 1662,                          /* -remap */
  OPT_reverse_sort = 1663,                   /* -reverse-sort */
  OPT_rpath_ = 1664,                         /* -rpath= */
  OPT_s = 1665,                              /* -s */
