...
#define HAVE_ATTR_mac 1
extern enum attr_mac get_attr_mac (void);

#define HAVE_ATTR_type 1
extern enum attr_type get_attr_type (rtx_insn *);

#define HAVE_ATTR_opx 1
extern int get_attr_opx (rtx_insn *);
#define HAVE_ATTR_opy 1
extern int get_attr_opy (rtx_insn *);
#define HAVE_ATTR_opy_type 1
extern enum attr_opy_type get_attr_opy_type (rtx_insn *);

#define HAVE_ATTR_opx_type 1
extern enum attr_opx_type get_attr_opx_type (rtx_insn *);

#define HAVE_ATTR_opx_access 1
extern enum attr_opx_access get_attr_opx_access (rtx_insn *);

#define HAVE_ATTR_op_mem 1
extern enum attr_op_mem get_attr_op_mem (rtx_insn *);

#define HAVE_ATTR_size 1
extern enum attr_size get_attr_size (rtx_insn *);

#define HAVE_ATTR_ok_for_coldfire 1
extern enum attr_ok_for_coldfire get_attr_ok_for_coldfire (rtx_insn *);

#define HAVE_ATTR_flags_valid 1
extern enum attr_flags_valid get_attr_flags_valid (rtx_insn *);
