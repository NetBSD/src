...
/* Define if `blocksize' is member of `struct audio_info'. */
/* #undef HAVE_STRUCT_AUDIO_INFO_BLOCKSIZE */

/* Define if `hiwat' is member of `struct audio_info'. */
/* #undef HAVE_STRUCT_AUDIO_INFO_HIWAT */

/* Define if `lowat' is member of `struct audio_info'. */
/* #undef HAVE_STRUCT_AUDIO_INFO_LOWAT */

/* Define if `mode' is member of `struct audio_info'. */
/* #undef HAVE_STRUCT_AUDIO_INFO_MODE */

/* Define if `monitor_gain' is member of `struct audio_info'. */
/* #undef HAVE_STRUCT_AUDIO_INFO_MONITOR_GAIN */

/* Define if `output_muted' is member of `struct audio_info'. */
/* #undef HAVE_STRUCT_AUDIO_INFO_OUTPUT_MUTED */
