/*	$NetBSD: coda_vnops.c,v 1.50.8.2.2.1 2007/09/03 07:04:15 wrstuden Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: coda_vnops.c,v 1.50.8.2.2.1 2007/09/03 07:04:15 wrstuden Exp $");
