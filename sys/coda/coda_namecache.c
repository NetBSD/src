/*	$NetBSD: coda_namecache.c,v 1.17.10.2 2006/05/06 23:31:25 christos Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: coda_namecache.c,v 1.17.10.2 2006/05/06 23:31:25 christos Exp $");
