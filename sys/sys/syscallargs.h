/* $NetBSD: syscallargs.h,v 1.191.2.5 2008/11/20 20:45:40 christos Exp $ */
...
check_syscall_args(sys_ntp_gettime)
...
int	sys_ntp_gettime(struct lwp *, const struct sys_ntp_gettime_args *, register_t *);
