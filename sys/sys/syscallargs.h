/* $NetBSD: syscallargs.h,v 1.139.2.8 2008/02/04 09:25:00 yamt Exp $ */
...
struct compat_40_sys_posix_fadvise_args {
	syscallarg(int) fd;
	syscallarg(off_t) offset;
	syscallarg(off_t) len;
	syscallarg(int) advice;
};
check_syscall_args(compat_40_sys_posix_fadvise)
...
int	compat_40_sys_posix_fadvise(struct lwp *, const struct compat_40_sys_posix_fadvise_args *, register_t *);
