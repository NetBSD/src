/* $NetBSD: syscallargs.h,v 1.171.4.1 2007/11/13 16:03:26 bouyer Exp $ */
...
check_syscall_args(sys_posix_fadvise)
...
int	sys__lwp_setname(struct lwp *, void *, register_t *);

int	sys__lwp_getname(struct lwp *, void *, register_t *);

int	sys__lwp_ctl(struct lwp *, void *, register_t *);
