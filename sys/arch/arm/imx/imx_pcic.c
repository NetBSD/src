/*	$Id: imx_pcic.c,v 1.1.24.1 2008/05/16 02:21:56 yamt Exp $	*/
...
/*	$NetBSD: imx_pcic.c,v 1.1.24.1 2008/05/16 02:21:56 yamt Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$Id: imx_pcic.c,v 1.1.24.1 2008/05/16 02:21:56 yamt Exp $");
