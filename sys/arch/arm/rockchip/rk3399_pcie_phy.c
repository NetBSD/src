/*	$NetBSD: rk3399_pcie_phy.c,v 1.1.4.2 2019/06/10 22:05:55 christos Exp $	*/
...
__KERNEL_RCSID(1, "$NetBSD: rk3399_pcie_phy.c,v 1.1.4.2 2019/06/10 22:05:55 christos Exp $");
