/*	$NetBSD: rk3399_pcie_phy.c,v 1.4.24.1 2025/08/02 05:55:29 perseant Exp $	*/
...
__KERNEL_RCSID(1, "$NetBSD: rk3399_pcie_phy.c,v 1.4.24.1 2025/08/02 05:55:29 perseant Exp $");
