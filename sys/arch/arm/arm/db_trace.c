/*	$NetBSD: db_trace.c,v 1.17.14.1 2014/02/15 16:18:36 matt Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: db_trace.c,v 1.17.14.1 2014/02/15 16:18:36 matt Exp $");
...
#if 1
				proc_t *p2 = p_find(addr, PFIND_LOCKED);
				if (p2 == NULL) {
					(*pr)("not found\n");
					return;
				}
				addr = (db_addr_t)LIST_FIRST(&p2->p_lwps);
#else
