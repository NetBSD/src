/*	$NetBSD: pci_machdep.h,v 1.1 2002/03/07 14:44:01 simonb Exp $	*/
 ...
 */
typedef struct evbmips_pci_chipset *pci_chipset_tag_t;
typedef u_long pcitag_t;
typedef u_long pci_intr_handle_t;
extern struct evbmips_bus_dma_tag pci_bus_dma_tag;
...
/*
 * evbmips-specific PCI structure and type definitions.
 * NOT TO BE USED DIRECTLY BY MACHINE INDEPENDENT CODE.
 */
struct evbmips_pci_chipset {
	void		*pc_conf_v;
...
/*
 * evbmips-specific PCI functions.
 * NOT TO BE USED DIRECTLY BY MACHINE INDEPENDENT CODE.
 */
#define	evbmips_pciide_compat_intr_establish(c, d, p, ch, f, a)		\
