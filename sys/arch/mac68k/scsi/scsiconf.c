...
#if !defined(OSF) && !defined(__386BSD__) && !defined(__NetBSD__)
#include "bll.h"
#include "cals.h"
#include "kil.h"
#else
...
#define	NCALS 0
#define	NKIL 0
#endif /* !defined(OSF) && !defined(__386BSD__) && !defined(__MACBSD__) */
...
knowndevs[] = {
	...
	{ T_READONLY,T_REMOV,"standard","any"
			,"any", cdattach,"cd",SC_ONE_LU },
#endif NCD
#if NBLL > 0
