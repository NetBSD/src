 ...
 *
 *	$NetBSD: loadbsd.c,v 1.13.8.1 2011/03/05 15:10:09 bouyer Exp $
 */

#include <sys/cdefs.h>

__RCSID("$NetBSD: loadbsd.c,v 1.13.8.1 2011/03/05 15:10:09 bouyer Exp $");
#define VERSION	"$Revision: 1.13.8.1 $ $Date: 2011/03/05 15:10:09 $"
