 ...
 *
 *	$NetBSD: loadbsd.c,v 1.9.78.1 2009/05/04 08:12:08 yamt Exp $
 */

#include <sys/cdefs.h>

__RCSID("$NetBSD: loadbsd.c,v 1.9.78.1 2009/05/04 08:12:08 yamt Exp $");
#define VERSION	"$Revision: 1.9.78.1 $ $Date: 2009/05/04 08:12:08 $"
