 ...
 *
 *	$NetBSD: loadbsd.c,v 1.9.86.1 2009/04/28 07:34:55 skrll Exp $
 */

#include <sys/cdefs.h>

__RCSID("$NetBSD: loadbsd.c,v 1.9.86.1 2009/04/28 07:34:55 skrll Exp $");
#define VERSION	"$Revision: 1.9.86.1 $ $Date: 2009/04/28 07:34:55 $"
