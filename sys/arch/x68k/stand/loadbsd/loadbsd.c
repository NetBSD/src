 ...
 *
 *	$NetBSD: loadbsd.c,v 1.7.2.1 2002/06/23 17:43:23 jdolecek Exp $
 */

#include <sys/cdefs.h>

__RCSID("$NetBSD: loadbsd.c,v 1.7.2.1 2002/06/23 17:43:23 jdolecek Exp $");
#define VERSION	"$Revision: 1.7.2.1 $ $Date: 2002/06/23 17:43:23 $"
