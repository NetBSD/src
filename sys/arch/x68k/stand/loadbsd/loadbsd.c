 ...
 *
 *	$NetBSD: loadbsd.c,v 1.8.24.1 2006/06/21 14:57:55 yamt Exp $
 */

#include <sys/cdefs.h>

__RCSID("$NetBSD: loadbsd.c,v 1.8.24.1 2006/06/21 14:57:55 yamt Exp $");
#define VERSION	"$Revision: 1.8.24.1 $ $Date: 2006/06/21 14:57:55 $"
