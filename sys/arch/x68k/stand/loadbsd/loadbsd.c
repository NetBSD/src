 ...
 *
 *	$NetBSD: loadbsd.c,v 1.7.8.2 2002/06/20 03:42:36 nathanw Exp $
 */

#include <sys/cdefs.h>

__RCSID("$NetBSD: loadbsd.c,v 1.7.8.2 2002/06/20 03:42:36 nathanw Exp $");
#define VERSION	"$Revision: 1.7.8.2 $ $Date: 2002/06/20 03:42:36 $"
