 ...
 *
 *	$NetBSD: loadbsd.c,v 1.13.4.1 2011/03/05 20:52:26 rmind Exp $
 */

#include <sys/cdefs.h>

__RCSID("$NetBSD: loadbsd.c,v 1.13.4.1 2011/03/05 20:52:26 rmind Exp $");
#define VERSION	"$Revision: 1.13.4.1 $ $Date: 2011/03/05 20:52:26 $"
