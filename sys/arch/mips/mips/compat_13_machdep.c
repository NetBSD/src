/*	$NetBSD: compat_13_machdep.c,v 1.10.2.2 2004/09/18 14:37:25 skrll Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.10.2.2 2004/09/18 14:37:25 skrll Exp $");
