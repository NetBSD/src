/*	$NetBSD: compat_13_machdep.c,v 1.10.2.3 2004/09/21 13:18:48 skrll Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.10.2.3 2004/09/21 13:18:48 skrll Exp $");
