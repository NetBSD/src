/*	$NetBSD: compat_13_machdep.c,v 1.14.24.1 2008/01/09 01:47:16 matt Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.14.24.1 2008/01/09 01:47:16 matt Exp $");
