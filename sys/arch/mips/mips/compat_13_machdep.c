/*	$NetBSD: compat_13_machdep.c,v 1.16.4.2 2008/05/14 01:35:00 wrstuden Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.16.4.2 2008/05/14 01:35:00 wrstuden Exp $");
