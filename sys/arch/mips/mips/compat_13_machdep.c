/*	$NetBSD: compat_13_machdep.c,v 1.19.4.1 2011/03/05 20:51:05 rmind Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.19.4.1 2011/03/05 20:51:05 rmind Exp $");
