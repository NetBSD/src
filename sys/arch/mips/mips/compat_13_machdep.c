/*	$NetBSD: compat_13_machdep.c,v 1.20.4.1 2011/03/05 15:09:49 bouyer Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.20.4.1 2011/03/05 15:09:49 bouyer Exp $");
