/*	$NetBSD: compat_13_machdep.c,v 1.11.16.1 2006/06/21 14:53:43 yamt Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.11.16.1 2006/06/21 14:53:43 yamt Exp $");
