/*	$NetBSD: compat_13_machdep.c,v 1.10.2.4 2005/11/10 13:57:33 skrll Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.10.2.4 2005/11/10 13:57:33 skrll Exp $");
