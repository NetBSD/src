/*	$NetBSD: compat_13_machdep.c,v 1.16.4.3 2008/05/14 19:54:10 wrstuden Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.16.4.3 2008/05/14 19:54:10 wrstuden Exp $");
