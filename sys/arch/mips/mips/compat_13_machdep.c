/*	$NetBSD: compat_13_machdep.c,v 1.14.36.1 2008/01/02 21:48:41 bouyer Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.14.36.1 2008/01/02 21:48:41 bouyer Exp $");
