/*	$NetBSD: compat_13_machdep.c,v 1.6.4.1 1999/06/21 00:52:05 thorpej Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.6.4.1 1999/06/21 00:52:05 thorpej Exp $");
