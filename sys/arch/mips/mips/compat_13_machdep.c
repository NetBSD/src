/*	$NetBSD: compat_13_machdep.c,v 1.8.8.4 2002/11/11 22:00:34 nathanw Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.8.8.4 2002/11/11 22:00:34 nathanw Exp $");
