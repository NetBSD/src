/*	$NetBSD: compat_13_machdep.c,v 1.22.6.1 2025/08/02 05:55:54 perseant Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.22.6.1 2025/08/02 05:55:54 perseant Exp $");
