/*	$NetBSD: elf_machdep.h,v 1.17 2025/12/01 16:39:57 jkoshy Exp $	*/
...
#define	R_PPC_ADDR14_BRTAKEN  	8	// (S + A) >> 2
#define	R_PPC_ADDR14_BRNTAKEN 	9	// (S + A) >> 2
#define	R_PPC_REL24 		10 	// (S + A - P) >> 2
#define	R_PPC_REL14 		11	// (S + A - P) >> 2
#define	R_PPC_REL14_BRTAKEN 	12	// (S + A - P) >> 2
#define	R_PPC_REL14_BRNTAKEN 	13	// (S + A - P) >> 2
...
/* PPC64 relocations */
#define R_PPC64_ADDR64		38	// S + A
#define R_PPC64_ADDR16_HIGHER	39	// #higher(S + A)
#define R_PPC64_ADDR16_HIGHERA	40	// #highera(S + A)
#define R_PPC64_ADDR16_HIGHEST	41	// #highest(S + A)
#define R_PPC64_ADDR16_HIGHESTA	42	// #highesta(S + A)
#define R_PPC64_UADDR64		43	// S + A
#define R_PPC64_REL64		44	// S + A - P
#define R_PPC64_PLT64		45	// L
#define R_PPC64_PLTREL64	46	// L - P
#define	R_PPC64_TOC16 		47	// S + A - .TOC.
#define	R_PPC64_TOC16_LO	48	// #lo(S + A - .TOC.)
#define	R_PPC64_TOC16_HI	49	// #lo(S + A - .TOC.)
#define	R_PPC64_TOC16_HA	50	// #ha(S + A - .TOC.)
#define R_PPC64_TOC		51	// .TOC.
#define	R_PPC64_PLTGOT16 	52	// M
#define	R_PPC64_PLTGOT16_LO 	53	// #lo(M)
#define	R_PPC64_PLTGOT16_HI	54	// #lo(M)
#define	R_PPC64_PLTGOT16_HA	55	// #ha(M)
#define	R_PPC64_ADDR16_DS	56	// (S + A) >> 2
#define	R_PPC64_ADDR16_LO_DS 	57	// #lo(S + A) >> 2
#define	R_PPC64_GOT16_DS 	58	// G >> 2
#define	R_PPC64_GOT16_LO_DS 	59	// #lo(G) >> 2
#define	R_PPC64_PLT16_LO_DS 	60	// #lo(L) >> 2
#define	R_PPC64_SECTOFF_DS	61	// (R + A) >> 2
#define	R_PPC64_SECTOFF_LO_DS	62	// #lo(R + A) >> 2
#define	R_PPC64_TOC16_DS	63	// (S + A - .TOC.) >> 2
#define	R_PPC64_TOC16_LO_DS 	64	// #lo(S + A - .TOC.) >> 2
#define	R_PPC64_PLTGOT16_DS	65	// M >> 2
#define	R_PPC64_PLTGOT16_LO_DS 	66	// #lo(M) >> 2
...
#define	R_PPC_DTPREL32		78	// @dtprel
...
#define	R_PPC64_TPREL16_DS	95	// @tprel
#define	R_PPC64_TPREL16_LO_DS	96	// #lo(@tprel)
#define	R_PPC64_TPREL16_HIGHER	97	// #higher(@tprel)
#define	R_PPC64_TPREL16_HIGHERA	98	// #highera(@tprel)
#define	R_PPC64_TPREL16_HIGHEST	99	// #highest(@tprel)
#define	R_PPC64_TPREL16_HIGHESTA 100	// #highesta(@tprel)

#define	R_PPC64_DTPREL16_DS	101	// @dtprel
#define	R_PPC64_DTPREL16_LO_DS	102	// #lo(@dtprel)
#define	R_PPC64_DTPREL16_HIGHER	103	// #higher(@dtprel)
#define	R_PPC64_DTPREL16_HIGHERA 104	// #highera(@dtprel)
#define	R_PPC64_DTPREL16_HIGHEST 105	// #highest(@dtprel)
#define	R_PPC64_DTPREL16_HIGHESTA 106	// #highesta(@dtprel)
...
#define	R_PPC64_REL16		249	// S + A - P
#define	R_PPC64_REL16_LO	250	// #lo(S + A - P)
#define	R_PPC64_REL16_HI	251	// #hi(S + A - P)
#define	R_PPC64_REL16_HA	252	// #ha(S + A - P)
...
/*
 * Local spellings of psABI constants.
 */
