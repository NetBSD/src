/*	$NetBSD: boca.c,v 1.1 1995/01/03 22:30:26 mycroft Exp $	*/
 ...
 *
 * The programming details of the BOCA board (i.e. how the interrupt register
 * works) were determined by David Muir Sharnoff.  BOCA Research refused to
