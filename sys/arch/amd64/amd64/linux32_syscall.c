/*	$NetBSD: linux32_syscall.c,v 1.20.2.1 2008/03/24 07:14:52 keiichi Exp $ */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscall.c,v 1.20.2.1 2008/03/24 07:14:52 keiichi Exp $");
