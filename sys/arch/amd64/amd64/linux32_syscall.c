/*	$NetBSD: linux32_syscall.c,v 1.24.4.3 2008/10/15 04:56:55 wrstuden Exp $ */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscall.c,v 1.24.4.3 2008/10/15 04:56:55 wrstuden Exp $");
