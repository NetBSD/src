/*	$NetBSD: linux32_syscall.c,v 1.13.2.1 2007/10/03 19:22:07 garbled Exp $ */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscall.c,v 1.13.2.1 2007/10/03 19:22:07 garbled Exp $");
