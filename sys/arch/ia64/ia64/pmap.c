/* $NetBSD: pmap.c,v 1.1 2006/04/07 14:21:18 cherry Exp $ */
/* This module is a mess. Need to clean up Locking, list traversal. etc....... */

#include <sys/cdefs.h>

__KERNEL_RCSID(0, "$NetBSD: pmap.c,v 1.1 2006/04/07 14:21:18 cherry Exp $");
