/* $NetBSD: asc_ioasic.c,v 1.1.2.1 1998/10/15 02:48:58 nisimura Exp $ */

#include <sys/cdefs.h>			/* RCS ID & Copyright macro defns */
__KERNEL_RCSID(0, "$NetBSD: asc_ioasic.c,v 1.1.2.1 1998/10/15 02:48:58 nisimura Exp $");
...
extern int	asc_dma_isintr __P((struct ncr53c9x_softc *sc));
