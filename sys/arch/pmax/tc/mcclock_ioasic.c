/*	$NetBSD: mcclock_ioasic.c,v 1.14.8.2 2002/10/10 18:35:10 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mcclock_ioasic.c,v 1.14.8.2 2002/10/10 18:35:10 jdolecek Exp $");
