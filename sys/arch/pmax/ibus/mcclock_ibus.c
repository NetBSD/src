/*	$NetBSD: mcclock_ibus.c,v 1.11 2002/09/27 20:34:51 thorpej Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: mcclock_ibus.c,v 1.11 2002/09/27 20:34:51 thorpej Exp $");
...
const struct cfattach mcclock_ibus_ca = {
