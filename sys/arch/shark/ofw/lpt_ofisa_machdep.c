/*	$NetBSD: lpt_ofisa_machdep.c,v 1.8.12.1 2012/11/20 03:01:42 tls Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: lpt_ofisa_machdep.c,v 1.8.12.1 2012/11/20 03:01:42 tls Exp $");
...
int
lpt_ofisa_md_match(device_t parent, cfdata_t cf, void *aux)
{
