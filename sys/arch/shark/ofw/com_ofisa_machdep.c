/*	$NetBSD: com_ofisa_machdep.c,v 1.4.88.1 2009/04/28 07:34:40 skrll Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: com_ofisa_machdep.c,v 1.4.88.1 2009/04/28 07:34:40 skrll Exp $");
...
int
com_ofisa_md_intr_fixup(struct device *parent, struct device *self, void *aux, struct ofisa_intr_desc *descp, int ndescs, int ndescsfilled)
{
