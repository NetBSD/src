/*	$NetBSD: isa_shark_machdep.c,v 1.15.18.1 2017/03/20 06:57:20 pgoyette Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: isa_shark_machdep.c,v 1.15.18.1 2017/03/20 06:57:20 pgoyette Exp $");
