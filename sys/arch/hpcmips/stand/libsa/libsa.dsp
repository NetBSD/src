...
# ADD CPP /nologo /ML /W3 /O2 /I "." /I "../../../.." /I "../include" /D _WIN32_WCE=$(CEVersion) /D "$(CEConfigName)" /D "NDEBUG" /D "MIPS" /D "_MIPS_" /D UNDER_CE=$(CEVersion) /D "UNICODE" /D "_STANDALONE" /D "__STDC__" /D "__signed=signed" /D "__INTERNAL_LIBSA_CREAD" /D "LIBSA_RENAME_PRINTF" /D "__COMPILER_INT64__=__int64" /QMRWCE /c
# SUBTRACT CPP /YX
BSC32=bscmake.exe
...
# ADD CPP /nologo /MLd /W3 /Zi /Od /I "." /I "../../../.." /I "../include" /D _WIN32_WCE=$(CEVersion) /D "$(CEConfigName)" /D "DEBUG" /D "MIPS" /D "_MIPS_" /D UNDER_CE=$(CEVersion) /D "UNICODE" /D "_STANDALONE" /D "__STDC__" /D "__signed=signed" /D "__INTERNAL_LIBSA_CREAD" /D "LIBSA_RENAME_PRINTF" /D "__COMPILER_INT64__=__int64" /QMRWCE /c
# SUBTRACT CPP /YX
BSC32=bscmake.exe
# ADD BASE BSC32 /NOLOGO
# ADD BSC32 /NOLOGO
