/* $NetBSD: dec_eb66.c,v 1.22.52.1 2009/04/28 07:33:34 skrll Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: dec_eb66.c,v 1.22.52.1 2009/04/28 07:33:34 skrll Exp $");
...
static void dec_eb66_device_register(struct device *, void *);
