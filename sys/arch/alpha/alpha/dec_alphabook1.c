/* $NetBSD: dec_alphabook1.c,v 1.10.16.1 2002/05/16 16:06:35 gehenna Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: dec_alphabook1.c,v 1.10.16.1 2002/05/16 16:06:35 gehenna Exp $");
