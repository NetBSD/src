/* $NetBSD: dec_alphabook1.c,v 1.10.2.1 2002/10/10 18:30:46 jdolecek Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: dec_alphabook1.c,v 1.10.2.1 2002/10/10 18:30:46 jdolecek Exp $");
