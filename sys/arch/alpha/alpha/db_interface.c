/* $NetBSD: db_interface.c,v 1.4.6.1.2.1 1999/06/21 00:46:02 thorpej Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: db_interface.c,v 1.4.6.1.2.1 1999/06/21 00:46:02 thorpej Exp $");
