/* $NetBSD: db_interface.c,v 1.16.4.3 2002/06/20 03:37:29 nathanw Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: db_interface.c,v 1.16.4.3 2002/06/20 03:37:29 nathanw Exp $");
