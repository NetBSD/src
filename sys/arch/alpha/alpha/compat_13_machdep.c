/* $NetBSD: compat_13_machdep.c,v 1.21.4.1 2017/08/28 17:51:27 skrll Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.21.4.1 2017/08/28 17:51:27 skrll Exp $");
