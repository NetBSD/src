/* $NetBSD: compat_13_machdep.c,v 1.20.10.1 2014/05/18 17:44:53 rmind Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.20.10.1 2014/05/18 17:44:53 rmind Exp $");
