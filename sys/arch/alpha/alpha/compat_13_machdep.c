/* $NetBSD: compat_13_machdep.c,v 1.18.10.1 2011/06/23 14:18:49 cherry Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.18.10.1 2011/06/23 14:18:49 cherry Exp $");
