/* $NetBSD: compat_13_machdep.c,v 1.17.4.1 2008/05/10 23:48:42 wrstuden Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.17.4.1 2008/05/10 23:48:42 wrstuden Exp $");
