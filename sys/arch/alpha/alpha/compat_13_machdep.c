/* $NetBSD: compat_13_machdep.c,v 1.15.32.1 2008/01/02 21:46:51 bouyer Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.15.32.1 2008/01/02 21:46:51 bouyer Exp $");
