/* $NetBSD: compat_13_machdep.c,v 1.21.12.1 2017/04/21 16:53:21 bouyer Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.21.12.1 2017/04/21 16:53:21 bouyer Exp $");
