/* $NetBSD: compat_13_machdep.c,v 1.11.2.1 2005/11/10 13:48:21 skrll Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.11.2.1 2005/11/10 13:48:21 skrll Exp $");
