/* $NetBSD: compat_13_machdep.c,v 1.21.8.1 2017/03/20 06:57:09 pgoyette Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.21.8.1 2017/03/20 06:57:09 pgoyette Exp $");
