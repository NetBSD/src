/* $NetBSD: compat_13_machdep.c,v 1.10.2.4 2002/07/12 01:39:20 nathanw Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: compat_13_machdep.c,v 1.10.2.4 2002/07/12 01:39:20 nathanw Exp $");
