/* $NetBSD: dec_axppci_33.c,v 1.16.2.4 1997/07/22 05:54:29 cgd Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: dec_axppci_33.c,v 1.16.2.4 1997/07/22 05:54:29 cgd Exp $");
...
dec_axppci_33_cons_init()
{
	...
	case 3:
		...
		/* XXX */
		{
			...
			pcppi_attach_console(lcp->lc_iot);
