/* $NetBSD: cia_swiz_bus_mem.c,v 1.15.18.1 2000/11/20 19:57:07 bouyer Exp $ */
...
__KERNEL_RCSID(1, "$NetBSD: cia_swiz_bus_mem.c,v 1.15.18.1 2000/11/20 19:57:07 bouyer Exp $");
