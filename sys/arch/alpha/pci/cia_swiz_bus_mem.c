/* $NetBSD: cia_swiz_bus_mem.c,v 1.16.152.1 2011/03/05 20:49:12 rmind Exp $ */
...
__KERNEL_RCSID(1, "$NetBSD: cia_swiz_bus_mem.c,v 1.16.152.1 2011/03/05 20:49:12 rmind Exp $");
