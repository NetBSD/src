/* $NetBSD: cia_bwx_bus_io.c,v 1.1.20.1 1999/12/27 18:31:27 wrstuden Exp $ */
...
__KERNEL_RCSID(1, "$NetBSD: cia_bwx_bus_io.c,v 1.1.20.1 1999/12/27 18:31:27 wrstuden Exp $");
