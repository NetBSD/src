/* $NetBSD: mcclock_ioasic.c,v 1.11.72.1 2007/10/03 19:22:05 garbled Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: mcclock_ioasic.c,v 1.11.72.1 2007/10/03 19:22:05 garbled Exp $");
