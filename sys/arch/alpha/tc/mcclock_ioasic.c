/* $NetBSD: mcclock_ioasic.c,v 1.17.64.1 2021/05/13 00:47:21 thorpej Exp $ */
...
__KERNEL_RCSID(0, "$NetBSD: mcclock_ioasic.c,v 1.17.64.1 2021/05/13 00:47:21 thorpej Exp $");
