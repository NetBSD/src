/*	$NetBSD: pci_machdep.h,v 1.1.6.3 2002/06/23 17:39:03 jdolecek Exp $	*/
...
/*
 * PowerPC-specific PCI structure and type definitions.
 ...
 * NOT TO BE USED DIRECTLY BY MACHINE INDEPENDENT CODE.
 */
#define	pciide_machdep_compat_intr_establish(dev, pa, ch, f, a)		\
    ((pa)->pa_pc->pc_pciide_compat_intr_establish == NULL ? NULL :	\
     (*(pa)->pa_pc->pc_pciide_compat_intr_establish)((pa)->pa_pc->pc_conf_v, \
     (dev), (pa), (ch), (f), (a)))
