/*	$NetBSD: db_interface.c,v 1.133.18.1 2019/06/10 22:06:48 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: db_interface.c,v 1.133.18.1 2019/06/10 22:06:48 christos Exp $");
