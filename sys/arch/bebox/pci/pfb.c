/*	$NetBSD: pfb.c,v 1.14.14.1 2007/03/12 05:47:24 rmind Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: pfb.c,v 1.14.14.1 2007/03/12 05:47:24 rmind Exp $");
...
static int pfb_ioctl __P((void *, void *, u_long, void *, int, struct lwp *));
