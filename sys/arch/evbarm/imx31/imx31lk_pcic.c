/*	$Id: imx31lk_pcic.c,v 1.1.2.1 2007/09/11 02:36:55 matt Exp $	*/
/*	$NetBSD: imx31lk_pcic.c,v 1.1.2.1 2007/09/11 02:36:55 matt Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$Id: imx31lk_pcic.c,v 1.1.2.1 2007/09/11 02:36:55 matt Exp $");
