/*	$NetBSD: setovfl.c,v 1.5.64.1 2009/04/28 07:34:07 skrll Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: setovfl.c,v 1.5.64.1 2009/04/28 07:34:07 skrll Exp $");
...
sgl_floating_point
sgl_setoverflow(unsigned int sign)
{
