/*	$NetBSD: rf_dagdegrd.c,v 1.24.6.1 2006/06/01 22:37:32 kardel Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_dagdegrd.c,v 1.24.6.1 2006/06/01 22:37:32 kardel Exp $");
...
rf_DoubleDegRead(RF_Raid_t *raidPtr, RF_AccessStripeMap_t *asmap,
		 ...
		 RF_AllocListElem_t *allocList,
		 const char *redundantReadNodeName, const char *recoveryNodeName,
