/*	$NetBSD: rf_chaindecluster.c,v 1.6.2.3 2002/10/18 02:43:42 nathanw Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_chaindecluster.c,v 1.6.2.3 2002/10/18 02:43:42 nathanw Exp $");
