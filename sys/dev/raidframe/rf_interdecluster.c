/*	$NetBSD: rf_interdecluster.c,v 1.12.10.1 2006/10/22 06:06:43 yamt Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_interdecluster.c,v 1.12.10.1 2006/10/22 06:06:43 yamt Exp $");
...
int
rf_GetDefaultNumFloatingReconBuffersInterDecluster(RF_Raid_t * raidPtr __unused)
{
	return (30);
}
