/*	$NetBSD: rf_interdecluster.c,v 1.11.4.1 2006/09/09 02:54:05 rpaulo Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_interdecluster.c,v 1.11.4.1 2006/09/09 02:54:05 rpaulo Exp $");
