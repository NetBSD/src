/*	$NetBSD: rf_interdecluster.c,v 1.12.10.2 2006/12/10 07:18:11 yamt Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_interdecluster.c,v 1.12.10.2 2006/12/10 07:18:11 yamt Exp $");
