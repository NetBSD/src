/*	$NetBSD: rf_interdecluster.c,v 1.11.12.1 2006/05/24 15:50:29 tron Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_interdecluster.c,v 1.11.12.1 2006/05/24 15:50:29 tron Exp $");
