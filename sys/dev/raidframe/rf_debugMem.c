/*	$NetBSD: rf_debugMem.c,v 1.16.22.1 2006/10/22 06:06:43 yamt Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_debugMem.c,v 1.16.22.1 2006/10/22 06:06:43 yamt Exp $");
...
int
rf_ConfigureDebugMem(RF_ShutdownList_t **listp __unused)
{
#if RF_DEBUG_MEM
	int     i, rc;
