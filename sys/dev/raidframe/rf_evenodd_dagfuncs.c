/*	$NetBSD: rf_evenodd_dagfuncs.c,v 1.12.2.1 2004/08/03 10:50:44 skrll Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_evenodd_dagfuncs.c,v 1.12.2.1 2004/08/03 10:50:44 skrll Exp $");
