/*	$NetBSD: rf_parityloggingdags.c,v 1.9.2.3 2004/09/21 13:32:53 skrll Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_parityloggingdags.c,v 1.9.2.3 2004/09/21 13:32:53 skrll Exp $");
