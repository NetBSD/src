/*	$NetBSD: rf_parityloggingdags.c,v 1.15.8.1 2006/09/03 15:24:48 yamt Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_parityloggingdags.c,v 1.15.8.1 2006/09/03 15:24:48 yamt Exp $");
