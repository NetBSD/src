/*	$NetBSD: rf_parityloggingdags.c,v 1.16.4.1 2006/10/22 06:06:43 yamt Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_parityloggingdags.c,v 1.16.4.1 2006/10/22 06:06:43 yamt Exp $");
