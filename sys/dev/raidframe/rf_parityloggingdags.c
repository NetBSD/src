/*	$NetBSD: rf_parityloggingdags.c,v 1.16.4.2 2006/12/10 07:18:11 yamt Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_parityloggingdags.c,v 1.16.4.2 2006/12/10 07:18:11 yamt Exp $");
