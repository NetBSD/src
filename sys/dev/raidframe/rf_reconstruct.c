/*	$NetBSD: rf_reconstruct.c,v 1.103.6.1 2008/06/23 04:31:26 wrstuden Exp $	*/
/*
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rf_reconstruct.c,v 1.103.6.1 2008/06/23 04:31:26 wrstuden Exp $");
