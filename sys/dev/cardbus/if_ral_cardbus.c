/*	$NetBSD: if_ral_cardbus.c,v 1.24.18.1 2019/06/10 22:07:06 christos Exp $	*/
 ...
 */
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: if_ral_cardbus.c,v 1.24.18.1 2019/06/10 22:07:06 christos Exp $");
