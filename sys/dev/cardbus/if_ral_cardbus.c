/*	$NetBSD: if_ral_cardbus.c,v 1.12.2.1 2008/09/18 04:35:02 wrstuden Exp $	*/
 ...
 */
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: if_ral_cardbus.c,v 1.12.2.1 2008/09/18 04:35:02 wrstuden Exp $");
