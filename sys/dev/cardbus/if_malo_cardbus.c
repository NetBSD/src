/*	$NetBSD: if_malo_cardbus.c,v 1.1.6.2 2019/06/10 22:07:06 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: if_malo_cardbus.c,v 1.1.6.2 2019/06/10 22:07:06 christos Exp $");
