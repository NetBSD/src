/*	$NetBSD: if_cs_isa.c,v 1.8 2002/09/27 20:38:26 thorpej Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: if_cs_isa.c,v 1.8 2002/09/27 20:38:26 thorpej Exp $");
...
const struct cfattach cs_isa_ca = {
