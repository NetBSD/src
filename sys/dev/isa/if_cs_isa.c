/*	$NetBSD: if_cs_isa.c,v 1.9 2002/10/02 02:09:17 thorpej Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: if_cs_isa.c,v 1.9 2002/10/02 02:09:17 thorpej Exp $");
...
CFATTACH_DECL(cs_isa, sizeof(struct cs_isa_softc),
