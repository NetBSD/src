/* $NetBSD: vga_isa.c,v 1.14 2002/10/02 02:09:20 thorpej Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: vga_isa.c,v 1.14 2002/10/02 02:09:20 thorpej Exp $");
...
CFATTACH_DECL(vga_isa, sizeof(struct vga_isa_softc),
