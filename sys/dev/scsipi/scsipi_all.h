/*	$NetBSD: scsipi_all.h,v 1.26 2005/01/31 23:06:41 reinoud Exp $	*/
...
/* 5*/	uint8_t additional_length;	/* n-4 */
/* 6*/	uint8_t flags1;
#define	SID_SCC		0x80
/* 7*/	uint8_t flags2;
...
struct scsipi_mode_header_big {
	...
	uint8_t medium_type;
	uint8_t dev_spec;
	uint8_t unused[2];		/* unused on ATAPI */
	uint8_t blk_desc_len[2];	/* unused on ATAPI */
} __attribute__((packed));
...
#define	PGCODE_PS	0x80		/* page is savable */
	uint8_t pg_length;		/* page length (not including hdr) */
