...
/*	$NetBSD: if_zydreg.h,v 1.2.2.2 2007/06/21 15:09:41 itohy Exp $	*/
...
#define ZYD_ENDPT_CNT	4
	...
	struct ue_chain			rx_data[ZYD_RX_LIST_CNT];
	struct ue_chain			tx_data[ZYD_TX_LIST_CNT];
	struct ieee80211_node		*tx_ni[ZYD_TX_LIST_CNT];
	int				tx_queued;
