/*	$NetBSD: if_ural.c,v 1.18.10.6 2007/06/25 09:25:49 itohy Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: if_ural.c,v 1.18.10.6 2007/06/25 09:25:49 itohy Exp $");
...
Static int		ural_ioctl(struct ifnet *, u_long, usb_ioctlarg_t);
...
Static int
ural_ioctl(struct ifnet *ifp, u_long cmd, usb_ioctlarg_t data)
{
	struct ural_softc *sc = ifp->if_softc;
	struct ieee80211com *ic = &sc->sc_ic;
	int s, error = 0;
