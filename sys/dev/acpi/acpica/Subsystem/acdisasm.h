...
extern const NATIVE_CHAR        *AcpiGbl_LockRule[ACPI_NUM_LOCK_RULES];
extern const NATIVE_CHAR        *AcpiGbl_AccessTypes[ACPI_NUM_ACCESS_TYPES];
extern const NATIVE_CHAR        *AcpiGbl_UpdateRules[ACPI_NUM_UPDATE_RULES];
extern const NATIVE_CHAR        *AcpiGbl_MatchOps[ACPI_NUM_MATCH_OPS];
