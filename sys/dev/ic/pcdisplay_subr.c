/* $NetBSD: pcdisplay_subr.c,v 1.32.26.1 2007/09/03 07:04:24 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: pcdisplay_subr.c,v 1.32.26.1 2007/09/03 07:04:24 wrstuden Exp $");
