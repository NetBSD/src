/* $NetBSD: pcdisplay_subr.c,v 1.25.8.1.4.1 2007/08/12 19:53:17 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: pcdisplay_subr.c,v 1.25.8.1.4.1 2007/08/12 19:53:17 bouyer Exp $");
