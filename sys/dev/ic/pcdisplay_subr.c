/* $NetBSD: pcdisplay_subr.c,v 1.18.2.3 2002/09/06 08:44:31 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: pcdisplay_subr.c,v 1.18.2.3 2002/09/06 08:44:31 jdolecek Exp $");
