/* $NetBSD: pcdisplay_subr.c,v 1.34.40.1 2010/10/22 07:21:58 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: pcdisplay_subr.c,v 1.34.40.1 2010/10/22 07:21:58 uebayasi Exp $");
