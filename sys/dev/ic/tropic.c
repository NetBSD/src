/*	$NetBSD: tropic.c,v 1.34.12.2 2009/04/28 07:35:27 skrll Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: tropic.c,v 1.34.12.2 2009/04/28 07:35:27 skrll Exp $");
...
int
tr_activate(struct device *self, enum devact act)
{
