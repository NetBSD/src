/* All information is from the intel 82365sl PC Card Interface
...
/* The PCIC allows two chips to share the same address.  In order not
to run afoul of the netbsd device model, this driver will treat those
chips as the same device. */
...
/* The card side of a memory mapping consists of bits A19-A12 of the
   card memory address in the LSB, and A25-A20 plus some other bits in
   the MSB.  Again, the shift is 12 bits. */
