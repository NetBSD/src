/*	$NetBSD: vga_pci.c,v 1.23.2.1 2003/07/02 15:26:13 darrenr Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: vga_pci.c,v 1.23.2.1 2003/07/02 15:26:13 darrenr Exp $");
...
int	vga_pci_ioctl(void *, u_long, caddr_t, int, struct lwp *);
