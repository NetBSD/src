/*	$NetBSD: if_bwi_pci.c,v 1.15.16.1 2018/12/26 14:01:50 pgoyette Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: if_bwi_pci.c,v 1.15.16.1 2018/12/26 14:01:50 pgoyette Exp $");
...
bwi_pci_attach(device_t parent, device_t self, void *aux)
{
	...
	sc->sc_ih = pci_intr_establish_xname(psc->psc_pc, ih, IPL_NET, bwi_intr,
