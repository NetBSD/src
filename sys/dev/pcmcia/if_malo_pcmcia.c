/*	$NetBSD: if_malo_pcmcia.c,v 1.10.2.2 2017/03/20 06:57:38 pgoyette Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: if_malo_pcmcia.c,v 1.10.2.2 2017/03/20 06:57:38 pgoyette Exp $");
