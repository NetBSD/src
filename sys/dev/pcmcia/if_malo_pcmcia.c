/*	$NetBSD: if_malo_pcmcia.c,v 1.25.10.1 2021/06/17 04:46:30 thorpej Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: if_malo_pcmcia.c,v 1.25.10.1 2021/06/17 04:46:30 thorpej Exp $");
