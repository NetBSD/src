/*	$NetBSD: efs_vfsops.c,v 1.16.4.1.10.1 2014/04/28 16:05:35 sborrill Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: efs_vfsops.c,v 1.16.4.1.10.1 2014/04/28 16:05:35 sborrill Exp $");
