/*	$NetBSD: cryptosoft_xform.c,v 1.1.4.2 2005/12/11 10:29:36 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(1, "$NetBSD: cryptosoft_xform.c,v 1.1.4.2 2005/12/11 10:29:36 christos Exp $");
