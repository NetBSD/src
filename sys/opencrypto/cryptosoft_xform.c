/*	$NetBSD: cryptosoft_xform.c,v 1.12.6.1 2011/06/06 09:10:04 jruoho Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(1, "$NetBSD: cryptosoft_xform.c,v 1.12.6.1 2011/06/06 09:10:04 jruoho Exp $");
