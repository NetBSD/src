/*	$NetBSD: cryptosoft_xform.c,v 1.30.28.1 2026/05/07 14:40:13 martin Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(1, "$NetBSD: cryptosoft_xform.c,v 1.30.28.1 2026/05/07 14:40:13 martin Exp $");
