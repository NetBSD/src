/*	$NetBSD: cryptosoft_xform.c,v 1.12.8.1 2011/03/05 15:10:48 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(1, "$NetBSD: cryptosoft_xform.c,v 1.12.8.1 2011/03/05 15:10:48 bouyer Exp $");
