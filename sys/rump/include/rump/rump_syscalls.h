/* $NetBSD: rump_syscalls.h,v 1.6.4.2 2009/01/19 13:20:25 skrll Exp $ */
...
int rump_sys_socket(int, int, int, int *) __RENAME(rump_sys___socket30);
int rump_sys_getfh(const char *, void *, size_t *, int *) __RENAME(rump_sys___getfh30);
int rump_sys_utimes(const char *, const struct timeval *, int *) __RENAME(rump_sys___utimes50);
int rump_sys_lutimes(const char *, const struct timeval *, int *) __RENAME(rump_sys___lutimes50);
int rump_sys_stat(const char *, struct stat *, int *) __RENAME(rump_sys___stat50);
int rump_sys_lstat(const char *, struct stat *, int *) __RENAME(rump_sys___lstat50);
int rump_sys_mknod(const char *, mode_t, dev_t, int *) __RENAME(rump_sys___mknod50);
