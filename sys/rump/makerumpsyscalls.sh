#!/bin/sh
#
#	$NetBSD: makerumpsyscalls.sh,v 1.2.10.3 2017/12/03 11:39:06 jdolecek Exp $
#
...
SYSCOMP_HDR='/*	$NetBSD: makerumpsyscalls.sh,v 1.2.10.3 2017/12/03 11:39:06 jdolecek Exp $	*/

/* AUTOMATICALLY GENERATED BY makerumpsyscalls.sh */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: makerumpsyscalls.sh,v 1.2.10.3 2017/12/03 11:39:06 jdolecek Exp $");
