/*	$NetBSD: wscons_component.c,v 1.2.18.1 2019/06/10 22:09:51 christos Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: wscons_component.c,v 1.2.18.1 2019/06/10 22:09:51 christos Exp $");
