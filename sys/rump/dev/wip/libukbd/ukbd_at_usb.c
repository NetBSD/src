...
struct cfdata cfdata_ukbd[] = {
    /* driver           attachment    unit state loc   flags pspec */
/*  1: usb* at rumpusbhc? */
    { "usb",		"usb",		 0, STAR,     loc,      0, &pspec1 },
/*  2: uhub* at usb? */
    { "uhub",		"uroothub",	 0, STAR,     loc,      0, &pspec2 },
/*  3: uhub* at uhub? port -1 configuration -1 interface -1 vendor -1 product -1 release -1 */
    { "uhub",		"uhub",		 0, STAR, loc+  0,      0, &pspec3 },
/*  4: uhidev* at uhub? port -1 configuration -1 interface -1 vendor -1 product -1 release -1 */
    { "uhidev",		"uhidev",	 0, STAR, loc+  6,      0, &pspec4 },
/*  5: uhid* at uhidev? reportid -1 */
    { "uhid",		"uhid",		 0, STAR, loc+ 14,      0, &pspec5 },
/*  6: ukbd* at uhidev? reportid -1 */
    { "ukbd",		"ukbd",		 0, STAR, loc+ 15,      0, &pspec5 },
...
{
	extern struct cfattach usb_ca, uhub_ca, uroothub_ca, uhidev_ca, ukbd_ca;
