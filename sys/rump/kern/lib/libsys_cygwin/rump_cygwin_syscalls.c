/* $NetBSD: rump_cygwin_syscalls.c,v 1.2.2.2 2013/06/23 06:20:27 tls Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_cygwin_syscalls.c,v 1.2.2.2 2013/06/23 06:20:27 tls Exp $");
