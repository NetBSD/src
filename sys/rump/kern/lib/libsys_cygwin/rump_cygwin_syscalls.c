/* $NetBSD: rump_cygwin_syscalls.c,v 1.3 2015/03/08 15:19:40 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_cygwin_syscalls.c,v 1.3 2015/03/08 15:19:40 christos Exp $");
