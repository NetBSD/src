/* $NetBSD: rump_linux_sysent.c,v 1.17.4.1 2015/04/06 15:18:29 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_linux_sysent.c,v 1.17.4.1 2015/04/06 15:18:29 skrll Exp $");
