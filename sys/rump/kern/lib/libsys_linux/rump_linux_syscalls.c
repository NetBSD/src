/* $NetBSD: rump_linux_syscalls.c,v 1.1.2.2 2012/10/30 17:22:53 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_linux_syscalls.c,v 1.1.2.2 2012/10/30 17:22:53 yamt Exp $");
