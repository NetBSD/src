/* $NetBSD: rump_linux_syscalls.c,v 1.1.2.3 2014/05/22 11:41:14 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_linux_syscalls.c,v 1.1.2.3 2014/05/22 11:41:14 yamt Exp $");
