/* $NetBSD: rump_linux_syscalls.c,v 1.5.6.1 2014/05/18 17:46:17 rmind Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_linux_syscalls.c,v 1.5.6.1 2014/05/18 17:46:17 rmind Exp $");
