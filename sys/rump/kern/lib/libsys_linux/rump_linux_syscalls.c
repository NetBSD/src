/* $NetBSD: rump_linux_syscalls.c,v 1.5.4.2 2013/04/08 20:58:28 pooka Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_linux_syscalls.c,v 1.5.4.2 2013/04/08 20:58:28 pooka Exp $");
