/* $NetBSD: rump_linux_syscalls.c,v 1.15.2.1 2014/08/10 06:56:51 tls Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_linux_syscalls.c,v 1.15.2.1 2014/08/10 06:56:51 tls Exp $");
