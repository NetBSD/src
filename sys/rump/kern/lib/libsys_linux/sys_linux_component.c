/*	$NetBSD: sys_linux_component.c,v 1.3.16.2 2018/12/26 14:02:06 pgoyette Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sys_linux_component.c,v 1.3.16.2 2018/12/26 14:02:06 pgoyette Exp $");
