/*	$NetBSD: sys_linux_component.c,v 1.3.18.1 2019/06/10 22:09:53 christos Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sys_linux_component.c,v 1.3.18.1 2019/06/10 22:09:53 christos Exp $");
