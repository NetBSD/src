/* $NetBSD: rump_sunos_syscalls.c,v 1.2.10.2 2014/05/22 11:41:14 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_sunos_syscalls.c,v 1.2.10.2 2014/05/22 11:41:14 yamt Exp $");
