/*	$NetBSD: rumpkern_syscalls.c,v 1.2.12.1 2015/09/22 12:06:15 skrll Exp $	*/

/* AUTOMATICALLY GENERATED BY makerumpsyscalls.sh */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rumpkern_syscalls.c,v 1.2.12.1 2015/09/22 12:06:15 skrll Exp $");
