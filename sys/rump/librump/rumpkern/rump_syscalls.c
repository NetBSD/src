/* $NetBSD: rump_syscalls.c,v 1.137.2.8 2018/07/28 04:38:11 pgoyette Exp $ */
...
#ifdef __NetBSD__
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_syscalls.c,v 1.137.2.8 2018/07/28 04:38:11 pgoyette Exp $");
