/* $NetBSD: rump_syscalls.c,v 1.5.2.9 2008/12/29 00:04:40 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_syscalls.c,v 1.5.2.9 2008/12/29 00:04:40 christos Exp $");
...
int
rump_sys___getfh30(const char * fname, void * fhp, size_t * fh_size, int *error)
{
	register_t retval = 0;
...
int
rump_sys___utimes50(const char * path, const struct timeval * tptr, int *error)
{
	register_t retval = 0;
