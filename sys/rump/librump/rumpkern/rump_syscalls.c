/* $NetBSD: rump_syscalls.c,v 1.5.2.3 2008/11/09 02:02:52 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_syscalls.c,v 1.5.2.3 2008/11/09 02:02:52 christos Exp $");
...
int
rump_sys___stat30(const char * path, struct stat30 * ub, int *error)
{
	register_t retval = 0;
	struct sys___stat30compat_50__args arg;
...
int
rump_sys___lstat30(const char * path, struct stat30 * ub, int *error)
{
	register_t retval = 0;
	struct sys___lstat30compat_50__args arg;
