/* $NetBSD: rump_syscalls.c,v 1.129.2.2 2017/03/20 06:57:52 pgoyette Exp $ */
...
#ifdef __NetBSD__
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_syscalls.c,v 1.129.2.2 2017/03/20 06:57:52 pgoyette Exp $");
