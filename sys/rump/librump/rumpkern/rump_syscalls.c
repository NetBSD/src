/* $NetBSD: rump_syscalls.c,v 1.129.2.1 2016/11/04 14:49:22 pgoyette Exp $ */
...
#ifdef __NetBSD__
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_syscalls.c,v 1.129.2.1 2016/11/04 14:49:22 pgoyette Exp $");
