/* $NetBSD: rump_syscalls.c,v 1.137.4.1 2019/06/10 22:09:53 christos Exp $ */
...
#ifdef __NetBSD__
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_syscalls.c,v 1.137.4.1 2019/06/10 22:09:53 christos Exp $");
