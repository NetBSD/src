/* $NetBSD: rump_syscalls.c,v 1.137.2.7 2018/04/18 00:01:19 pgoyette Exp $ */
...
#ifdef __NetBSD__
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: rump_syscalls.c,v 1.137.2.7 2018/04/18 00:01:19 pgoyette Exp $");
