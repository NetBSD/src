...
static	char	rcsid[] = "Id: ip_fil.c,v 1.2.4.9 1996/12/02 11:51:26 darrenr Exp";
#endif
...
#if (_BSDI_VERSION >= 199501) || defined(__NetBSD__)
...
#endif /* _BSDI_VERSION >= 199501 || __NetBSD__ */
