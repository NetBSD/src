/*	$NetBSD: ip_fil.c,v 1.79.2.4 2002/07/15 10:36:55 gehenna Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_fil.c,v 1.79.2.4 2002/07/15 10:36:55 gehenna Exp $");
#else
...
#if defined(__NetBSD__) && (__NetBSD_Version__ >= 106040000)
#include <sys/conf.h>
