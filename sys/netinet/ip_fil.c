/*	$NetBSD: ip_fil.c,v 1.79.2.5 2002/08/29 00:56:45 gehenna Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_fil.c,v 1.79.2.5 2002/08/29 00:56:45 gehenna Exp $");
#else
...
#if defined(__NetBSD__) && (__NetBSD_Version__ >= 106070000)
#include <sys/conf.h>
