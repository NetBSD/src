/*	$NetBSD: ip_ipsec_pxy.c,v 1.1.1.1.6.3 2002/04/17 00:06:25 nathanw Exp $	*/
...
__KERNEL_RCSID(1, "$NetBSD: ip_ipsec_pxy.c,v 1.1.1.1.6.3 2002/04/17 00:06:25 nathanw Exp $");
