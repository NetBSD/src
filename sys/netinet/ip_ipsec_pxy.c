/*	$NetBSD: ip_ipsec_pxy.c,v 1.1.1.1.4.4 2002/06/23 17:50:52 jdolecek Exp $	*/
...
__KERNEL_RCSID(1, "$NetBSD: ip_ipsec_pxy.c,v 1.1.1.1.4.4 2002/06/23 17:50:52 jdolecek Exp $");
