/*	$NetBSD: ip_ftp_pxy.c,v 1.10.12.1.2.1 2007/06/03 17:26:08 wrstuden Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(1, "$NetBSD: ip_ftp_pxy.c,v 1.10.12.1.2.1 2007/06/03 17:26:08 wrstuden Exp $");
