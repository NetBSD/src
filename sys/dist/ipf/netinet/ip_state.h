/*	$NetBSD: ip_state.h,v 1.13 2012/01/30 16:12:50 darrenr Exp $	*/
...
extern	int	ipf_state_ioctl __P((ipf_main_softc_t *, void *, ioctlcmd_t, int, int, void *));
extern	void	ipf_state_log __P((ipf_main_softc_t *, struct ipstate *, u_int));
extern	int	ipf_state_matchflush __P((ipf_main_softc_t *, void *));
