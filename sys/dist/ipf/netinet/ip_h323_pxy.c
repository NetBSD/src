/*	$NetBSD: ip_h323_pxy.c,v 1.4.12.1.2.1 2007/09/03 07:04:51 wrstuden Exp $	*/
...
__KERNEL_RCSID(1, "$NetBSD: ip_h323_pxy.c,v 1.4.12.1.2.1 2007/09/03 07:04:51 wrstuden Exp $");
