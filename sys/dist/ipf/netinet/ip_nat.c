/*	$NetBSD: ip_nat.c,v 1.40.2.1 2010/04/30 14:43:56 uebayasi Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_nat.c,v 1.40.2.1 2010/04/30 14:43:56 uebayasi Exp $");
#else
...
static	int	fr_natgetent __P((void *, int));
static	int	fr_natgetsz __P((void *, int));
