/*	$NetBSD: ip_nat.c,v 1.45 2012/01/30 16:12:50 darrenr Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_nat.c,v 1.45 2012/01/30 16:12:50 darrenr Exp $");
#else
...
/* ------------------------------------------------------------------------ */
static int
ipf_nat_matchencap(softn, fin, np)
	ipf_nat_softc_t *softn;
	fr_info_t *fin;
	ipnat_t *np;
{
