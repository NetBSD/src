/*	$NetBSD: ip_nat.c,v 1.35.12.2 2008/09/18 04:36:47 wrstuden Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_nat.c,v 1.35.12.2 2008/09/18 04:36:47 wrstuden Exp $");
#else
static const char sccsid[] = "@(#)ip_nat.c	1.11 6/5/96 (C) 1995 Darren Reed";
static const char rcsid[] = "@(#)$Id: ip_nat.c,v 1.35.12.2 2008/09/18 04:36:47 wrstuden Exp $";
#endif
#endif
