/*	$NetBSD: ip_nat.c,v 1.35.8.1 2008/06/04 02:05:34 yamt Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_nat.c,v 1.35.8.1 2008/06/04 02:05:34 yamt Exp $");
#else
static const char sccsid[] = "@(#)ip_nat.c	1.11 6/5/96 (C) 1995 Darren Reed";
static const char rcsid[] = "@(#)$Id: ip_nat.c,v 1.35.8.1 2008/06/04 02:05:34 yamt Exp $";
#endif
#endif
