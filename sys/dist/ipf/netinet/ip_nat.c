/*	$NetBSD: ip_nat.c,v 1.36.2.1 2008/07/28 14:37:27 simonb Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_nat.c,v 1.36.2.1 2008/07/28 14:37:27 simonb Exp $");
#else
static const char sccsid[] = "@(#)ip_nat.c	1.11 6/5/96 (C) 1995 Darren Reed";
static const char rcsid[] = "@(#)$Id: ip_nat.c,v 1.36.2.1 2008/07/28 14:37:27 simonb Exp $";
#endif
#endif
