/*	$NetBSD: ip_ipsec_pxy.c,v 1.5.12.1.2.1 2007/09/03 07:04:52 wrstuden Exp $	*/
...
__KERNEL_RCSID(1, "$NetBSD: ip_ipsec_pxy.c,v 1.5.12.1.2.1 2007/09/03 07:04:52 wrstuden Exp $");
