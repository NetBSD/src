/*	$NetBSD: ip_fil.h,v 1.20 2012/01/30 16:12:49 darrenr Exp $	*/
...
#endif
extern	int	frrequest __P((ipf_main_softc_t *, int, ioctlcmd_t, void *,
			       int, int));
...
extern	int	ipf_ipf_ioctl __P((ipf_main_softc_t *, void *, ioctlcmd_t,
				   int, int, void *));
extern	int	ipf_ipftune __P((ipf_main_softc_t *, ioctlcmd_t, void *));
extern	int	ipf_matcharray_load __P((ipf_main_softc_t *, void *,
					 ipfobj_t *, int **));
...
extern	int		ipf_lock __P((void *, int *));
...
extern	int		ipf_zerostats __P((ipf_main_softc_t *, void *));
