/*	$NetBSD: ip_irc_pxy.c,v 1.11.12.1 2012/04/17 00:08:13 yamt Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(1, "$NetBSD: ip_irc_pxy.c,v 1.11.12.1 2012/04/17 00:08:13 yamt Exp $");
...
ippr_irc_fini(void);
int
ippr_irc_new(fr_info_t *, ap_session_t *, nat_t *);
int
ippr_irc_out(fr_info_t *, ap_session_t *, nat_t *);
int
ippr_irc_send(fr_info_t *, nat_t *);
int
ippr_irc_complete(ircinfo_t *, char *, size_t);
u_short
ipf_irc_atoi(char **);
