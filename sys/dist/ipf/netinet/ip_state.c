/*	$NetBSD: ip_state.c,v 1.30.18.1 2008/06/02 13:24:04 mjf Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_state.c,v 1.30.18.1 2008/06/02 13:24:04 mjf Exp $");
#else
static const char sccsid[] = "@(#)ip_state.c	1.8 6/5/96 (C) 1993-2000 Darren Reed";
static const char rcsid[] = "@(#)$Id: ip_state.c,v 1.30.18.1 2008/06/02 13:24:04 mjf Exp $";
#endif
#endif
