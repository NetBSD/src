/*	$NetBSD: ip_rcmd_pxy.c,v 1.8.12.1.2.1 2007/09/03 07:04:58 wrstuden Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(1, "$NetBSD: ip_rcmd_pxy.c,v 1.8.12.1.2.1 2007/09/03 07:04:58 wrstuden Exp $");
