/*	$NetBSD: ip_fil_netbsd.c,v 1.46.8.1.2.1.2.1 2010/04/21 00:27:55 matt Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_fil_netbsd.c,v 1.46.8.1.2.1.2.1 2010/04/21 00:27:55 matt Exp $");
#else
