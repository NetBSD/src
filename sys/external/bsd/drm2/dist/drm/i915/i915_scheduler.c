/*	$NetBSD: i915_scheduler.c,v 1.1.1.1 2021/12/18 20:15:26 riastradh Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: i915_scheduler.c,v 1.1.1.1 2021/12/18 20:15:26 riastradh Exp $");
