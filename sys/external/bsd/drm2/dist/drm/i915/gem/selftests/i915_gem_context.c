/*	$NetBSD: i915_gem_context.c,v 1.1.1.1 2021/12/18 20:15:32 riastradh Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: i915_gem_context.c,v 1.1.1.1 2021/12/18 20:15:32 riastradh Exp $");
