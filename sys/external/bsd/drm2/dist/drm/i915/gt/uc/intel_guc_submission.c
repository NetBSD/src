/*	$NetBSD: intel_guc_submission.c,v 1.1.1.1 2021/12/18 20:15:33 riastradh Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: intel_guc_submission.c,v 1.1.1.1 2021/12/18 20:15:33 riastradh Exp $");
