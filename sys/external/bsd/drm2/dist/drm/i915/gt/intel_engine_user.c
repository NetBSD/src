/*	$NetBSD: intel_engine_user.c,v 1.1.1.1 2021/12/18 20:15:32 riastradh Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: intel_engine_user.c,v 1.1.1.1 2021/12/18 20:15:32 riastradh Exp $");
