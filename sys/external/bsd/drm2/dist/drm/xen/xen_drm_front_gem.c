/*	$NetBSD: xen_drm_front_gem.c,v 1.1.1.1 2021/12/18 20:15:56 riastradh Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: xen_drm_front_gem.c,v 1.1.1.1 2021/12/18 20:15:56 riastradh Exp $");
