/*	$NetBSD: amdgpu_dc_link_dp.c,v 1.1.1.1 2021/12/18 20:18:29 riastradh Exp $	*/

/* Copyright 2015 Advanced Micro Devices, Inc. */
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: amdgpu_dc_link_dp.c,v 1.1.1.1 2021/12/18 20:18:29 riastradh Exp $");
