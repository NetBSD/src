/*	$NetBSD: radeon_legacy_tv.c,v 1.1.1.2 2018/08/27 01:34:58 riastradh Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: radeon_legacy_tv.c,v 1.1.1.2 2018/08/27 01:34:58 riastradh Exp $");
