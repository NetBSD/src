/*	$NetBSD: radeon_legacy_tv.c,v 1.1.1.3 2021/12/18 20:15:49 riastradh Exp $	*/

// SPDX-License-Identifier: MIT

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: radeon_legacy_tv.c,v 1.1.1.3 2021/12/18 20:15:49 riastradh Exp $");
