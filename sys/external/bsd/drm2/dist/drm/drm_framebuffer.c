/*	$NetBSD: drm_framebuffer.c,v 1.1.1.1 2021/12/18 20:11:02 riastradh Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: drm_framebuffer.c,v 1.1.1.1 2021/12/18 20:11:02 riastradh Exp $");
