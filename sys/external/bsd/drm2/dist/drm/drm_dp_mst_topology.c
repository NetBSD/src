/*	$NetBSD: drm_dp_mst_topology.c,v 1.1.1.2 2021/12/18 20:11:01 riastradh Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: drm_dp_mst_topology.c,v 1.1.1.2 2021/12/18 20:11:01 riastradh Exp $");
