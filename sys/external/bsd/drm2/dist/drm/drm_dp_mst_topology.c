/*	$NetBSD: drm_dp_mst_topology.c,v 1.1.1.1 2018/08/27 01:34:41 riastradh Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: drm_dp_mst_topology.c,v 1.1.1.1 2018/08/27 01:34:41 riastradh Exp $");
