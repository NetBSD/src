/*	$NetBSD: nouveau_dispnv04_cursor.c,v 1.1.1.3 2021/12/18 20:15:36 riastradh Exp $	*/

// SPDX-License-Identifier: MIT
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: nouveau_dispnv04_cursor.c,v 1.1.1.3 2021/12/18 20:15:36 riastradh Exp $");
