/*	$NetBSD: nouveau_subdev_bios_init.c,v 1.1.1.1.6.2 2014/08/20 00:04:14 tls Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: nouveau_subdev_bios_init.c,v 1.1.1.1.6.2 2014/08/20 00:04:14 tls Exp $");
