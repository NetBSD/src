/*	$NetBSD: nouveau_engine_graph_nv2a.c,v 1.1.1.1.6.2 2014/08/20 00:04:12 tls Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: nouveau_engine_graph_nv2a.c,v 1.1.1.1.6.2 2014/08/20 00:04:12 tls Exp $");
