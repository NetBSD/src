/*	$NetBSD: nouveau_engine_graph_nv30.c,v 1.1.1.1.2.2 2014/08/10 06:55:32 tls Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: nouveau_engine_graph_nv30.c,v 1.1.1.1.2.2 2014/08/10 06:55:32 tls Exp $");
