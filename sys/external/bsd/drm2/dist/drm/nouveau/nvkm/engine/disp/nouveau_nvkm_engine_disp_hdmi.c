/*	$NetBSD: nouveau_nvkm_engine_disp_hdmi.c,v 1.1.1.1 2021/12/18 20:15:37 riastradh Exp $	*/

// SPDX-License-Identifier: MIT
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: nouveau_nvkm_engine_disp_hdmi.c,v 1.1.1.1 2021/12/18 20:15:37 riastradh Exp $");
