/*	$NetBSD: nouveau_nvkm_engine_gr_nv34.c,v 1.3 2021/12/18 23:45:36 riastradh Exp $	*/

// SPDX-License-Identifier: MIT
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: nouveau_nvkm_engine_gr_nv34.c,v 1.3 2021/12/18 23:45:36 riastradh Exp $");
