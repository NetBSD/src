/*	$NetBSD: nouveau_nvkm_subdev_pmu_memx.c,v 1.2.2.2 2018/09/06 06:56:30 pgoyette Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: nouveau_nvkm_subdev_pmu_memx.c,v 1.2.2.2 2018/09/06 06:56:30 pgoyette Exp $");
