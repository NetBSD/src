/*	$NetBSD: ip_pool.c,v 1.3.2.2 2017/12/03 11:38:02 jdolecek Exp $	*/
...
#if defined(__NetBSD__)
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_pool.c,v 1.3.2.2 2017/12/03 11:38:02 jdolecek Exp $");
#else
...
static void ipf_pool_free(ipf_main_softc_t *, ipf_pool_softc_t *, ip_pool_t *);
