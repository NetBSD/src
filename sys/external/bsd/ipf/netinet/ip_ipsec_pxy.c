/*	$NetBSD: ip_ipsec_pxy.c,v 1.2.4.3 2012/10/30 17:22:19 yamt Exp $	*/
 ...
 * code.
 *
 * Id: ip_ipsec_pxy.c,v 1.1.1.2 2012/07/22 13:45:19 darrenr Exp
 *
 */

#include <sys/cdefs.h>
__KERNEL_RCSID(1, "$NetBSD: ip_ipsec_pxy.c,v 1.2.4.3 2012/10/30 17:22:19 yamt Exp $");
