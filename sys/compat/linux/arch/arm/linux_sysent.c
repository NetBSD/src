/* $NetBSD: linux_sysent.c,v 1.29.24.1 2007/11/18 19:35:01 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.29.24.1 2007/11/18 19:35:01 bouyer Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ ns(struct sys___posix_rename_args), 0,
	    sys___posix_rename },		/* 38 = __posix_rename */
	...
	{ ns(struct compat_43_sys_truncate_args), 0,
	    compat_43_sys_truncate },		/* 92 = truncate */
	...
	{ 0, 0, 0,
	    linux_sys_breakpoint },		/* 385 = breakpoint */
	{ ns(struct linux_sys_cacheflush_args), 0,
	    linux_sys_cacheflush },		/* 386 = cacheflush */
	{ 0, 0, 0,
