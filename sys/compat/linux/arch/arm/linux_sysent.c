/* $NetBSD: linux_sysent.c,v 1.70 2017/01/02 16:32:38 manu Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.70 2017/01/02 16:32:38 manu Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ ns(struct linux_sys_oldolduname_args), 0,
	...
	{ ns(struct linux_sys_pread_args), SYCALL_NARGS64_VAL(1) | SYCALL_ARG3_64,
	    (sy_call_t *)linux_sys_pread },	/* 180 = pread */
	{ ns(struct linux_sys_pwrite_args), SYCALL_NARGS64_VAL(1) | SYCALL_ARG3_64,
	...
	{ 0, 0, 0,
	    (sy_call_t *)sys___vfork14 },	/* 190 = vfork */
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	{ 0, 0, 0,
	    (sy_call_t *)sys_getuid },		/* 199 = getuid32 */
	{ 0, 0, 0,
	    (sy_call_t *)sys_getgid },		/* 200 = getgid32 */
	{ 0, 0, 0,
	    (sy_call_t *)sys_geteuid },		/* 201 = geteuid32 */
	{ 0, 0, 0,
	    (sy_call_t *)sys_getegid },		/* 202 = getegid32 */
	{ ns(struct sys_setreuid_args), 0,
	    (sy_call_t *)sys_setreuid },	/* 203 = setreuid32 */
	{ ns(struct sys_setregid_args), 0,
	    (sy_call_t *)sys_setregid },	/* 204 = setregid32 */
	{ ns(struct sys_getgroups_args), 0,
	    (sy_call_t *)sys_getgroups },	/* 205 = getgroups32 */
	{ ns(struct sys_setgroups_args), 0,
	    (sy_call_t *)sys_setgroups },	/* 206 = setgroups32 */
	{ ns(struct sys___posix_fchown_args), 0,
	    (sy_call_t *)sys___posix_fchown },	/* 207 = fchown32 */
	{ ns(struct linux_sys_setresuid_args), 0,
	    (sy_call_t *)linux_sys_setresuid },	/* 208 = setresuid32 */
	{ ns(struct linux_sys_getresuid_args), 0,
	    (sy_call_t *)linux_sys_getresuid },	/* 209 = getresuid32 */
	{ ns(struct linux_sys_setresgid_args), 0,
	    (sy_call_t *)linux_sys_setresgid },	/* 210 = setresgid32 */
	{ ns(struct linux_sys_getresgid_args), 0,
	    (sy_call_t *)linux_sys_getresgid },	/* 211 = getresgid32 */
	{ ns(struct sys___posix_chown_args), 0,
	    (sy_call_t *)sys___posix_chown },	/* 212 = chown32 */
	{ ns(struct sys_setuid_args), 0,
	    (sy_call_t *)sys_setuid },		/* 213 = setuid32 */
	{ ns(struct sys_setgid_args), 0,
	    (sy_call_t *)sys_setgid },		/* 214 = setgid32 */
	{ ns(struct linux_sys_setfsuid_args), 0,
	    (sy_call_t *)linux_sys_setfsuid },	/* 215 = setfsuid32 */
	{ ns(struct linux_sys_setfsgid_args), 0,
	    (sy_call_t *)linux_sys_setfsgid },	/* 216 = setfsgid32 */
	...
	{ ns(struct sys_mincore_args), 0,
	    (sy_call_t *)sys_mincore },		/* 219 = mincore */
	{ ns(struct sys_madvise_args), 0,
	    (sy_call_t *)sys_madvise },		/* 220 = madvise */
	{ ns(struct linux_sys_fcntl64_args), 0,
	    (sy_call_t *)linux_sys_fcntl64 },	/* 221 = fcntl64 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 222 = unimplemented / * for tux * / */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 243 = unimplemented io_setup */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 244 = unimplemented io_destroy */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 245 = unimplemented io_getevents */
	{ 0, 0, 0,
	...
	{ ns(struct linux_sys_exit_group_args), 0,
	    (sy_call_t *)linux_sys_exit_group },/* 248 = exit_group */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 249 = unimplemented lookup_dcookie */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 250 = unimplemented epoll_create */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 251 = unimplemented epoll_ctl */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 252 = unimplemented epoll_wait */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 253 = unimplemented remap_file_pages */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 254 = unimplemented set_thread_area */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 255 = unimplemented get_thread_area */
	{ ns(struct linux_sys_set_tid_address_args), 0,
	    (sy_call_t *)linux_sys_set_tid_address },/* 256 = set_tid_address */
	{ 0, 0, 0,
	...
	{ ns(struct linux_sys_statfs64_args), 0,
	    (sy_call_t *)linux_sys_statfs64 },	/* 266 = statfs64 */
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 271 = unimplemented pciconfig_iobase */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 272 = unimplemented pciconfig_read */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 273 = unimplemented pciconfig_write */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 274 = unimplemented mq_open */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 275 = unimplemented mq_unlink */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 276 = unimplemented mq_timedsend */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 277 = unimplemented mq_timedreceive */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 278 = unimplemented mq_notify */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 279 = unimplemented mq_getsetattr */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 280 = unimplemented waitid */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 281 = unimplemented socket */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 282 = unimplemented bind */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 283 = unimplemented connect */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 284 = unimplemented listen */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 285 = unimplemented accept */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 286 = unimplemented getsockname */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 287 = unimplemented getpeername */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 288 = unimplemented socketpair */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 289 = unimplemented send */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 290 = unimplemented sendto */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 291 = unimplemented recv */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 292 = unimplemented recvfrom */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 293 = unimplemented shutdown */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 294 = unimplemented setsockopt */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 295 = unimplemented getsockopt */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 296 = unimplemented sendmsg */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 297 = unimplemented recvmsg */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 298 = unimplemented semop */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 299 = unimplemented semget */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 300 = unimplemented semctl */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 301 = unimplemented msgsnd */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 302 = unimplemented msgrcv */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 303 = unimplemented msgget */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 304 = unimplemented msgctl */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 305 = unimplemented shmat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 306 = unimplemented shmdt */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 307 = unimplemented shmget */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 308 = unimplemented shmctl */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 309 = unimplemented add_key */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 310 = unimplemented request_key */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 311 = unimplemented keyctl */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 312 = unimplemented semtimedop */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 313 = unimplemented vserver */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 314 = unimplemented ioptio_set */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 315 = unimplemented ioptio_get */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 316 = unimplemented inotify_init */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 317 = unimplemented inotify_add_watch */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 318 = unimplemented inotify_rm_watch */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 319 = unimplemented mbind */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 320 = unimplemented get_mempolicy */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 321 = unimplemented set_mempolicy */
	{ ns(struct linux_sys_openat_args), 0,
	    (sy_call_t *)linux_sys_openat },	/* 322 = openat */
	{ ns(struct sys_mkdirat_args), 0,
	    (sy_call_t *)sys_mkdirat },		/* 323 = mkdirat */
	{ ns(struct linux_sys_mknodat_args), 0,
	    (sy_call_t *)linux_sys_mknodat },	/* 324 = mknodat */
	{ ns(struct linux_sys_fchownat_args), 0,
	    (sy_call_t *)linux_sys_fchownat },	/* 325 = fchownat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 326 = unimplemented futimesat */
	{ ns(struct linux_sys_fstatat64_args), 0,
	    (sy_call_t *)linux_sys_fstatat64 },	/* 327 = fstatat64 */
	{ ns(struct linux_sys_unlinkat_args), 0,
	    (sy_call_t *)linux_sys_unlinkat },	/* 328 = unlinkat */
	{ ns(struct sys_renameat_args), 0,
	    (sy_call_t *)sys_renameat },	/* 329 = renameat */
	{ ns(struct linux_sys_linkat_args), 0,
	    (sy_call_t *)linux_sys_linkat },	/* 330 = linkat */
	{ ns(struct sys_symlinkat_args), 0,
	    (sy_call_t *)sys_symlinkat },	/* 331 = symlinkat */
	{ ns(struct sys_readlinkat_args), 0,
	    (sy_call_t *)sys_readlinkat },	/* 332 = readlinkat */
	{ ns(struct linux_sys_fchmodat_args), 0,
	    (sy_call_t *)linux_sys_fchmodat },	/* 333 = fchmodat */
	{ ns(struct linux_sys_faccessat_args), 0,
	    (sy_call_t *)linux_sys_faccessat },	/* 334 = faccessat */
	{ ns(struct linux_sys_pselect6_args), 0,
	    (sy_call_t *)linux_sys_pselect6 },	/* 335 = pselect6 */
	{ ns(struct linux_sys_ppoll_args), 0,
	    (sy_call_t *)linux_sys_ppoll },	/* 336 = ppoll */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 337 = unimplemented unshare */
	{ ns(struct linux_sys_set_robust_list_args), 0,
	    (sy_call_t *)linux_sys_set_robust_list },/* 338 = set_robust_list */
	{ ns(struct linux_sys_get_robust_list_args), 0,
	    (sy_call_t *)linux_sys_get_robust_list },/* 339 = get_robust_list */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 340 = unimplemented splice */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 341 = unimplemented sync_file_range2 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 342 = unimplemented tee */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 343 = unimplemented vmsplice */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 344 = unimplemented move_pages */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 345 = unimplemented getcpu */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 346 = unimplemented epoll_wait */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 347 = unimplemented kexec_load */
	{ ns(struct linux_sys_utimensat_args), 0,
	    (sy_call_t *)linux_sys_utimensat },	/* 348 = utimensat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 349 = unimplemented signalfd */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 350 = unimplemented timerfd_create */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 351 = unimplemented eventfd */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 352 = unimplemented fallocate */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 353 = unimplemented timerfd_settime */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 354 = unimplemented timerfd_gettime */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 355 = unimplemented signalfd4 */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 361 = unimplemented preadv */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 362 = unimplemented pwritev */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 363 = unimplemented rt_tgsigqueueinfo */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 364 = unimplemented perf_counter_open */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 365 = unimplemented recvmmsg */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 366 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 367 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 368 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 369 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 370 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 371 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 372 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 373 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 374 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 375 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 376 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 377 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 378 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 379 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 380 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 381 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 382 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 383 = unimplemented */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 384 = unimplemented / * base * / */
	{ 0, 0, 0,
	    (sy_call_t *)linux_sys_breakpoint },/* 385 = breakpoint */
	{ ns(struct linux_sys_cacheflush_args), 0,
	    (sy_call_t *)linux_sys_cacheflush },/* 386 = cacheflush */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 387 = unimplemented usr26 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 388 = unimplemented usr32 */
	{ ns(struct linux_sys_set_tls_args), 0,
	    (sy_call_t *)linux_sys_set_tls },	/* 389 = set_tls */
	{ 0, 0, 0,
