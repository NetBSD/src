/* $NetBSD: linux_sysent.c,v 1.100 2026/09/15 10:42:50 sborrill Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.100 2026/09/15 10:42:50 sborrill Exp $");
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	},		/* 224 = gettid */
	{
		...
		.sy_flags = SYCALL_NARGS64_VAL(1) | SYCALL_ARG1_64 | SYCALL_RET_WIDE,
