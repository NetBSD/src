/* $NetBSD: linux_syscalls.c,v 1.36.4.2 2008/05/14 01:35:03 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.36.4.2 2008/05/14 01:35:03 wrstuden Exp $");
