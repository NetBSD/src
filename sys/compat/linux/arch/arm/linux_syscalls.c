/* $NetBSD: linux_syscalls.c,v 1.93.2.1 2025/08/02 05:56:22 perseant Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.93.2.1 2025/08/02 05:56:22 perseant Exp $");
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	/* 316 */	NULL, /* inotify_init */
	/* 317 */	NULL, /* inotify_add_watch */
	/* 318 */	NULL, /* inotify_rm_watch */
	...
	/* 356 */	NULL, /* eventfd2 */
	/* 357 */	NULL, /* epoll_create1 */
	/* 358 */	NULL, /* dup3 */
	/* 359 */	NULL, /* pipe2 */
	/* 360 */	NULL, /* inotify_init1 */
	/* 361 */	NULL, /* preadv */
	/* 362 */	NULL, /* pwritev */
