/* $NetBSD: linux_syscalls.c,v 1.51.10.4 2017/12/03 11:36:54 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.51.10.4 2017/12/03 11:36:54 jdolecek Exp $");
