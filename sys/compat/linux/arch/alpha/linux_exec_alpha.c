/*	$NetBSD: linux_exec_alpha.c,v 1.4.8.1 2002/08/29 05:22:13 gehenna Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_exec_alpha.c,v 1.4.8.1 2002/08/29 05:22:13 gehenna Exp $");
