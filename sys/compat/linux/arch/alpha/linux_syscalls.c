/* $NetBSD: linux_syscalls.c,v 1.36 2001/03/30 17:18:48 jdolecek Exp $ */

/*
 * System call names.
 *
 * DO NOT EDIT-- this file is automatically generated.
 * created from	NetBSD: syscalls.master,v 1.32 2001/03/30 17:16:33 jdolecek Exp 
 */
...
const char *const linux_syscallnames[] = {
	...
	"#374 (unimplemented shmget)",		/* 374 = unimplemented shmget */
};
