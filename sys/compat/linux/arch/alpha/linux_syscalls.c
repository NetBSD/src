/* $NetBSD: linux_syscalls.c,v 1.40.2.3 2002/03/16 16:00:30 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.40.2.3 2002/03/16 16:00:30 jdolecek Exp $");
