/* $NetBSD: linux_syscalls.c,v 1.107.8.1 2018/09/06 06:55:45 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.107.8.1 2018/09/06 06:55:45 pgoyette Exp $");
