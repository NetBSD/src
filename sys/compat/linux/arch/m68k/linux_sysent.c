/* $NetBSD: linux_sysent.c,v 1.81.4.1 2014/05/18 17:45:32 rmind Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.81.4.1 2014/05/18 17:45:32 rmind Exp $");
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	{ ns(struct linux_sys_utimensat_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_utimensat },	/* 316 = utimensat */
	{ 0, 0, 0,
