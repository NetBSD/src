/* $NetBSD: linux_sysent.c,v 1.42.4.3 2004/05/11 14:38:23 tron Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.42.4.3 2004/05/11 14:38:23 tron Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ 2, s(struct linux_sys_ftruncate_args), 0,
	    linux_sys_ftruncate },		/* 194 = ftruncate */
