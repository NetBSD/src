/* $NetBSD: linux_sysent.c,v 1.59.24.1 2007/11/18 19:35:06 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.59.24.1 2007/11/18 19:35:06 bouyer Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ ns(struct linux_sys_setxattr_args), 0,
	    linux_sys_setxattr },		/* 223 = setxattr */
	{ ns(struct linux_sys_lsetxattr_args), 0,
	    linux_sys_lsetxattr },		/* 224 = lsetxattr */
	{ ns(struct linux_sys_fsetxattr_args), 0,
	    linux_sys_fsetxattr },		/* 225 = fsetxattr */
	{ ns(struct linux_sys_getxattr_args), 0,
	    linux_sys_getxattr },		/* 226 = getxattr */
	{ ns(struct linux_sys_lgetxattr_args), 0,
	    linux_sys_lgetxattr },		/* 227 = lgetxattr */
	{ ns(struct linux_sys_fgetxattr_args), 0,
	    linux_sys_fgetxattr },		/* 228 = fgetxattr */
	{ ns(struct linux_sys_listxattr_args), 0,
	    linux_sys_listxattr },		/* 229 = listxattr */
	{ ns(struct linux_sys_llistxattr_args), 0,
	    linux_sys_llistxattr },		/* 230 = llistxattr */
	{ ns(struct linux_sys_flistxattr_args), 0,
	    linux_sys_flistxattr },		/* 231 = flistxattr */
	{ ns(struct linux_sys_removexattr_args), 0,
	    linux_sys_removexattr },		/* 232 = removexattr */
	{ ns(struct linux_sys_lremovexattr_args), 0,
	    linux_sys_lremovexattr },		/* 233 = lremovexattr */
	{ ns(struct linux_sys_fremovexattr_args), 0,
	    linux_sys_fremovexattr },		/* 234 = fremovexattr */
	{ 0, 0, 0,
