/* $NetBSD: linux_syscalls.c,v 1.37.2.3 2002/06/23 17:44:12 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.37.2.3 2002/06/23 17:44:12 jdolecek Exp $");
