/* $NetBSD: linux_syscalls.c,v 1.54.4.1 2006/09/09 02:45:38 rpaulo Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.54.4.1 2006/09/09 02:45:38 rpaulo Exp $");
...
const char *const linux_syscallnames[] = {
	...
	"setxattr",			/* 223 = setxattr */
	"lsetxattr",			/* 224 = lsetxattr */
	"fsetxattr",			/* 225 = fsetxattr */
	"getxattr",			/* 226 = getxattr */
	"lgetxattr",			/* 227 = lgetxattr */
	"fgetxattr",			/* 228 = fgetxattr */
	"listxattr",			/* 229 = listxattr */
	"llistxattr",			/* 230 = llistxattr */
	"flistxattr",			/* 231 = flistxattr */
	"removexattr",			/* 232 = removexattr */
