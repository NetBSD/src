/* $NetBSD: linux_syscalls.c,v 1.47.2.2 2004/09/18 14:43:32 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.47.2.2 2004/09/18 14:43:32 skrll Exp $");
...
const char *const linux_syscallnames[] = {
	...
	"#223 (unimplemented setxattr)",		/* 223 = unimplemented setxattr */
	"#224 (unimplemented lsetxattr)",		/* 224 = unimplemented lsetxattr */
	"#225 (unimplemented fsetxattr)",		/* 225 = unimplemented fsetxattr */
	"#226 (unimplemented getxattr)",		/* 226 = unimplemented getxattr */
	"#227 (unimplemented lgetxattr)",		/* 227 = unimplemented lgetxattr */
	"#228 (unimplemented fgetxattr)",		/* 228 = unimplemented fgetxattr */
	"#229 (unimplemented listxattr)",		/* 229 = unimplemented listxattr */
	"#230 (unimplemented llistxattr)",		/* 230 = unimplemented llistxattr */
	"#231 (unimplemented flistxattr)",		/* 231 = unimplemented flistxattr */
	"#232 (unimplemented removexattr)",		/* 232 = unimplemented removexattr */
	"#233 (unimplemented lremovexattr)",		/* 233 = unimplemented lremovexattr */
	"#234 (unimplemented fremovexattr)",		/* 234 = unimplemented fremovexattr */
