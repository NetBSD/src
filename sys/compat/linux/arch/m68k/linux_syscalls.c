...
const char *const linux_syscallnames[] = {
	...
	"setuid16",			/* 23 = setuid16 */
	"getuid16",			/* 24 = getuid16 */
	"stime",			/* 25 = stime */
	"ptrace",			/* 26 = ptrace */
	"alarm",			/* 27 = alarm */
	...
	"brk",			/* 45 = brk */
	"setgid16",			/* 46 = setgid16 */
	"getgid16",			/* 47 = getgid16 */
	"signal",			/* 48 = signal */
	"geteuid16",			/* 49 = geteuid16 */
	"getegid16",			/* 50 = getegid16 */
	"acct",			/* 51 = acct */
	...
	"lstat64",			/* 196 = lstat64 */
	"fstat64",			/* 197 = fstat64 */
	"__posix_chown",			/* 198 = __posix_chown */
	"getuid",			/* 199 = getuid */
	"getgid",			/* 200 = getgid */
	"geteuid",			/* 201 = geteuid */
	"getegid",			/* 202 = getegid */
	...
	"__posix_lchown",			/* 212 = __posix_lchown */
	"setuid",			/* 213 = setuid */
	"setgid",			/* 214 = setgid */
