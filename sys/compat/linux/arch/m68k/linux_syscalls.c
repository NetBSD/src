/* $NetBSD: linux_syscalls.c,v 1.66.4.1 2008/05/10 23:48:53 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.66.4.1 2008/05/10 23:48:53 wrstuden Exp $");
