/* $NetBSD: linux_syscalls.c,v 1.37.2.2 2002/03/16 16:00:34 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.37.2.2 2002/03/16 16:00:34 jdolecek Exp $");
