/* $NetBSD: linux_syscalls.c,v 1.43.4.3 2004/05/11 14:38:23 tron Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.43.4.3 2004/05/11 14:38:23 tron Exp $");
