/* $NetBSD: linux_syscalls.c,v 1.105.10.1 2019/06/10 22:06:59 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.105.10.1 2019/06/10 22:06:59 christos Exp $");
