/* $NetBSD: linux_syscalls.c,v 1.66.4.3 2008/06/23 04:30:54 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.66.4.3 2008/06/23 04:30:54 wrstuden Exp $");
