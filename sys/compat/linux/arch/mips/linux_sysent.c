/* $NetBSD: linux_sysent.c,v 1.32.4.1 2008/05/10 23:48:53 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.32.4.1 2008/05/10 23:48:53 wrstuden Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ ns(struct sys_nanosleep_args), 0,
	    (sy_call_t *)sys_nanosleep },	/* 166 = nanosleep */
