/* $NetBSD: linux_sysent.c,v 1.1.2.12 2002/11/11 22:07:06 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.1.2.12 2002/11/11 22:07:06 nathanw Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 212 = unimplemented ftruncate64 */
