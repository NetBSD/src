/* $NetBSD: linux_syscalls.c,v 1.96 2026/09/15 10:42:50 sborrill Exp $ */

/*
 * System call names.
 *
 * DO NOT EDIT-- this file is generated by makesyscalls.sh
 * created from	NetBSD: syscalls.master,v 1.86 2026/09/15 10:42:02 sborrill Exp
 */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.96 2026/09/15 10:42:50 sborrill Exp $");
