/* $NetBSD: linux_syscalls.c,v 1.95 2026/09/11 13:08:12 sborrill Exp $ */

/*
 * System call names.
 *
 * DO NOT EDIT-- this file is generated by makesyscalls.sh
 * created from	NetBSD: syscalls.master,v 1.85 2025/11/10 15:41:38 christos Exp
 */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.95 2026/09/11 13:08:12 sborrill Exp $");
