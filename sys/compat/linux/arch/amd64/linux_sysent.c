/* $NetBSD: linux_sysent.c,v 1.15 2006/08/30 11:19:23 matt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.15 2006/08/30 11:19:23 matt Exp $");
...
#else
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 101 = excluded ptrace */
#endif
	{ 0, 0, 0,
