/* $NetBSD: linux_syscalls.c,v 1.15 2006/08/30 11:19:23 matt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.15 2006/08/30 11:19:23 matt Exp $");
...
const char *const linux_syscallnames[] = {
	...
	"ptrace",			/* 101 = ptrace */
#else
	"#101 (excluded ptrace)",		/* 101 = excluded ptrace */
#endif
	"getuid",			/* 102 = getuid */
	...
	"sched_getaffinity",			/* 204 = sched_getaffinity */
