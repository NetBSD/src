/* $NetBSD: linux_syscalls.c,v 1.27.4.2 2008/12/30 19:34:33 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.27.4.2 2008/12/30 19:34:33 christos Exp $");
