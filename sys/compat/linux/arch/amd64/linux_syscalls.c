/* $NetBSD: linux_syscalls.c,v 1.27.4.3 2009/01/04 02:21:08 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.27.4.3 2009/01/04 02:21:08 christos Exp $");
