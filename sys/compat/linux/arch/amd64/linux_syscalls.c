/* $NetBSD: linux_syscalls.c,v 1.1 2005/05/03 16:26:30 manu Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.1 2005/05/03 16:26:30 manu Exp $");
...
const char *const linux_syscallnames[] = {
	...
	"#188 (unimplemented setxattr)",		/* 188 = unimplemented setxattr */
	"#189 (unimplemented lsetxattr)",		/* 189 = unimplemented lsetxattr */
	"#190 (unimplemented fsetxattr)",		/* 190 = unimplemented fsetxattr */
	"#191 (unimplemented getxattr)",		/* 191 = unimplemented getxattr */
	"#192 (unimplemented lgetxattr)",		/* 192 = unimplemented lgetxattr */
	"#193 (unimplemented fgetxattr)",		/* 193 = unimplemented fgetxattr */
	"#194 (unimplemented listxattr)",		/* 194 = unimplemented listxattr */
	"#195 (unimplemented llistxattr)",		/* 195 = unimplemented llistxattr */
	"#196 (unimplemented flistxattr)",		/* 196 = unimplemented flistxattr */
	"#197 (unimplemented removexattr)",		/* 197 = unimplemented removexattr */
	"#198 (unimplemented lremovexattr)",		/* 198 = unimplemented lremovexattr */
	"#199 (unimplemented fremovexattr)",		/* 199 = unimplemented fremovexattr */
