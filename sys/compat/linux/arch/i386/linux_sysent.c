/* $NetBSD: linux_sysent.c,v 1.70 2007/12/20 23:10:46 dsl Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.70 2007/12/20 23:10:46 dsl Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ 0, 0, 0,
	    (sy_call_t *)linux_sys_getfsuid },	/* 139 = linux_getfsuid16 */
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	{ 0, 0, 0,
	    (sy_call_t *)linux_sys_getfsuid },	/* 216 = getfsuid */
	{ 0, 0, 0,
