/* $NetBSD: linux_sysent.c,v 1.73.8.2 2008/11/01 21:22:26 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.73.8.2 2008/11/01 21:22:26 christos Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ ns(struct compat_50_sys_nanosleep_args), 0,
	    (sy_call_t *)compat_50_sys_nanosleep },/* 162 = nanosleep */
...
#define linux_sys_mmap2_args linux_sys_mmap_args
...
#else
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 241 = unimplemented setaffinity */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 242 = unimplemented getaffinity */
#endif
#ifdef LINUX_NPTL
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 285 = obsolete / * XXXJDM really? * / */
	{ 0, 0, 0,
