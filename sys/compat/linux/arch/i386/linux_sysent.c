/* $NetBSD: linux_sysent.c,v 1.109 2017/01/02 16:32:38 manu Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.109 2017/01/02 16:32:38 manu Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ ns(struct linux_sys_break_args), 0,
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	{ ns(struct linux_sys_set_thread_area_args), 0,
	    (sy_call_t *)linux_sys_set_thread_area },/* 243 = set_thread_area */
	{ ns(struct linux_sys_get_thread_area_args), 0,
