/* $NetBSD: linux_syscalls.c,v 1.74.8.3 2008/11/20 20:45:38 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.74.8.3 2008/11/20 20:45:38 christos Exp $");
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	/* 285 */	"#285 (obsolete / * XXXJDM really? * /)",
