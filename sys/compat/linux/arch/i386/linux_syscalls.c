/* $NetBSD: linux_syscalls.c,v 1.48.2.1 2004/08/03 10:43:54 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.48.2.1 2004/08/03 10:43:54 skrll Exp $");
...
const char *const linux_syscallnames[] = {
	...
	"#252 (unimplemented exit_group)",		/* 252 = unimplemented exit_group */
