/* $NetBSD: linux_syscalls.c,v 1.108.2.3 2017/03/20 06:57:24 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.108.2.3 2017/03/20 06:57:24 pgoyette Exp $");
