/* $NetBSD: linux_syscalls.c,v 1.87.2.1 2010/04/30 14:42:58 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.87.2.1 2010/04/30 14:42:58 uebayasi Exp $");
