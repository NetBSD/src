/* $NetBSD: linux_syscalls.c,v 1.87.2.2 2010/08/17 06:45:44 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.87.2.2 2010/08/17 06:45:44 uebayasi Exp $");
