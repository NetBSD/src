/*	$NetBSD: linux_commons.c,v 1.12.12.2 2008/05/14 01:35:03 wrstuden Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(1, "$NetBSD: linux_commons.c,v 1.12.12.2 2008/05/14 01:35:03 wrstuden Exp $");
