/*	$NetBSD: linux_commons.c,v 1.12.12.1 2008/05/10 23:48:52 wrstuden Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(1, "$NetBSD: linux_commons.c,v 1.12.12.1 2008/05/10 23:48:52 wrstuden Exp $");
