/* $NetBSD: linux_sysent.c,v 1.71 2014/11/22 13:20:35 njoly Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.71 2014/11/22 13:20:35 njoly Exp $");
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	{ ns(struct compat_50_sys_utimes_args), SYCALL_ARG_PTR,
	    (sy_call_t *)compat_50_sys_utimes },/* 251 = utimes */
	...
	{ ns(struct linux_sys_utimensat_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_utimensat },	/* 304 = utimensat */
	{ 0, 0, 0,
