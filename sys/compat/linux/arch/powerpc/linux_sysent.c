/* $NetBSD: linux_sysent.c,v 1.36.24.1 2007/11/18 19:35:10 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.36.24.1 2007/11/18 19:35:10 bouyer Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ ns(struct sys___posix_lchown_args), 0,
	    sys___posix_lchown },		/* 16 = __posix_lchown */
	{ 0, 0, 0,
	...
	{ ns(struct sys___posix_chown_args), 0,
	    sys___posix_chown },		/* 181 = __posix_chown */
	...
	{ ns(struct linux_sys_setxattr_args), 0,
	    linux_sys_setxattr },		/* 209 = setxattr */
	{ ns(struct linux_sys_lsetxattr_args), 0,
	    linux_sys_lsetxattr },		/* 210 = lsetxattr */
	{ ns(struct linux_sys_fsetxattr_args), 0,
	    linux_sys_fsetxattr },		/* 211 = fsetxattr */
	{ ns(struct linux_sys_getxattr_args), 0,
	    linux_sys_getxattr },		/* 212 = getxattr */
	{ ns(struct linux_sys_lgetxattr_args), 0,
	    linux_sys_lgetxattr },		/* 213 = lgetxattr */
	{ ns(struct linux_sys_fgetxattr_args), 0,
	    linux_sys_fgetxattr },		/* 214 = fgetxattr */
	{ ns(struct linux_sys_listxattr_args), 0,
	    linux_sys_listxattr },		/* 215 = listxattr */
	{ ns(struct linux_sys_llistxattr_args), 0,
	    linux_sys_llistxattr },		/* 216 = llistxattr */
	{ ns(struct linux_sys_flistxattr_args), 0,
	    linux_sys_flistxattr },		/* 217 = flistxattr */
	{ ns(struct linux_sys_removexattr_args), 0,
	    linux_sys_removexattr },		/* 218 = removexattr */
	{ ns(struct linux_sys_lremovexattr_args), 0,
	    linux_sys_lremovexattr },		/* 219 = lremovexattr */
	{ ns(struct linux_sys_fremovexattr_args), 0,
	    linux_sys_fremovexattr },		/* 220 = fremovexattr */
	{ 0, 0, 0,
	...
	{ ns(struct linux_sys_clock_settime_args), 0,
	    linux_sys_clock_settime },		/* 245 = clock_settime */
	{ ns(struct linux_sys_clock_gettime_args), 0,
	    linux_sys_clock_gettime },		/* 246 = clock_gettime */
	{ ns(struct linux_sys_clock_getres_args), 0,
	    linux_sys_clock_getres },		/* 247 = clock_getres */
	{ ns(struct linux_sys_clock_nanosleep_args), 0,
	    linux_sys_clock_nanosleep },	/* 248 = clock_nanosleep */
	{ 0, 0, 0,
