/* $NetBSD: linux_sysent.c,v 1.6 2001/03/30 18:02:29 jdolecek Exp $ */
...
struct sysent linux_sysent[] = {
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 166 = unimplemented query_module */
	{ 3, s(struct sys_poll_args), 0,
	    sys_poll },				/* 167 = poll */
	{ 0, 0, 0,
	    sys_nosys },			/* 168 = unimplemented nfsservctl */
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 171 = unimplemented prctl */
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 176 = unimplemented rt_sigtimedwait */
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 183 = unimplemented capget */
	{ 0, 0, 0,
	    sys_nosys },			/* 184 = unimplemented capset */
	{ 2, s(struct linux_sys_sigaltstack_args), 0,
	    linux_sys_sigaltstack },		/* 185 = sigaltstack */
	{ 0, 0, 0,
	    sys_nosys },			/* 186 = unimplemented sendfile */
	{ 0, 0, 0,
	    sys_nosys },			/* 187 = unimplemented getpmsg */
	{ 0, 0, 0,
	    sys_nosys },			/* 188 = unimplemented putpmsg */
	{ 0, 0, 0,
	    sys___vfork14 },			/* 189 = __vfork14 */
	{ 0, 0, 0,
	    sys_nosys },			/* 190 = unimplemented sys_getrlimit */
	{ 0, 0, 0,
	    sys_nosys },			/* 191 = unimplemented / * unused * / */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 198 = unimplemented sys_pciconfig_read */
	{ 0, 0, 0,
	    sys_nosys },			/* 199 = unimplemented sys_pciconfig_write */
	{ 0, 0, 0,
	    sys_nosys },			/* 200 = unimplemented sys_pciconfig_iobase */
	{ 0, 0, 0,
	    sys_nosys },			/* 201 = unimplemented / * Unused ( MacOnLinux project ) * / */
	{ 0, 0, 0,
	    sys_nosys },			/* 202 = unimplemented sys_getdents64 */
	{ 0, 0, 0,
	    sys_nosys },			/* 203 = unimplemented pivot_root */
	{ 0, 0, 0,
	    sys_nosys },			/* 204 = unimplemented fcntl64 */
	{ 0, 0, 0,
	    sys_nosys },			/* 205 = unimplemented madvise */
	{ 0, 0, 0,
	    sys_nosys },			/* 206 = unimplemented mincore */
};
