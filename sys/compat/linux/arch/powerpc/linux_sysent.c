/* $NetBSD: linux_sysent.c,v 1.50.2.1 2010/08/17 06:45:47 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.50.2.1 2010/08/17 06:45:47 uebayasi Exp $");
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 281 = unimplemented ppoll */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 316 = unimplemented dup3 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 317 = unimplemented pipe2 */
	{ 0, 0, 0,
