/* $NetBSD: linux_sysent.c,v 1.21.2.5 2005/03/04 16:40:02 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_sysent.c,v 1.21.2.5 2005/03/04 16:40:02 skrll Exp $");
...
struct sysent linux_sysent[] = {
	...
	{ 1, s(struct linux_sys_exit_group_args), 0,
	    linux_sys_exit_group },		/* 234 = exit_group */
	{ 0, 0, 0,
