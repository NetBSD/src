/* $NetBSD: linux_syscalls.c,v 1.41.4.1 2008/05/10 23:48:55 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.41.4.1 2008/05/10 23:48:55 wrstuden Exp $");
