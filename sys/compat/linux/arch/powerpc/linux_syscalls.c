/* $NetBSD: linux_syscalls.c,v 1.49.2.1 2010/08/17 06:45:47 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.49.2.1 2010/08/17 06:45:47 uebayasi Exp $");
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	/* 316 */	"#316 (unimplemented dup3)",
	/* 317 */	"#317 (unimplemented pipe2)",
