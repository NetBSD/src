/* $NetBSD: linux_syscalls.c,v 1.74.2.1 2016/07/26 03:24:20 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux_syscalls.c,v 1.74.2.1 2016/07/26 03:24:20 pgoyette Exp $");
