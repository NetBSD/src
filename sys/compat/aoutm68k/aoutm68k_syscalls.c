/* $NetBSD: aoutm68k_syscalls.c,v 1.25.12.1 2007/11/13 16:00:33 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.25.12.1 2007/11/13 16:00:33 bouyer Exp $");
