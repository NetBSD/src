/* $NetBSD: aoutm68k_syscalls.c,v 1.38.4.1 2011/06/06 09:07:14 jruoho Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.38.4.1 2011/06/06 09:07:14 jruoho Exp $");
