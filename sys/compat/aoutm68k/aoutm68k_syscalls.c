/* $NetBSD: aoutm68k_syscalls.c,v 1.29.4.1 2008/05/10 23:48:47 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.29.4.1 2008/05/10 23:48:47 wrstuden Exp $");
