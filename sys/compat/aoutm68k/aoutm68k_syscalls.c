/* $NetBSD: aoutm68k_syscalls.c,v 1.5.2.3 2001/11/14 19:12:53 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.5.2.3 2001/11/14 19:12:53 nathanw Exp $");
