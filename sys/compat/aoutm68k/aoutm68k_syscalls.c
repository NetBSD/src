/* $NetBSD: aoutm68k_syscalls.c,v 1.40.6.1 2015/04/06 15:18:05 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.40.6.1 2015/04/06 15:18:05 skrll Exp $");
