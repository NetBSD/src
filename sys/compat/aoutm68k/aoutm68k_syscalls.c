/* $NetBSD: aoutm68k_syscalls.c,v 1.15.16.1 2006/09/09 02:45:14 rpaulo Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.15.16.1 2006/09/09 02:45:14 rpaulo Exp $");
