/* $NetBSD: aoutm68k_syscalls.c,v 1.39.14.1 2017/12/03 11:36:52 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.39.14.1 2017/12/03 11:36:52 jdolecek Exp $");
