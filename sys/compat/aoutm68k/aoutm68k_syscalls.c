/* $NetBSD: aoutm68k_syscalls.c,v 1.38.2.1 2011/04/21 01:41:35 rmind Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.38.2.1 2011/04/21 01:41:35 rmind Exp $");
