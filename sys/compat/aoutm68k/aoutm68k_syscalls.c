/* $NetBSD: aoutm68k_syscalls.c,v 1.7.2.1 2002/01/10 19:50:57 thorpej Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.7.2.1 2002/01/10 19:50:57 thorpej Exp $");
