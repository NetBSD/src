/* $NetBSD: aoutm68k_syscalls.c,v 1.29.6.1 2008/06/27 15:11:19 simonb Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.29.6.1 2008/06/27 15:11:19 simonb Exp $");
