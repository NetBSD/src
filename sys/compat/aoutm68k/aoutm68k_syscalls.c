/* $NetBSD: aoutm68k_syscalls.c,v 1.11.2.3 2004/09/21 13:24:56 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.11.2.3 2004/09/21 13:24:56 skrll Exp $");
