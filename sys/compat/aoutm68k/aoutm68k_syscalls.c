/* $NetBSD: aoutm68k_syscalls.c,v 1.11.2.1 2004/08/03 10:43:28 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.11.2.1 2004/08/03 10:43:28 skrll Exp $");
