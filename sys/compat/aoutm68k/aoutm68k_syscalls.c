/* $NetBSD: aoutm68k_syscalls.c,v 1.15.20.3 2006/08/11 15:43:19 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.15.20.3 2006/08/11 15:43:19 yamt Exp $");
