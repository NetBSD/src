/* $NetBSD: aoutm68k_syscalls.c,v 1.29.4.3 2008/06/23 04:30:51 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.29.4.3 2008/06/23 04:30:51 wrstuden Exp $");
