/* $NetBSD: aoutm68k_syscalls.c,v 1.49.4.2 2020/04/13 08:04:13 martin Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.49.4.2 2020/04/13 08:04:13 martin Exp $");
