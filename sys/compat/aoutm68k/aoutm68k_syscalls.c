/* $NetBSD: aoutm68k_syscalls.c,v 1.15.20.2 2006/06/26 12:45:41 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.15.20.2 2006/06/26 12:45:41 yamt Exp $");
