/* $NetBSD: aoutm68k_syscalls.c,v 1.15.18.1 2006/06/01 22:35:42 kardel Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.15.18.1 2006/06/01 22:35:42 kardel Exp $");
