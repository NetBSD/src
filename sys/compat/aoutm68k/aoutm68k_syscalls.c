/* $NetBSD: aoutm68k_syscalls.c,v 1.5.2.8 2002/11/11 22:06:42 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.5.2.8 2002/11/11 22:06:42 nathanw Exp $");
