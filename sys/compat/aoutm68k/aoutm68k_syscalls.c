/* $NetBSD: aoutm68k_syscalls.c,v 1.44.4.1 2017/05/11 02:58:35 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.44.4.1 2017/05/11 02:58:35 pgoyette Exp $");
