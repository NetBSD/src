/* $NetBSD: aoutm68k_syscalls.c,v 1.40.6.2 2015/12/27 12:09:45 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.40.6.2 2015/12/27 12:09:45 skrll Exp $");
