/* $NetBSD: aoutm68k_syscalls.c,v 1.15.20.1 2006/05/24 10:57:26 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.15.20.1 2006/05/24 10:57:26 yamt Exp $");
