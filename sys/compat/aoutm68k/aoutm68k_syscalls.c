/* $NetBSD: aoutm68k_syscalls.c,v 1.30.4.1 2009/01/19 13:17:17 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.30.4.1 2009/01/19 13:17:17 skrll Exp $");
