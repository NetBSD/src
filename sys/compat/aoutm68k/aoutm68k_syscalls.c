/* $NetBSD: aoutm68k_syscalls.c,v 1.29.4.2 2008/05/14 01:35:01 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.29.4.2 2008/05/14 01:35:01 wrstuden Exp $");
