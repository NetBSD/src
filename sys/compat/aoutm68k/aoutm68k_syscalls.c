/* $NetBSD: aoutm68k_syscalls.c,v 1.25.6.1 2007/11/11 16:47:09 joerg Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.25.6.1 2007/11/11 16:47:09 joerg Exp $");
