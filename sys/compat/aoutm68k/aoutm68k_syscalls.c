/* $NetBSD: aoutm68k_syscalls.c,v 1.25.6.2 2007/11/14 19:04:18 joerg Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.25.6.2 2007/11/14 19:04:18 joerg Exp $");
