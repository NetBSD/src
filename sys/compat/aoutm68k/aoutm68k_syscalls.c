/* $NetBSD: aoutm68k_syscalls.c,v 1.15.20.4 2006/09/03 15:23:37 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_syscalls.c,v 1.15.20.4 2006/09/03 15:23:37 yamt Exp $");
