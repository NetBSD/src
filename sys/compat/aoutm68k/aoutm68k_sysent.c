/* $NetBSD: aoutm68k_sysent.c,v 1.54.4.1 2019/06/10 22:06:57 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_sysent.c,v 1.54.4.1 2019/06/10 22:06:57 christos Exp $");
