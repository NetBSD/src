/* $NetBSD: aoutm68k_sysent.c,v 1.22.2.1 2006/07/13 17:49:07 gdamore Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_sysent.c,v 1.22.2.1 2006/07/13 17:49:07 gdamore Exp $");
