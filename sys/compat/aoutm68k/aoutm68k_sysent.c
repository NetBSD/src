/* $NetBSD: aoutm68k_sysent.c,v 1.33.4.3 2008/06/23 04:30:51 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_sysent.c,v 1.33.4.3 2008/06/23 04:30:51 wrstuden Exp $");
