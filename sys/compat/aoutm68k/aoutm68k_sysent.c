/* $NetBSD: aoutm68k_sysent.c,v 1.41.2.1 2010/04/30 14:42:56 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_sysent.c,v 1.41.2.1 2010/04/30 14:42:56 uebayasi Exp $");
