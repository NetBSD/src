/* $NetBSD: aoutm68k_sysent.c,v 1.33.4.2 2008/05/14 01:35:01 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_sysent.c,v 1.33.4.2 2008/05/14 01:35:01 wrstuden Exp $");
