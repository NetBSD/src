/* $NetBSD: aoutm68k_sysent.c,v 1.33.4.1 2008/05/10 23:48:47 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_sysent.c,v 1.33.4.1 2008/05/10 23:48:47 wrstuden Exp $");
