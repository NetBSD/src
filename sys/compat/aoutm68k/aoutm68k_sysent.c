/* $NetBSD: aoutm68k_sysent.c,v 1.29.12.1 2007/11/13 16:00:33 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_sysent.c,v 1.29.12.1 2007/11/13 16:00:33 bouyer Exp $");
