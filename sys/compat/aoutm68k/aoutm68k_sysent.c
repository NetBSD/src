/* $NetBSD: aoutm68k_sysent.c,v 1.44.14.2 2017/12/03 11:36:52 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_sysent.c,v 1.44.14.2 2017/12/03 11:36:52 jdolecek Exp $");
