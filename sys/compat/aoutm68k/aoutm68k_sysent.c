/* $NetBSD: aoutm68k_sysent.c,v 1.58 2026/09/11 13:08:11 sborrill Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: aoutm68k_sysent.c,v 1.58 2026/09/11 13:08:11 sborrill Exp $");
...
struct sysent aoutm68k_sysent[] = {
	...
	},		/* 197 = mmap */
	{
		...
		.sy_flags = SYCALL_NARGS64_VAL(1) | SYCALL_ARG0_64 | SYCALL_RET_WIDE | SYCALL_RET_64 | SYCALL_INDIRECT | 0,
