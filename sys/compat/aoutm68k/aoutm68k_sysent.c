/* $NetBSD: aoutm68k_sysent.c,v 1.3.2.2 2001/01/08 14:56:50 bouyer Exp $ */
...
struct sysent aoutm68k_sysent[] = {
	...
	{ 3, s(struct sys_write_args),
	    sys_write },			/* 4 = write */
	{ 3, s(struct aoutm68k_sys_open_args),
	...
	{ 2, s(struct aoutm68k_sys_access_args),
	    aoutm68k_sys_access },		/* 33 = access */
	{ 2, s(struct aoutm68k_sys_chflags_args),
	...
	{ 2, s(struct sys_kill_args),
	    sys_kill },				/* 37 = kill */
#ifdef COMPAT_43
	{ 2, s(struct aoutm68k_compat_43_sys_stat_args),
...
#ifdef COMPAT_43
	{ 2, s(struct aoutm68k_compat_43_sys_lstat_args),
...
#endif
	{ 3, s(struct aoutm68k_sys_ioctl_args),
...
#endif
	{ 1, s(struct aoutm68k_sys_revoke_args),
	    aoutm68k_sys_revoke },		/* 56 = revoke */
	{ 2, s(struct aoutm68k_sys_symlink_args),
	    aoutm68k_sys_symlink },		/* 57 = symlink */
	{ 3, s(struct aoutm68k_sys_readlink_args),
	    aoutm68k_sys_readlink },		/* 58 = readlink */
	{ 3, s(struct aoutm68k_sys_execve_args),
	    aoutm68k_sys_execve },		/* 59 = execve */
	{ 1, s(struct sys_umask_args),
	    sys_umask },			/* 60 = umask */
	{ 1, s(struct aoutm68k_sys_chroot_args),
	    aoutm68k_sys_chroot },		/* 61 = chroot */
#ifdef COMPAT_43
	{ 2, s(struct aoutm68k_compat_43_sys_fstat_args),
	...
	{ 2, s(struct aoutm68k_sys_rename_args),
	    aoutm68k_sys_rename },		/* 128 = rename */
#ifdef COMPAT_43
	{ 2, s(struct aoutm68k_compat_43_sys_truncate_args),
	...
	{ 2, s(struct sys_mkdir_args),
	    sys_mkdir },			/* 136 = mkdir */
	{ 1, s(struct aoutm68k_sys_rmdir_args),
	    aoutm68k_sys_rmdir },		/* 137 = rmdir */
	{ 2, s(struct aoutm68k_sys_utimes_args),
...
#endif
	{ 2, s(struct aoutm68k_sys_statfs_args),
...
#if defined(NFS) || defined(NFSSERVER) || !defined(_KERNEL)
	{ 2, s(struct aoutm68k_sys_getfh_args),
...
#endif
#ifdef COMPAT_12
	{ 2, s(struct aoutm68k_compat_12_sys_stat_args),
	    aoutm68k_compat_12_sys_stat },	/* 188 = stat12 */
	{ 2, s(struct aoutm68k_compat_12_sys_fstat_args),
	    aoutm68k_compat_12_sys_fstat },	/* 189 = fstat12 */
	{ 2, s(struct aoutm68k_compat_12_sys_lstat_args),
...
#endif
	{ 2, s(struct aoutm68k_sys_pathconf_args),
	...
	{ 4, s(struct sys_lseek_args),
	    sys_lseek },			/* 199 = lseek */
	{ 3, s(struct aoutm68k_sys_truncate_args),
	...
	{ 1, s(struct aoutm68k_sys_undelete_args),
	...
	{ 2, s(struct aoutm68k_sys___posix_rename_args),
	...
	{ 2, s(struct aoutm68k_sys_lchmod_args),
	    aoutm68k_sys_lchmod },		/* 274 = lchmod */
	{ 3, s(struct aoutm68k_sys_lchown_args),
	    aoutm68k_sys_lchown },		/* 275 = lchown */
	{ 2, s(struct aoutm68k_sys_lutimes_args),
	    aoutm68k_sys_lutimes },		/* 276 = lutimes */
	{ 3, s(struct sys___msync13_args),
	    sys___msync13 },			/* 277 = __msync13 */
	{ 2, s(struct aoutm68k_sys___stat13_args),
	    aoutm68k_sys___stat13 },		/* 278 = __stat13 */
	{ 2, s(struct aoutm68k_sys___fstat13_args),
	    aoutm68k_sys___fstat13 },		/* 279 = __fstat13 */
	{ 2, s(struct aoutm68k_sys___lstat13_args),
	...
	{ 3, s(struct aoutm68k_sys___posix_chown_args),
	...
	{ 2, s(struct aoutm68k_sys_fhstat_args),
