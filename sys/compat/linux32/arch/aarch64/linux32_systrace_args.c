/* $NetBSD: linux32_systrace_args.c,v 1.4 2026/09/11 13:08:12 sborrill Exp $ */
...
#define linux32_sys_fcntl64_args linux32_sys_fcntl_args
	...
	/* linux32_sys_socket */
	case 281: {
		const struct linux32_sys_socket_args *p = params;
	...
	/* linux32_sys_bind */
	case 282: {
		const struct linux32_sys_bind_args *p = params;
		iarg[0] = SCARG(p, s); /* int */
		uarg[1] = (intptr_t) SCARG(p, name).i32; /* netbsd32_osockaddrp_t */
	...
	/* linux32_sys_connect */
	case 283: {
		const struct linux32_sys_connect_args *p = params;
		iarg[0] = SCARG(p, s); /* int */
		uarg[1] = (intptr_t) SCARG(p, name).i32; /* netbsd32_osockaddrp_t */
		iarg[2] = SCARG(p, namelen); /* int */
		*n_args = 3;
	...
	/* linux32_sys_accept */
	case 285: {
		const struct linux32_sys_accept_args *p = params;
		iarg[0] = SCARG(p, s); /* int */
		uarg[1] = (intptr_t) SCARG(p, name).i32; /* netbsd32_osockaddrp_t */
	...
	/* linux32_sys_getsockname */
	case 286: {
		const struct linux32_sys_getsockname_args *p = params;
		iarg[0] = SCARG(p, fdec); /* int */
		uarg[1] = (intptr_t) SCARG(p, asa).i32; /* netbsd32_charp */
		uarg[2] = (intptr_t) SCARG(p, alen).i32; /* netbsd32_intp */
		*n_args = 3;
		break;
	}
	/* linux32_sys_getpeername */
	case 287: {
		const struct linux32_sys_getpeername_args *p = params;
	...
	/* linux32_sys_socketpair */
	case 288: {
		const struct linux32_sys_socketpair_args *p = params;
		iarg[0] = SCARG(p, domain); /* int */
		iarg[1] = SCARG(p, type); /* int */
		iarg[2] = SCARG(p, protocol); /* int */
	...
	/* linux32_sys_send */
	case 289: {
		const struct linux32_sys_send_args *p = params;
		iarg[0] = SCARG(p, s); /* int */
		uarg[1] = (intptr_t) SCARG(p, buf).i32; /* netbsd32_voidp */
	...
	/* linux32_sys_sendto */
	case 290: {
		const struct linux32_sys_sendto_args *p = params;
		iarg[0] = SCARG(p, s); /* int */
		uarg[1] = (intptr_t) SCARG(p, msg).i32; /* netbsd32_voidp */
		iarg[2] = SCARG(p, len); /* int */
		iarg[3] = SCARG(p, flags); /* int */
		uarg[4] = (intptr_t) SCARG(p, to).i32; /* netbsd32_osockaddrp_t */
	...
	case 292: {
		...
		iarg[3] = SCARG(p, flags); /* int */
		uarg[4] = (intptr_t) SCARG(p, from).i32; /* netbsd32_osockaddrp_t */
		uarg[5] = (intptr_t) SCARG(p, fromlenaddr).i32; /* netbsd32_intp */
		*n_args = 6;
		break;
	}
	/* linux32_sys_setsockopt */
	case 294: {
		const struct linux32_sys_setsockopt_args *p = params;
		iarg[0] = SCARG(p, s); /* int */
		iarg[1] = SCARG(p, level); /* int */
		iarg[2] = SCARG(p, optname); /* int */
		uarg[3] = (intptr_t) SCARG(p, optval).i32; /* netbsd32_voidp */
		iarg[4] = SCARG(p, optlen); /* int */
		*n_args = 5;
		break;
	}
	/* linux32_sys_getsockopt */
	case 295: {
		const struct linux32_sys_getsockopt_args *p = params;
		iarg[0] = SCARG(p, s); /* int */
		iarg[1] = SCARG(p, level); /* int */
		iarg[2] = SCARG(p, optname); /* int */
		uarg[3] = (intptr_t) SCARG(p, optval).i32; /* netbsd32_voidp */
		uarg[4] = (intptr_t) SCARG(p, optlen).i32; /* netbsd32_intp */
		*n_args = 5;
		break;
	}
	/* linux32_sys_openat */
	...
	/* linux32_sys_prlimit64 */
	case 369: {
		const struct linux32_sys_prlimit64_args *p = params;
		iarg[0] = SCARG(p, pid); /* pid_t */
		iarg[1] = SCARG(p, which); /* int */
		uarg[2] = (intptr_t) SCARG(p, new_rlp).i32; /* netbsd32_rlimitp_t */
		uarg[3] = (intptr_t) SCARG(p, old_rlp).i32; /* netbsd32_rlimitp_t */
		*n_args = 4;
		break;
	}
	/* netbsd32_getrandom */
	...
	/* linux32_sys_statx */
	case 397: {
		const struct linux32_sys_statx_args *p = params;
		iarg[0] = SCARG(p, fd); /* int */
		uarg[1] = (intptr_t) SCARG(p, path).i32; /* netbsd32_charp */
		iarg[2] = SCARG(p, flag); /* int */
		uarg[3] = SCARG(p, mask); /* unsigned int */
		uarg[4] = (intptr_t) SCARG(p, sp).i32; /* linux32_statxp */
		*n_args = 5;
		break;
	}
	/* linux32_sys_set_tls */
	case 485: {
		const struct linux32_sys_set_tls_args *p = params;
		uarg[0] = (intptr_t) SCARG(p, tls).i32; /* netbsd32_voidp */
		*n_args = 1;
		break;
	}
	/* linux32_sys_get_tls */
