/* $NetBSD: linux32_sysent.c,v 1.4 2026/09/11 13:08:12 sborrill Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_sysent.c,v 1.4 2026/09/11 13:08:12 sborrill Exp $");
...
#define linux32_sys_fcntl64_args linux32_sys_fcntl_args
	...
	{
		ns(struct linux32_sys_socket_args),
		.sy_call = (sy_call_t *)linux32_sys_socket
	},		/* 281 = socket */
	{
		ns(struct linux32_sys_bind_args),
		.sy_call = (sy_call_t *)linux32_sys_bind
	},		/* 282 = bind */
	{
		ns(struct linux32_sys_connect_args),
		.sy_call = (sy_call_t *)linux32_sys_connect
	},		/* 283 = connect */
	{
		.sy_call = linux_sys_nosys,
	},		/* 284 = filler */
	{
		ns(struct linux32_sys_accept_args),
		.sy_call = (sy_call_t *)linux32_sys_accept
	},		/* 285 = accept */
	{
		ns(struct linux32_sys_getsockname_args),
		.sy_call = (sy_call_t *)linux32_sys_getsockname
	},		/* 286 = getsockname */
	{
		ns(struct linux32_sys_getpeername_args),
		.sy_call = (sy_call_t *)linux32_sys_getpeername
	},		/* 287 = getpeername */
	{
		ns(struct linux32_sys_socketpair_args),
		.sy_call = (sy_call_t *)linux32_sys_socketpair
	},		/* 288 = socketpair */
	{
		ns(struct linux32_sys_send_args),
		.sy_call = (sy_call_t *)linux32_sys_send
	},		/* 289 = send */
	{
		ns(struct linux32_sys_sendto_args),
		.sy_call = (sy_call_t *)linux32_sys_sendto
	},		/* 290 = sendto */
	{
		ns(struct linux32_sys_recv_args),
		.sy_call = (sy_call_t *)linux32_sys_recv
	},		/* 291 = recv */
	{
		ns(struct linux32_sys_recvfrom_args),
		.sy_call = (sy_call_t *)linux32_sys_recvfrom
	},		/* 292 = recvfrom */
	{
		.sy_call = linux_sys_nosys,
	},		/* 293 = filler */
	{
		ns(struct linux32_sys_setsockopt_args),
		.sy_call = (sy_call_t *)linux32_sys_setsockopt
	},		/* 294 = setsockopt */
	{
		ns(struct linux32_sys_getsockopt_args),
		.sy_call = (sy_call_t *)linux32_sys_getsockopt
	},		/* 295 = getsockopt */
	{
		.sy_call = linux_sys_nosys,
	},		/* 296 = filler */
	...
	{
		ns(struct linux32_sys_statx_args),
		.sy_call = (sy_call_t *)linux32_sys_statx
	},		/* 397 = statx */
	{
		.sy_call = linux_sys_nosys,
	},		/* 398 = filler */
	...
	{
		ns(struct linux32_sys_set_tls_args),
		.sy_call = (sy_call_t *)linux32_sys_set_tls
	},		/* 485 = set_tls */
	{
		.sy_call = (sy_call_t *)linux32_sys_get_tls
	},		/* 486 = get_tls */
	{
		.sy_call = linux_sys_nosys,
	},		/* 487 = filler */
