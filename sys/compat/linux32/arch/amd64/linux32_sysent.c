/* $NetBSD: linux32_sysent.c,v 1.88 2026/09/11 13:08:13 sborrill Exp $ */

/*
 * System call switch table.
 *
 * DO NOT EDIT-- this file is generated by makesyscalls.sh
 * created from	NetBSD: syscalls.master,v 1.77 2021/12/02 04:29:48 ryo Exp
 */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_sysent.c,v 1.88 2026/09/11 13:08:13 sborrill Exp $");
...
struct sysent linux32_sysent[] = {
	...
	},		/* 179 = rt_sigsuspend */
	{
		...
		.sy_flags = SYCALL_NARGS64_VAL(1) | SYCALL_ARG3_64 | SYCALL_RET_WIDE,
...
const uint32_t linux32_sysent_nomodbits[] = {
