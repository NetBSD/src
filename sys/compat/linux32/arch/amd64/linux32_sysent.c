/* $NetBSD: linux32_sysent.c,v 1.58.2.2 2010/11/06 08:08:26 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_sysent.c,v 1.58.2.2 2010/11/06 08:08:26 uebayasi Exp $");
