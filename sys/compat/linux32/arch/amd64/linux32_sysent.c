/* $NetBSD: linux32_sysent.c,v 1.36.6.1 2008/06/23 04:30:54 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_sysent.c,v 1.36.6.1 2008/06/23 04:30:54 wrstuden Exp $");
