/* $NetBSD: linux32_sysent.c,v 1.3.14.1 2006/07/13 17:49:14 gdamore Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_sysent.c,v 1.3.14.1 2006/07/13 17:49:14 gdamore Exp $");
...
struct sysent linux32_sysent[] = {
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 148 = unimplemented fdatasync */
