/* $NetBSD: linux32_sysent.c,v 1.17.12.2 2007/11/18 19:35:13 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_sysent.c,v 1.17.12.2 2007/11/18 19:35:13 bouyer Exp $");
...
struct sysent linux32_sysent[] = {
	...
	{ ns(struct netbsd32_readlink_args), 0,
	    netbsd32_readlink },		/* 85 = netbsd32_readlink */
	{ 0, 0, 0,
