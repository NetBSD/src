/* $NetBSD: linux32_sysent.c,v 1.17.6.4 2007/11/11 16:47:17 joerg Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_sysent.c,v 1.17.6.4 2007/11/11 16:47:17 joerg Exp $");
...
struct sysent linux32_sysent[] = {
	...
	{ 1, s(struct netbsd32_setuid_args), 0,
	    netbsd32_setuid },			/* 23 = linux_setuid16 */
	{ 0, 0, 0,
	...
	{ 1, s(struct linux32_sys_alarm_args), 0,
	    linux32_sys_alarm },		/* 27 = alarm */
	{ 0, 0, 0,
	...
	{ 1, s(struct linux32_sys_nice_args), 0,
	    linux32_sys_nice },			/* 34 = nice */
	{ 0, 0, 0,
	...
	{ 1, s(struct netbsd32_setgid_args), 0,
	    netbsd32_setgid },			/* 46 = linux_setgid16 */
	{ 0, 0, 0,
	...
	{ 2, s(struct linux32_sys_setreuid16_args), 0,
	    linux32_sys_setreuid16 },		/* 70 = setreuid16 */
	{ 2, s(struct linux32_sys_setregid16_args), 0,
	    linux32_sys_setregid16 },		/* 71 = setregid16 */
	{ 0, 0, 0,
	...
	{ 2, s(struct netbsd32_fchmod_args), 0,
	    netbsd32_fchmod },			/* 94 = netbsd32_fchmod */
	...
	{ 1, s(struct netbsd32_fsync_args), 0,
	    netbsd32_fsync },			/* 118 = netbsd32_fsync */
	...
	{ 1, s(struct netbsd32_fchdir_args), 0,
	    netbsd32_fchdir },			/* 133 = netbsd32_fchdir */
	{ 0, 0, 0,
	...
	{ 1, s(struct linux32_sys_setfsuid_args), 0,
	...
	{ 2, s(struct netbsd32_flock_args), 0,
	    netbsd32_flock },			/* 143 = netbsd32_flock */
	{ 0, 0, 0,
	...
	{ 1, s(struct netbsd32_getsid_args), 0,
	    netbsd32_getsid },			/* 147 = netbsd32_getsid */
	{ 1, s(struct linux32_sys_fdatasync_args), 0,
	    linux32_sys_fdatasync },		/* 148 = fdatasync */
	...
	{ 1, s(struct netbsd32_mlockall_args), 0,
	    netbsd32_mlockall },		/* 152 = netbsd32_mlockall */
	{ 0, 0, 0,
	...
	{ 1, s(struct linux32_sys_sched_getscheduler_args), 0,
	    linux32_sys_sched_getscheduler },	/* 157 = sched_getscheduler */
	{ 0, 0, 0,
	...
	{ 3, s(struct linux32_sys_setresuid16_args), 0,
	...
	{ 3, s(struct linux32_sys_setresgid16_args), 0,
	    linux32_sys_setresgid16 },		/* 170 = setresgid16 */
	{ 0, 0, 0,
	...
	{ 3, s(struct linux32_sys_chown16_args), 0,
	    linux32_sys_chown16 },		/* 182 = chown16 */
	...
	{ 3, s(struct netbsd32___posix_lchown_args), 0,
	    netbsd32___posix_lchown },		/* 198 = netbsd32___posix_lchown */
	{ 0, 0, 0,
	...
	{ 2, s(struct netbsd32_setreuid_args), 0,
	    netbsd32_setreuid },		/* 203 = netbsd32_setreuid */
	{ 2, s(struct netbsd32_setregid_args), 0,
	    netbsd32_setregid },		/* 204 = netbsd32_setregid */
	...
	{ 3, s(struct netbsd32___posix_chown_args), 0,
	    netbsd32___posix_chown },		/* 212 = netbsd32___posix_chown */
	{ 1, s(struct netbsd32_setuid_args), 0,
	    netbsd32_setuid },			/* 213 = netbsd32_setuid */
	{ 1, s(struct netbsd32_setgid_args), 0,
	    netbsd32_setgid },			/* 214 = netbsd32_setgid */
	{ 1, s(struct linux32_sys_setfsuid_args), 0,
	    linux32_sys_setfsuid },		/* 215 = setfsuid */
	{ 0, 0, 0,
	...
	{ 1, s(struct linux32_sys_exit_group_args), 0,
	    linux32_sys_exit_group },		/* 252 = exit_group */
	{ 0, 0, 0,
