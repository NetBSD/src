/* $NetBSD: linux32_syscalls.c,v 1.78.8.1 2018/09/06 06:55:46 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.78.8.1 2018/09/06 06:55:46 pgoyette Exp $");
