/* $NetBSD: linux32_syscalls.c,v 1.17.12.2 2007/11/18 19:35:13 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.17.12.2 2007/11/18 19:35:13 bouyer Exp $");
