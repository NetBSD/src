/* $NetBSD: linux32_syscalls.c,v 1.75.2.1 2017/03/20 06:57:25 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.75.2.1 2017/03/20 06:57:25 pgoyette Exp $");
