/* $NetBSD: linux32_syscalls.c,v 1.23.6.2 2008/01/08 22:10:46 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.23.6.2 2008/01/08 22:10:46 bouyer Exp $");
