/* $NetBSD: linux32_syscalls.c,v 1.78.10.1 2019/06/10 22:07:00 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.78.10.1 2019/06/10 22:07:00 christos Exp $");
