/* $NetBSD: linux32_syscalls.c,v 1.58.2.1 2010/08/17 06:45:51 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.58.2.1 2010/08/17 06:45:51 uebayasi Exp $");
