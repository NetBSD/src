/* $NetBSD: linux32_syscalls.c,v 1.3.14.1 2006/07/13 17:49:14 gdamore Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.3.14.1 2006/07/13 17:49:14 gdamore Exp $");
