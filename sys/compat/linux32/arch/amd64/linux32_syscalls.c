/* $NetBSD: linux32_syscalls.c,v 1.37.2.2 2008/07/28 14:37:26 simonb Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.37.2.2 2008/07/28 14:37:26 simonb Exp $");
