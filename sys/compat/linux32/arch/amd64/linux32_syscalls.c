/* $NetBSD: linux32_syscalls.c,v 1.47.2.2 2009/01/04 01:58:39 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.47.2.2 2009/01/04 01:58:39 christos Exp $");
