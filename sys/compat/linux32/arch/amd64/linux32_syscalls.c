/* $NetBSD: linux32_syscalls.c,v 1.10.4.2 2007/04/20 20:28:35 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.10.4.2 2007/04/20 20:28:35 bouyer Exp $");
