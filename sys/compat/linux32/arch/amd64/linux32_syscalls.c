/* $NetBSD: linux32_syscalls.c,v 1.60.2.1 2011/06/06 09:07:28 jruoho Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.60.2.1 2011/06/06 09:07:28 jruoho Exp $");
