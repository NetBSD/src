/* $NetBSD: linux32_syscalls.c,v 1.23.6.3 2008/01/19 12:14:59 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.23.6.3 2008/01/19 12:14:59 bouyer Exp $");
