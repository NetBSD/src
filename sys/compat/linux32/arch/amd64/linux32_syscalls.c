/* $NetBSD: linux32_syscalls.c,v 1.36.6.2 2008/09/18 04:36:45 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.36.6.2 2008/09/18 04:36:45 wrstuden Exp $");
