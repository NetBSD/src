/* $NetBSD: linux32_syscalls.c,v 1.23.6.1 2008/01/02 21:52:47 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: linux32_syscalls.c,v 1.23.6.1 2008/01/02 21:52:47 bouyer Exp $");
