/*	$NetBSD: uipc_syscalls_30.c,v 1.3.98.1 2019/06/10 22:06:58 christos Exp $	*/

/* written by Pavel Cahyna, 2006. Public domain. */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: uipc_syscalls_30.c,v 1.3.98.1 2019/06/10 22:06:58 christos Exp $");
