/*	$NetBSD: uipc_syscalls_40.c,v 1.12.2.1 2017/04/21 16:53:40 bouyer Exp $	*/

/* written by Pavel Cahyna, 2006. Public domain. */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: uipc_syscalls_40.c,v 1.12.2.1 2017/04/21 16:53:40 bouyer Exp $");
