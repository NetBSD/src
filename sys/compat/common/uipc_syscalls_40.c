/*	$NetBSD: uipc_syscalls_40.c,v 1.16.2.2 2020/04/08 14:08:00 martin Exp $	*/

/* written by Pavel Cahyna, 2006. Public domain. */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: uipc_syscalls_40.c,v 1.16.2.2 2020/04/08 14:08:00 martin Exp $");
