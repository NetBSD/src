/*	$NetBSD: uipc_syscalls_40.c,v 1.6.44.1 2011/06/06 09:07:15 jruoho Exp $	*/

/* written by Pavel Cahyna, 2006. Public domain. */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: uipc_syscalls_40.c,v 1.6.44.1 2011/06/06 09:07:15 jruoho Exp $");
