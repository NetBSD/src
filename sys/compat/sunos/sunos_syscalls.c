/* $NetBSD: sunos_syscalls.c,v 1.84.2.1 2010/04/30 14:43:02 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos_syscalls.c,v 1.84.2.1 2010/04/30 14:43:02 uebayasi Exp $");
