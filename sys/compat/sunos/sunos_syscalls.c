/* $NetBSD: sunos_syscalls.c,v 1.78.12.1 2008/06/23 04:30:55 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos_syscalls.c,v 1.78.12.1 2008/06/23 04:30:55 wrstuden Exp $");
