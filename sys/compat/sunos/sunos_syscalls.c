/* $NetBSD: sunos_syscalls.c,v 1.88.2.1 2017/03/20 06:57:26 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos_syscalls.c,v 1.88.2.1 2017/03/20 06:57:26 pgoyette Exp $");
