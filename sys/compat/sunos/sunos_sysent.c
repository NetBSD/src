/* $NetBSD: sunos_sysent.c,v 1.57.2.6 2002/05/29 21:48:55 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos_sysent.c,v 1.57.2.6 2002/05/29 21:48:55 nathanw Exp $");
...
struct sysent sunos_sysent[] = {
	...
	{ 1, s(struct sunos_sys_stime_args), 0,
	...
	{ 3, s(struct sunos_sys_omsync_args), 0,
	...
	{ 1, s(struct sunos_sys_sigsuspend_args), 0,
