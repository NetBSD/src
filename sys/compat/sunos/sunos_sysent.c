/* $NetBSD: sunos_sysent.c,v 1.91.4.1 2019/06/10 22:07:02 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos_sysent.c,v 1.91.4.1 2019/06/10 22:07:02 christos Exp $");
...
const uint32_t sunos_sysent_nomodbits[] = {
