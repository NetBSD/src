/* $NetBSD: mach_syscalls.c,v 1.20.12.1 2008/05/10 23:48:57 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_syscalls.c,v 1.20.12.1 2008/05/10 23:48:57 wrstuden Exp $");
