/* $NetBSD: mach_services_names.c,v 1.12.6.1 2005/04/29 11:28:41 kent Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_services_names.c,v 1.12.6.1 2005/04/29 11:28:41 kent Exp $");
