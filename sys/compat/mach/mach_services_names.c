/* $NetBSD: mach_services_names.c,v 1.12.2.5 2005/03/04 16:40:12 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_services_names.c,v 1.12.2.5 2005/03/04 16:40:12 skrll Exp $");
