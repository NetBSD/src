/* $NetBSD: mach_services_names.c,v 1.12.2.2 2004/08/03 10:44:07 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_services_names.c,v 1.12.2.2 2004/08/03 10:44:07 skrll Exp $");
