/* $NetBSD: mach_services_names.c,v 1.12.2.4 2004/09/21 13:25:42 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_services_names.c,v 1.12.2.4 2004/09/21 13:25:42 skrll Exp $");
