/* $NetBSD: mach_services_names.c,v 1.12.2.3 2004/09/18 14:43:46 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_services_names.c,v 1.12.2.3 2004/09/18 14:43:46 skrll Exp $");
