/* $NetBSD: mach_services_names.c,v 1.15.74.1 2009/05/04 08:12:24 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_services_names.c,v 1.15.74.1 2009/05/04 08:12:24 yamt Exp $");
