/* $NetBSD: mach_services_names.c,v 1.15.70.1 2009/01/17 13:28:46 mjf Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_services_names.c,v 1.15.70.1 2009/01/17 13:28:46 mjf Exp $");
