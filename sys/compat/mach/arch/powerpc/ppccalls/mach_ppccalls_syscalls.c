/* $NetBSD: mach_ppccalls_syscalls.c,v 1.3.10.1 2005/04/29 11:28:41 kent Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_ppccalls_syscalls.c,v 1.3.10.1 2005/04/29 11:28:41 kent Exp $");
