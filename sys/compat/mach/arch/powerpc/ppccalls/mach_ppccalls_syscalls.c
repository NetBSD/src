/* $NetBSD: mach_ppccalls_syscalls.c,v 1.1.2.2 2002/11/11 22:07:42 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_ppccalls_syscalls.c,v 1.1.2.2 2002/11/11 22:07:42 nathanw Exp $");
