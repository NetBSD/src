/* $NetBSD: mach_ppccalls_syscalls.c,v 1.3.2.1 2005/03/04 16:40:20 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_ppccalls_syscalls.c,v 1.3.2.1 2005/03/04 16:40:20 skrll Exp $");
