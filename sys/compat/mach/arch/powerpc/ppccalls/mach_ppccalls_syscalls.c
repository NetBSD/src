/* $NetBSD: mach_ppccalls_syscalls.c,v 1.6 2005/12/11 12:20:22 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_ppccalls_syscalls.c,v 1.6 2005/12/11 12:20:22 christos Exp $");
