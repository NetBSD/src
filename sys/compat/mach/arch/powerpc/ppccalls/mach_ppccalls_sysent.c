/* $NetBSD: mach_ppccalls_sysent.c,v 1.7.28.1 2007/12/26 19:49:30 ad Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_ppccalls_sysent.c,v 1.7.28.1 2007/12/26 19:49:30 ad Exp $");
