/* $NetBSD: mach_ppccalls_sysent.c,v 1.7.32.1 2008/01/02 21:53:04 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_ppccalls_sysent.c,v 1.7.32.1 2008/01/02 21:53:04 bouyer Exp $");
