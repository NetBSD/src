/* $NetBSD: mach_ppccalls_sysent.c,v 1.5.4.2 2008/01/21 09:41:46 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_ppccalls_sysent.c,v 1.5.4.2 2008/01/21 09:41:46 yamt Exp $");
