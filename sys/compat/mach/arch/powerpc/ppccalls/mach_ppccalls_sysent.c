/* $NetBSD: mach_ppccalls_sysent.c,v 1.7.20.1 2008/01/09 01:51:32 matt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_ppccalls_sysent.c,v 1.7.20.1 2008/01/09 01:51:32 matt Exp $");
