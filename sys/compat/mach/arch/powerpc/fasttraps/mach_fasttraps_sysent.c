/* $NetBSD: mach_fasttraps_sysent.c,v 1.12.32.1 2008/01/02 21:53:02 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_sysent.c,v 1.12.32.1 2008/01/02 21:53:02 bouyer Exp $");
