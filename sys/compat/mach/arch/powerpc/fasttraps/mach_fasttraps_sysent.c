/* $NetBSD: mach_fasttraps_sysent.c,v 1.12.28.1 2007/12/26 19:49:29 ad Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_sysent.c,v 1.12.28.1 2007/12/26 19:49:29 ad Exp $");
