/* $NetBSD: mach_fasttraps_sysent.c,v 1.13.6.1 2009/01/17 13:28:46 mjf Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_sysent.c,v 1.13.6.1 2009/01/17 13:28:46 mjf Exp $");
