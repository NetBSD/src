/* $NetBSD: mach_fasttraps_sysent.c,v 1.1.2.3 2002/12/11 06:37:34 thorpej Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_sysent.c,v 1.1.2.3 2002/12/11 06:37:34 thorpej Exp $");
