/* $NetBSD: mach_fasttraps_sysent.c,v 1.1.2.2 2002/11/11 22:07:37 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_sysent.c,v 1.1.2.2 2002/11/11 22:07:37 nathanw Exp $");
...
struct sysent mach_fasttraps_sysent[] = {
	...
	{ 0, 0, 0,
	    mach_sys_cthread_info },		/* 2 = cthread_info */
	{ 0, 0, 0,
