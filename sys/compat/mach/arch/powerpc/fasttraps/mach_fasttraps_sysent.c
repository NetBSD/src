/* $NetBSD: mach_fasttraps_sysent.c,v 1.8.2.1 2005/03/04 16:40:13 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_sysent.c,v 1.8.2.1 2005/03/04 16:40:13 skrll Exp $");
