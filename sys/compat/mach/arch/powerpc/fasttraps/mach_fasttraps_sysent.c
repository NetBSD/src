/* $NetBSD: mach_fasttraps_sysent.c,v 1.11.20.1 2007/01/30 13:51:35 ad Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_sysent.c,v 1.11.20.1 2007/01/30 13:51:35 ad Exp $");
