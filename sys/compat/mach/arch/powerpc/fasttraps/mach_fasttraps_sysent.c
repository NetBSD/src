/* $NetBSD: mach_fasttraps_sysent.c,v 1.8.12.1 2005/03/19 08:33:42 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_sysent.c,v 1.8.12.1 2005/03/19 08:33:42 yamt Exp $");
