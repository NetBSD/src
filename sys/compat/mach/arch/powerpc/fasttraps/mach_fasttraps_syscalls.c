/* $NetBSD: mach_fasttraps_syscalls.c,v 1.10.4.2 2008/01/21 09:41:45 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_syscalls.c,v 1.10.4.2 2008/01/21 09:41:45 yamt Exp $");
