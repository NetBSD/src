/* $NetBSD: mach_fasttraps_syscalls.c,v 1.12.20.1 2008/01/09 01:51:31 matt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_syscalls.c,v 1.12.20.1 2008/01/09 01:51:31 matt Exp $");
