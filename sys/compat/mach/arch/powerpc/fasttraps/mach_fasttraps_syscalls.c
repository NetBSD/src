/* $NetBSD: mach_fasttraps_syscalls.c,v 1.1 2002/11/03 23:17:20 manu Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_syscalls.c,v 1.1 2002/11/03 23:17:20 manu Exp $");
