/* $NetBSD: mach_fasttraps_syscalls.c,v 1.13.10.1 2009/05/04 08:12:24 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_syscalls.c,v 1.13.10.1 2009/05/04 08:12:24 yamt Exp $");
