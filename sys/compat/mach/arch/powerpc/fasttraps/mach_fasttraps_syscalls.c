/* $NetBSD: mach_fasttraps_syscalls.c,v 1.13.18.1 2009/01/19 13:17:36 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: mach_fasttraps_syscalls.c,v 1.13.18.1 2009/01/19 13:17:36 skrll Exp $");
