/* $NetBSD: freebsd_sysent.c,v 1.91.2.1 2018/09/06 06:55:45 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_sysent.c,v 1.91.2.1 2018/09/06 06:55:45 pgoyette Exp $");
