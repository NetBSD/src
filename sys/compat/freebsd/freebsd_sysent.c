/* $NetBSD: freebsd_sysent.c,v 1.45.2.2 2002/06/23 17:43:45 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_sysent.c,v 1.45.2.2 2002/06/23 17:43:45 jdolecek Exp $");
...
struct sysent freebsd_sysent[] = {
	...
	{ 3, s(struct freebsd_sys_lchown_args), 0,
