/* $NetBSD: freebsd_sysent.c,v 1.83.2.1 2017/03/20 06:57:23 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_sysent.c,v 1.83.2.1 2017/03/20 06:57:23 pgoyette Exp $");
