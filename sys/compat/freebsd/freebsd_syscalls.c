/* $NetBSD: freebsd_syscalls.c,v 1.43.2.1 2002/01/10 19:51:03 thorpej Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.43.2.1 2002/01/10 19:51:03 thorpej Exp $");
