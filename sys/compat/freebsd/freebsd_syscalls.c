/* $NetBSD: freebsd_syscalls.c,v 1.69.8.1 2008/03/29 20:46:58 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.69.8.1 2008/03/29 20:46:58 christos Exp $");
