/* $NetBSD: freebsd_syscalls.c,v 1.42.2.3 2001/11/14 19:12:56 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.42.2.3 2001/11/14 19:12:56 nathanw Exp $");
