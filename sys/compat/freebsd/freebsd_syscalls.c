/* $NetBSD: freebsd_syscalls.c,v 1.61.4.1 2006/09/09 02:45:14 rpaulo Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.61.4.1 2006/09/09 02:45:14 rpaulo Exp $");
