/* $NetBSD: freebsd_syscalls.c,v 1.62.4.1 2006/07/13 17:49:08 gdamore Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.62.4.1 2006/07/13 17:49:08 gdamore Exp $");
