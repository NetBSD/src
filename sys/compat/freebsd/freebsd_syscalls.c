/* $NetBSD: freebsd_syscalls.c,v 1.89.4.1 2019/06/10 22:06:58 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.89.4.1 2019/06/10 22:06:58 christos Exp $");
