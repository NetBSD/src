/* $NetBSD: freebsd_syscalls.c,v 1.78.2.2 2017/12/03 11:36:53 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.78.2.2 2017/12/03 11:36:53 jdolecek Exp $");
