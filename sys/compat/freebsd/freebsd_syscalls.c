/* $NetBSD: freebsd_syscalls.c,v 1.76.4.1 2011/06/06 09:07:18 jruoho Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.76.4.1 2011/06/06 09:07:18 jruoho Exp $");
