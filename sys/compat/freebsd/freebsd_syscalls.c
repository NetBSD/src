/* $NetBSD: freebsd_syscalls.c,v 1.42.2.8 2002/12/29 19:49:13 thorpej Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.42.2.8 2002/12/29 19:49:13 thorpej Exp $");
