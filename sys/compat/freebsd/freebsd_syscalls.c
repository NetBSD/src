/* $NetBSD: freebsd_syscalls.c,v 1.69.8.2 2008/11/20 20:45:38 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.69.8.2 2008/11/20 20:45:38 christos Exp $");
