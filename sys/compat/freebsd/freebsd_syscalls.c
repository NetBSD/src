/* $NetBSD: freebsd_syscalls.c,v 1.89.4.2 2020/04/13 08:04:14 martin Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.89.4.2 2020/04/13 08:04:14 martin Exp $");
