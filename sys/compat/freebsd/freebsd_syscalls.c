/* $NetBSD: freebsd_syscalls.c,v 1.74.2.1 2010/04/30 14:42:57 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.74.2.1 2010/04/30 14:42:57 uebayasi Exp $");
