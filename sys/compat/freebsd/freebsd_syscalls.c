/* $NetBSD: freebsd_syscalls.c,v 1.68.20.1 2008/01/02 21:51:53 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.68.20.1 2008/01/02 21:51:53 bouyer Exp $");
