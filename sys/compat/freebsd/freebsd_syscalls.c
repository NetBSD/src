/* $NetBSD: freebsd_syscalls.c,v 1.42.2.4 2002/02/28 20:00:22 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.42.2.4 2002/02/28 20:00:22 nathanw Exp $");
