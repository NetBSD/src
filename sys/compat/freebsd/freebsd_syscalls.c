/* $NetBSD: freebsd_syscalls.c,v 1.82.2.1 2017/04/21 16:53:40 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.82.2.1 2017/04/21 16:53:40 bouyer Exp $");
