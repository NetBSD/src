/* $NetBSD: freebsd_syscalls.c,v 1.43.2.2 2002/06/23 17:43:45 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.43.2.2 2002/06/23 17:43:45 jdolecek Exp $");
