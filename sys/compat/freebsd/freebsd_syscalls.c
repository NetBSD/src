/* $NetBSD: freebsd_syscalls.c,v 1.42.2.7 2002/10/18 02:40:57 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.42.2.7 2002/10/18 02:40:57 nathanw Exp $");
