/* $NetBSD: freebsd_syscalls.c,v 1.61.6.1 2006/06/01 22:35:48 kardel Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: freebsd_syscalls.c,v 1.61.6.1 2006/06/01 22:35:48 kardel Exp $");
