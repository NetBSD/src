/* $NetBSD: pecoff_syscallargs.h,v 1.2.2.3 2002/04/12 23:27:58 nathanw Exp $ */
...
int	pecoff_compat_43_sys_stat(struct lwp *, void *, register_t *);
int	sys_getppid(struct lwp *, void *, register_t *);
int	pecoff_compat_43_sys_lstat(struct lwp *, void *, register_t *);
...
int	pecoff_compat_43_sys_truncate(struct lwp *, void *, register_t *);
...
#else
#endif
int	pecoff_compat_12_sys_stat(struct lwp *, void *, register_t *);
int	compat_12_sys_fstat(struct lwp *, void *, register_t *);
int	pecoff_compat_12_sys_lstat(struct lwp *, void *, register_t *);
