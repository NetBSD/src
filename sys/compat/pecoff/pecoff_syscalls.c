/* $NetBSD: pecoff_syscalls.c,v 1.19.2.1 2006/07/13 17:49:15 gdamore Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: pecoff_syscalls.c,v 1.19.2.1 2006/07/13 17:49:15 gdamore Exp $");
