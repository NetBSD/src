/* $NetBSD: pecoff_syscalls.c,v 1.25 2006/08/31 00:23:11 oki Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: pecoff_syscalls.c,v 1.25 2006/08/31 00:23:11 oki Exp $");
...
const char *const pecoff_syscallnames[] = {
	...
	"ptrace",			/* 26 = ptrace */
#else
	"#26 (excluded sys_ptrace)",		/* 26 = excluded sys_ptrace */
#endif
	"recvmsg",			/* 27 = recvmsg */
	"sendmsg",			/* 28 = sendmsg */
