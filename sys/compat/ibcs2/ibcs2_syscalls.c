/* $NetBSD: ibcs2_syscalls.c,v 1.45.8.2 2008/11/01 21:22:26 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ibcs2_syscalls.c,v 1.45.8.2 2008/11/01 21:22:26 christos Exp $");
