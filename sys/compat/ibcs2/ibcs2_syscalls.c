/* $NetBSD: ibcs2_syscalls.c,v 1.45.14.1 2008/06/23 04:30:52 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ibcs2_syscalls.c,v 1.45.14.1 2008/06/23 04:30:52 wrstuden Exp $");
