/* $NetBSD: ibcs2_syscalls.c,v 1.53.2.1 2017/03/20 06:57:24 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ibcs2_syscalls.c,v 1.53.2.1 2017/03/20 06:57:24 pgoyette Exp $");
