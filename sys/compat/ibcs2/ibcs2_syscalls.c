/* $NetBSD: ibcs2_syscalls.c,v 1.45.8.1 2008/03/29 20:46:58 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ibcs2_syscalls.c,v 1.45.8.1 2008/03/29 20:46:58 christos Exp $");
