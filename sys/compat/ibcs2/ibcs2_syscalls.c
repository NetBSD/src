/* $NetBSD: ibcs2_syscalls.c,v 1.55.4.1 2017/05/11 02:58:36 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ibcs2_syscalls.c,v 1.55.4.1 2017/05/11 02:58:36 pgoyette Exp $");
