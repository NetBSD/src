/* $NetBSD: ibcs2_syscalls.c,v 1.49.22.2 2017/12/03 11:36:53 jdolecek Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ibcs2_syscalls.c,v 1.49.22.2 2017/12/03 11:36:53 jdolecek Exp $");
