/* $NetBSD: ibcs2_sysent.c,v 1.43.26.1 2007/12/13 05:05:28 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ibcs2_sysent.c,v 1.43.26.1 2007/12/13 05:05:28 yamt Exp $");
...
struct sysent ibcs2_sysent[] = {
	...
	{ ns(struct ibcs2_sys_chmod_args), 0,
	    ibcs2_sys_chmod },			/* 15 = chmod */
	{ ns(struct ibcs2_sys_chown_args), 0,
	...
	{ ns(struct ibcs2_sys_rmdir_args), 0,
	    ibcs2_sys_rmdir },			/* 79 = rmdir */
	{ ns(struct ibcs2_sys_mkdir_args), 0,
	...
	{ ns(struct ibcs2_sys_rename_args), 0,
