/* $NetBSD: ibcs2_sysent.c,v 1.57.8.1 2018/09/06 06:55:45 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ibcs2_sysent.c,v 1.57.8.1 2018/09/06 06:55:45 pgoyette Exp $");
...
const uint32_t ibcs2_sysent_nomodbits[] = {
