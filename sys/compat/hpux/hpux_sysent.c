/* $NetBSD: hpux_sysent.c,v 1.43.16.1 2006/07/13 17:49:08 gdamore Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: hpux_sysent.c,v 1.43.16.1 2006/07/13 17:49:08 gdamore Exp $");
...
struct sysent hpux_sysent[] = {
	...
	{ 3, s(struct hpux_sys_setresuid_args), 0,
	    hpux_sys_setresuid },		/* 126 = setresuid */
	{ 3, s(struct hpux_sys_setresgid_args), 0,
	...
	{ 4, s(struct hpux_sys_osemctl_args), 0,
	...
	{ 3, s(struct hpux_sys_omsgctl_args), 0,
	...
	{ 3, s(struct hpux_sys_oshmctl_args), 0,
	...
	{ 5, s(struct hpux_sys_setsockopt2_args), 0,
	...
	{ 3, s(struct compat_30_sys_socket_args), 0,
	    compat_30_sys_socket },		/* 290 = socket */
...
#ifdef SYSVSEM
	{ 4, s(struct hpux_sys_semctl_args), 0,
...
#endif
#ifdef SYSVMSG
	{ 3, s(struct hpux_sys_msgctl_args), 0,
