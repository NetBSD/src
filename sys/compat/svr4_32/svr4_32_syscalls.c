/* $NetBSD: svr4_32_syscalls.c,v 1.2.4.3 2001/11/14 19:13:31 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: svr4_32_syscalls.c,v 1.2.4.3 2001/11/14 19:13:31 nathanw Exp $");
