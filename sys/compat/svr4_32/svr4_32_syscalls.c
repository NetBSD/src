/* $NetBSD: svr4_32_syscalls.c,v 1.15.28.1 2008/01/02 21:53:37 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: svr4_32_syscalls.c,v 1.15.28.1 2008/01/02 21:53:37 bouyer Exp $");
...
const char *const svr4_32_syscallnames[] = {
	...
	/* 155 */	"vhangup",
	/* 156 */	"gettimeofday",
	/* 157 */	"netbsd32_getitimer",
	/* 158 */	"netbsd32_setitimer",
	/* 159 */	"_lwp_create",
	/* 160 */	"_lwp_exit",
	/* 161 */	"_lwp_suspend",
	/* 162 */	"_lwp_continue",
