/* $NetBSD: svr4_32_syscalls.c,v 1.25.2.1 2017/04/21 16:53:43 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: svr4_32_syscalls.c,v 1.25.2.1 2017/04/21 16:53:43 bouyer Exp $");
