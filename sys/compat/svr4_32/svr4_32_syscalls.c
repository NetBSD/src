/* $NetBSD: svr4_32_syscalls.c,v 1.2.4.4 2002/05/29 21:48:57 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: svr4_32_syscalls.c,v 1.2.4.4 2002/05/29 21:48:57 nathanw Exp $");
