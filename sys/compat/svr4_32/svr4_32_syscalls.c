/* $NetBSD: svr4_32_syscalls.c,v 1.12.6.1 2006/06/01 22:36:01 kardel Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: svr4_32_syscalls.c,v 1.12.6.1 2006/06/01 22:36:01 kardel Exp $");
