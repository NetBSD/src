/* $NetBSD: svr4_32_syscalls.c,v 1.12.4.1 2006/09/09 02:46:23 rpaulo Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: svr4_32_syscalls.c,v 1.12.4.1 2006/09/09 02:46:23 rpaulo Exp $");
