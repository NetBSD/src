/* $NetBSD: svr4_32_syscalls.c,v 1.4.2.2 2002/01/10 19:52:26 thorpej Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: svr4_32_syscalls.c,v 1.4.2.2 2002/01/10 19:52:26 thorpej Exp $");
