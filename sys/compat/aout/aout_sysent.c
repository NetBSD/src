/* $NetBSD: aout_sysent.c,v 1.6.2.4 2001/02/11 19:13:19 bouyer Exp $ */

/*
 * System call switch table.
 *
 * DO NOT EDIT-- this file is automatically generated.
 * created from	NetBSD: syscalls.master,v 1.13 2001/01/27 07:50:11 thorpej Exp 
 */
...
struct sysent aout_sysent[] = {
	...
	{ 3, s(struct sys_write_args), 0,
	    sys_write },			/* 4 = write */
	{ 3, s(struct aout_sys_open_args), 0,
	    aout_sys_open },			/* 5 = open */
	{ 1, s(struct sys_close_args), 0,
	    sys_close },			/* 6 = close */
	{ 4, s(struct sys_wait4_args), 0,
	    sys_wait4 },			/* 7 = wait4 */
	{ 2, s(struct aout_sys_creat_args), 0,
	    aout_sys_creat },			/* 8 = ocreat */
	{ 2, s(struct aout_sys_link_args), 0,
	    aout_sys_link },			/* 9 = link */
	{ 1, s(struct aout_sys_unlink_args), 0,
	    aout_sys_unlink },			/* 10 = unlink */
	{ 0, 0, 0,
	    sys_nosys },			/* 11 = obsolete execv */
	{ 1, s(struct aout_sys_chdir_args), 0,
	    aout_sys_chdir },			/* 12 = chdir */
	{ 1, s(struct sys_fchdir_args), 0,
	    sys_fchdir },			/* 13 = fchdir */
	{ 3, s(struct aout_sys_mknod_args), 0,
	    aout_sys_mknod },			/* 14 = mknod */
	{ 2, s(struct aout_sys_chmod_args), 0,
	    aout_sys_chmod },			/* 15 = chmod */
	{ 3, s(struct aout_sys_chown_args), 0,
	    aout_sys_chown },			/* 16 = chown */
	...
	{ 4, s(struct aout_sys_mount_args), 0,
	    aout_sys_mount },			/* 21 = mount */
	{ 2, s(struct aout_sys_unmount_args), 0,
	    aout_sys_unmount },			/* 22 = unmount */
	...
	{ 2, s(struct aout_sys_access_args), 0,
	    aout_sys_access },			/* 33 = access */
	{ 2, s(struct aout_sys_chflags_args), 0,
	    aout_sys_chflags },			/* 34 = chflags */
	...
	{ 2, s(struct sys_kill_args), 0,
	    sys_kill },				/* 37 = kill */
	{ 2, s(struct aout_compat_43_sys_stat_args), 0,
	    aout_compat_43_sys_stat },		/* 38 = stat43 */
	{ 0, 0, 0,
	    sys_getppid },			/* 39 = getppid */
	{ 2, s(struct aout_compat_43_sys_lstat_args), 0,
	    aout_compat_43_sys_lstat },		/* 40 = lstat43 */
	...
	{ 4, s(struct aout_sys_ktrace_args), 0,
	...
	{ 1, s(struct aout_sys_acct_args), 0,
	    aout_sys_acct },			/* 51 = acct */
	{ 0, 0, 0,
	...
	{ 1, s(struct aout_sys_revoke_args), 0,
	    aout_sys_revoke },			/* 56 = revoke */
	{ 2, s(struct aout_sys_symlink_args), 0,
	    aout_sys_symlink },			/* 57 = symlink */
	{ 3, s(struct aout_sys_readlink_args), 0,
	    aout_sys_readlink },		/* 58 = readlink */
	{ 3, s(struct aout_sys_execve_args), 0,
	    aout_sys_execve },			/* 59 = execve */
	{ 1, s(struct sys_umask_args), 0,
	    sys_umask },			/* 60 = umask */
	{ 1, s(struct aout_sys_chroot_args), 0,
	    aout_sys_chroot },			/* 61 = chroot */
	...
	{ 2, s(struct aout_sys_rename_args), 0,
	    aout_sys_rename },			/* 128 = rename */
	{ 2, s(struct aout_compat_43_sys_truncate_args), 0,
	    aout_compat_43_sys_truncate },	/* 129 = otruncate */
	{ 2, s(struct compat_43_sys_ftruncate_args), 0,
	    compat_43_sys_ftruncate },		/* 130 = oftruncate */
	{ 2, s(struct sys_flock_args), 0,
	    sys_flock },			/* 131 = flock */
	{ 2, s(struct aout_sys_mkfifo_args), 0,
	    aout_sys_mkfifo },			/* 132 = mkfifo */
	...
	{ 2, s(struct aout_sys_mkdir_args), 0,
	    aout_sys_mkdir },			/* 136 = mkdir */
	{ 1, s(struct aout_sys_rmdir_args), 0,
	    aout_sys_rmdir },			/* 137 = rmdir */
	{ 2, s(struct aout_sys_utimes_args), 0,
	    aout_sys_utimes },			/* 138 = utimes */
	{ 0, 0, 0,
	...
	{ 4, s(struct aout_sys_quotactl_args), 0,
	    aout_sys_quotactl },		/* 148 = quotactl */
	{ 0, 0, 0,
	...
	{ 2, s(struct aout_sys_statfs_args), 0,
	    aout_sys_statfs },			/* 157 = statfs */
...
#if defined(NFS) || defined(NFSSERVER) || !defined(_KERNEL)
	{ 2, s(struct aout_sys_getfh_args), 0,
...
#endif
	{ 2, s(struct aout_compat_12_sys_stat_args), 0,
	    aout_compat_12_sys_stat },		/* 188 = stat12 */
	{ 2, s(struct compat_12_sys_fstat_args), 0,
	    compat_12_sys_fstat },		/* 189 = fstat12 */
	{ 2, s(struct aout_compat_12_sys_lstat_args), 0,
	    aout_compat_12_sys_lstat },		/* 190 = lstat12 */
	{ 2, s(struct aout_sys_pathconf_args), 0,
	    aout_sys_pathconf },		/* 191 = pathconf */
	...
	{ 4, s(struct sys_lseek_args), 0,
	    sys_lseek },			/* 199 = lseek */
	{ 3, s(struct aout_sys_truncate_args), 0,
	    aout_sys_truncate },		/* 200 = truncate */
	...
	{ 1, s(struct aout_sys_undelete_args), 0,
	    aout_sys_undelete },		/* 205 = undelete */
	...
	{ 2, s(struct aout_sys___posix_rename_args), 0,
	    aout_sys___posix_rename },		/* 270 = __posix_rename */
	...
	{ 2, s(struct aout_sys_lchmod_args), 0,
	    aout_sys_lchmod },			/* 274 = lchmod */
	{ 3, s(struct aout_sys_lchown_args), 0,
	    aout_sys_lchown },			/* 275 = lchown */
	{ 2, s(struct aout_sys_lutimes_args), 0,
	    aout_sys_lutimes },			/* 276 = lutimes */
	...
	{ 3, s(struct aout_sys___posix_chown_args), 0,
	    aout_sys___posix_chown },		/* 283 = __posix_chown */
