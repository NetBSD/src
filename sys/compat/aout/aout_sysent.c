/*	$NetBSD: aout_sysent.c,v 1.6 1999/09/16 18:19:12 christos Exp $	*/

/*
 * System call switch table.
 *
 * DO NOT EDIT-- this file is automatically generated.
 * created from	NetBSD: syscalls.master,v 1.6 1999/09/16 18:18:28 christos Exp 
 */
...
struct sysent aout_sysent[] = {
	...
	{ 4, s(struct aout_sys_mount_args),
	    aout_sys_mount },			/* 21 = mount */
	{ 2, s(struct aout_sys_unmount_args),
	...
	{ 2, s(struct aout_sys_access_args),
	    aout_sys_access },			/* 33 = access */
	{ 2, s(struct aout_sys_chflags_args),
	...
	{ 2, s(struct sys_kill_args),
	    sys_kill },				/* 37 = kill */
	{ 2, s(struct aout_compat_43_sys_stat_args),
	    aout_compat_43_sys_stat },		/* 38 = stat43 */
	{ 0, 0,
	    sys_getppid },			/* 39 = getppid */
	{ 2, s(struct aout_compat_43_sys_lstat_args),
	...
	{ 1, s(struct aout_sys_revoke_args),
	    aout_sys_revoke },			/* 56 = revoke */
	{ 2, s(struct aout_sys_symlink_args),
	    aout_sys_symlink },			/* 57 = symlink */
	{ 3, s(struct aout_sys_readlink_args),
	    aout_sys_readlink },		/* 58 = readlink */
	{ 3, s(struct aout_sys_execve_args),
	    aout_sys_execve },			/* 59 = execve */
	{ 1, s(struct sys_umask_args),
	    sys_umask },			/* 60 = umask */
	{ 1, s(struct aout_sys_chroot_args),
	...
	{ 2, s(struct aout_sys_rename_args),
	    aout_sys_rename },			/* 128 = rename */
	{ 2, s(struct aout_compat_43_sys_truncate_args),
	...
	{ 2, s(struct sys_flock_args),
	    sys_flock },			/* 131 = flock */
	{ 2, s(struct aout_sys_mkfifo_args),
	...
	{ 2, s(struct aout_sys_mkdir_args),
	    aout_sys_mkdir },			/* 136 = mkdir */
	{ 1, s(struct aout_sys_rmdir_args),
	    aout_sys_rmdir },			/* 137 = rmdir */
	{ 2, s(struct aout_sys_utimes_args),
	...
	{ 4, s(struct aout_sys_quotactl_args),
	...
	{ 2, s(struct aout_sys_statfs_args),
	...
	{ 2, s(struct aout_compat_12_sys_lstat_args),
	    aout_compat_12_sys_lstat },		/* 190 = lstat12 */
	{ 2, s(struct aout_sys_pathconf_args),
	...
	{ 4, s(struct sys_lseek_args),
	    sys_lseek },			/* 199 = lseek */
	{ 3, s(struct aout_sys_truncate_args),
	...
	{ 1, s(struct aout_sys_undelete_args),
	...
	{ 2, s(struct aout_sys___posix_rename_args),
	...
	{ 2, s(struct aout_sys_lchmod_args),
	    aout_sys_lchmod },			/* 274 = lchmod */
	{ 3, s(struct aout_sys_lchown_args),
	    aout_sys_lchown },			/* 275 = lchown */
	{ 2, s(struct aout_sys_lutimes_args),
	...
	{ 3, s(struct aout_sys___posix_chown_args),
