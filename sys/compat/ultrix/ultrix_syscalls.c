/* $NetBSD: ultrix_syscalls.c,v 1.48.16.1 2006/07/13 17:49:16 gdamore Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ultrix_syscalls.c,v 1.48.16.1 2006/07/13 17:49:16 gdamore Exp $");
