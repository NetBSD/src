/* $NetBSD: ultrix_syscalls.c,v 1.41.2.4 2002/05/29 21:48:58 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ultrix_syscalls.c,v 1.41.2.4 2002/05/29 21:48:58 nathanw Exp $");
