/* $NetBSD: ultrix_syscalls.c,v 1.54.4.1 2008/06/23 04:30:57 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ultrix_syscalls.c,v 1.54.4.1 2008/06/23 04:30:57 wrstuden Exp $");
