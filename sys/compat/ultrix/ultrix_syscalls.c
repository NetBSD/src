/* $NetBSD: ultrix_syscalls.c,v 1.42.2.1 2002/01/10 19:52:29 thorpej Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ultrix_syscalls.c,v 1.42.2.1 2002/01/10 19:52:29 thorpej Exp $");
