/* $NetBSD: ultrix_syscalls.c,v 1.60.2.1 2010/04/30 14:43:03 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ultrix_syscalls.c,v 1.60.2.1 2010/04/30 14:43:03 uebayasi Exp $");
