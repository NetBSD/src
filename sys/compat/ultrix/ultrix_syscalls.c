/* $NetBSD: ultrix_syscalls.c,v 1.52.28.1 2008/01/02 21:53:41 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ultrix_syscalls.c,v 1.52.28.1 2008/01/02 21:53:41 bouyer Exp $");
