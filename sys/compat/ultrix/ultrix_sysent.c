/* $NetBSD: ultrix_sysent.c,v 1.78 2026/09/11 13:08:13 sborrill Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ultrix_sysent.c,v 1.78 2026/09/11 13:08:13 sborrill Exp $");
...
const uint32_t ultrix_sysent_nomodbits[] = {
