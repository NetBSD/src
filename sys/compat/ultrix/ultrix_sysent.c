/* $NetBSD: ultrix_sysent.c,v 1.42.2.3 2001/12/06 09:35:32 wdk Exp $ */

/*
 * System call switch table.
 *
 * DO NOT EDIT-- this file is automatically generated.
 * created from	NetBSD: syscalls.master,v 1.36.2.1 2001/06/21 20:00:56 nathanw Exp 
 */

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ultrix_sysent.c,v 1.42.2.3 2001/12/06 09:35:32 wdk Exp $");
...
struct sysent ultrix_sysent[] = {
	...
	{ 3, s(struct ultrix_sys_fcntl_args), 0,
	...
	{ 1, s(struct ultrix_sys_sigreturn_args), 0,
	    ultrix_sys_sigreturn },		/* 103 = sigreturn */
	...
	{ 3, s(struct ultrix_sys_sigvec_args), 0,
	    ultrix_sys_sigvec },		/* 108 = sigvec */
	...
	{ 1, s(struct ultrix_sys_sigsuspend_args), 0,
	    ultrix_sys_sigsuspend },		/* 111 = sigsuspend */
...
#ifdef __mips
	{ 3, s(struct ultrix_sys_cacheflush_args), 0,
	    ultrix_sys_cacheflush },		/* 152 = cacheflush */
	{ 3, s(struct ultrix_sys_cachectl_args), 0,
	...
	{ 4, s(struct ultrix_sys_shmsys_args), 0,
