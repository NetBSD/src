/* $NetBSD: ultrix_sysent.c,v 1.51.4.1 2006/09/09 02:46:39 rpaulo Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ultrix_sysent.c,v 1.51.4.1 2006/09/09 02:46:39 rpaulo Exp $");
