/* $NetBSD: netbsd32_sysent.c,v 1.132.2.1 2018/05/21 04:36:04 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_sysent.c,v 1.132.2.1 2018/05/21 04:36:04 pgoyette Exp $");
