/* $NetBSD: netbsd32_sysent.c,v 1.132.2.9 2018/09/12 03:22:07 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_sysent.c,v 1.132.2.9 2018/09/12 03:22:07 pgoyette Exp $");
