/* $NetBSD: netbsd32_sysent.c,v 1.21.2.5 2002/11/11 22:08:01 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_sysent.c,v 1.21.2.5 2002/11/11 22:08:01 nathanw Exp $");
