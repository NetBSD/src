/* $NetBSD: netbsd32_sysent.c,v 1.23.2.1 2002/01/10 19:51:59 thorpej Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_sysent.c,v 1.23.2.1 2002/01/10 19:51:59 thorpej Exp $");
