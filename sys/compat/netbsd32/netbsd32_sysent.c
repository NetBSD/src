...
struct sysent netbsd32_sysent[] = {
	...
	{
		ns(struct netbsd32_semsys_args),
		.sy_call = (sy_call_t *)sys_nomodule
	},		/* 169 = osemsys */
	{
		ns(struct netbsd32_msgsys_args),
		.sy_call = (sy_call_t *)sys_nomodule
	},		/* 170 = omsgsys */
	{
		ns(struct netbsd32_shmsys_args),
		.sy_call = (sy_call_t *)sys_nomodule
	},		/* 171 = oshmsys */
	{
		.sy_call = sys_nosys,
	...
	{
		ns(struct netbsd32___semctl14_args),
		.sy_call = (sy_call_t *)sys_nomodule
	},		/* 301 = netbsd32___semctl14 */
	{
		ns(struct netbsd32___msgctl13_args),
		.sy_call = (sy_call_t *)sys_nomodule
	},		/* 302 = netbsd32___msgctl13 */
	{
		ns(struct netbsd32___shmctl13_args),
		.sy_call = (sy_call_t *)sys_nomodule
