/* $NetBSD: netbsd32_sysent.c,v 1.132.2.5 2018/09/11 06:12:17 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_sysent.c,v 1.132.2.5 2018/09/11 06:12:17 pgoyette Exp $");
