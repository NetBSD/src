/* $NetBSD: netbsd32_sysent.c,v 1.162.2.1 2025/08/02 05:56:28 perseant Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_sysent.c,v 1.162.2.1 2025/08/02 05:56:28 perseant Exp $");
...
struct sysent netbsd32_sysent[] = {
	...
	{
		ns(struct netbsd32_epoll_create1_args),
		.sy_call = (sy_call_t *)netbsd32_epoll_create1
	},		/* 502 = netbsd32_epoll_create1 */
	{
		ns(struct netbsd32_epoll_ctl_args),
		.sy_call = (sy_call_t *)netbsd32_epoll_ctl
	},		/* 503 = netbsd32_epoll_ctl */
	{
		ns(struct netbsd32_epoll_pwait2_args),
	...
	{
		ns(struct netbsd32_semtimedop_args),
		.sy_call = (sy_call_t *)sys_nomodule
