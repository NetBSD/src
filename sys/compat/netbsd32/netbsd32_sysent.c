/* $NetBSD: netbsd32_sysent.c,v 1.132.2.11 2018/09/13 03:50:24 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_sysent.c,v 1.132.2.11 2018/09/13 03:50:24 pgoyette Exp $");
