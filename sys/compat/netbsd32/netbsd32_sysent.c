/* $NetBSD: netbsd32_sysent.c,v 1.132.2.12 2018/09/14 01:21:34 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_sysent.c,v 1.132.2.12 2018/09/14 01:21:34 pgoyette Exp $");
