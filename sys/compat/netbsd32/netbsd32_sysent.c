/* $NetBSD: netbsd32_sysent.c,v 1.132.2.10 2018/09/12 23:27:24 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_sysent.c,v 1.132.2.10 2018/09/12 23:27:24 pgoyette Exp $");
