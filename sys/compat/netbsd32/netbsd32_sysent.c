/* $NetBSD: netbsd32_sysent.c,v 1.39 2005/07/10 11:29:35 cube Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_sysent.c,v 1.39 2005/07/10 11:29:35 cube Exp $");
