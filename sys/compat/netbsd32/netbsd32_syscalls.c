/* $NetBSD: netbsd32_syscalls.c,v 1.91.4.1 2011/06/06 09:07:34 jruoho Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.91.4.1 2011/06/06 09:07:34 jruoho Exp $");
