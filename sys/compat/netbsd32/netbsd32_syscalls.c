/* $NetBSD: netbsd32_syscalls.c,v 1.59 2006/08/30 13:58:51 cube Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.59 2006/08/30 13:58:51 cube Exp $");
...
#else
	"#26 (excluded netbsd32_ptrace)",		/* 26 = excluded netbsd32_ptrace */
#endif
