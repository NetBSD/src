/* $NetBSD: netbsd32_syscalls.c,v 1.22.2.5 2002/11/11 22:08:00 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.22.2.5 2002/11/11 22:08:00 nathanw Exp $");
