/* $NetBSD: netbsd32_syscalls.c,v 1.47.4.1 2006/09/09 02:46:12 rpaulo Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.47.4.1 2006/09/09 02:46:12 rpaulo Exp $");
