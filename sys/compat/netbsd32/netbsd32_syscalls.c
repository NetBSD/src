/* $NetBSD: netbsd32_syscalls.c,v 1.29.2.2 2004/09/18 14:43:58 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.29.2.2 2004/09/18 14:43:58 skrll Exp $");
