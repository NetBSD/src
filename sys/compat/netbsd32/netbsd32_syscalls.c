/* $NetBSD: netbsd32_syscalls.c,v 1.29.2.1 2004/08/03 10:44:22 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.29.2.1 2004/08/03 10:44:22 skrll Exp $");
