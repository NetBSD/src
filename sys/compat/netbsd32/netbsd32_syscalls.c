/* $NetBSD: netbsd32_syscalls.c,v 1.89.2.1 2010/04/30 14:43:00 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.89.2.1 2010/04/30 14:43:00 uebayasi Exp $");
