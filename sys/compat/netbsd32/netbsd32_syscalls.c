/* $NetBSD: netbsd32_syscalls.c,v 1.108.4.5 2016/12/05 10:55:00 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.108.4.5 2016/12/05 10:55:00 skrll Exp $");
