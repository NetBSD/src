/* $NetBSD: netbsd32_syscalls.c,v 1.77.2.3 2009/04/28 07:35:08 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.77.2.3 2009/04/28 07:35:08 skrll Exp $");
