/* $NetBSD: netbsd32_syscalls.c,v 1.65.10.1 2007/08/15 13:48:08 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.65.10.1 2007/08/15 13:48:08 skrll Exp $");
