/* $NetBSD: netbsd32_syscalls.c,v 1.69.4.1 2008/01/02 21:53:13 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.69.4.1 2008/01/02 21:53:13 bouyer Exp $");
