/* $NetBSD: netbsd32_syscalls.c,v 1.65.10.2 2007/09/03 10:20:02 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.65.10.2 2007/09/03 10:20:02 skrll Exp $");
