/* $NetBSD: netbsd32_syscalls.c,v 1.22.2.2 2001/11/14 19:13:18 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.22.2.2 2001/11/14 19:13:18 nathanw Exp $");
