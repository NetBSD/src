/* $NetBSD: netbsd32_syscalls.c,v 1.108.4.2 2015/09/22 12:05:55 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.108.4.2 2015/09/22 12:05:55 skrll Exp $");
