/* $NetBSD: netbsd32_syscalls.c,v 1.91.2.1 2011/04/21 01:41:43 rmind Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.91.2.1 2011/04/21 01:41:43 rmind Exp $");
