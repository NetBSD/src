/* $NetBSD: netbsd32_syscalls.c,v 1.24.2.1 2002/01/10 19:51:58 thorpej Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.24.2.1 2002/01/10 19:51:58 thorpej Exp $");
