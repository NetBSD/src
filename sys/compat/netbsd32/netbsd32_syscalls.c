/* $NetBSD: netbsd32_syscalls.c,v 1.65.14.3 2007/11/11 16:47:20 joerg Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.65.14.3 2007/11/11 16:47:20 joerg Exp $");
