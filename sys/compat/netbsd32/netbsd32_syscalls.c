/* $NetBSD: netbsd32_syscalls.c,v 1.74.2.1 2008/03/24 07:15:10 keiichi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.74.2.1 2008/03/24 07:15:10 keiichi Exp $");
