/* $NetBSD: netbsd32_syscalls.c,v 1.108.4.1 2015/04/06 15:18:07 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.108.4.1 2015/04/06 15:18:07 skrll Exp $");
