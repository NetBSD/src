/* $NetBSD: netbsd32_syscalls.c,v 1.76.4.1 2008/05/10 23:48:58 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.76.4.1 2008/05/10 23:48:58 wrstuden Exp $");
