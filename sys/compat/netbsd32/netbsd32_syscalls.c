/* $NetBSD: netbsd32_syscalls.c,v 1.108.4.4 2016/10/05 20:55:39 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.108.4.4 2016/10/05 20:55:39 skrll Exp $");
