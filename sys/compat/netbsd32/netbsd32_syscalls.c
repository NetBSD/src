/* $NetBSD: netbsd32_syscalls.c,v 1.81.4.3 2009/01/04 02:56:09 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.81.4.3 2009/01/04 02:56:09 christos Exp $");
...
const char *const netbsd32_syscallnames[] = {
	...
	/* 404 */	"#404 (unimplemented { int sys_aio_suspend ( const struct aiocb * const * list , int nent , const netbsd32_timespecp_t timeout ) ; })",
	/* 405 */	"#405 (unimplemented { int sys_aio_write ( struct aiocb * aiocbp ) ; })",
	/* 406 */	"#406 (unimplemented { int sys_lio_listio ( int mode , struct aiocb * const * list , int nent , netbsd32_sigeventp_t sig ) ; })",
	/* 407 */	"#407 (unimplemented)",
	/* 408 */	"#408 (unimplemented)",
	/* 409 */	"#409 (unimplemented)",
	/* 410 */	"#410 (unimplemented { int sys___mount50 ( const netbsd32_charp type , const netbsd32_charp path , int flags , netbsd32_voidp data , netbsd32_size_t data_len ) ; })",
	/* 411 */	"netbsd32_mremap",
	...
	/* 432 */	"#432 (unimplemented { int netbsd32___mq_timedsend50 ( mqd_t mqdes , const netbsd32_charp msg_ptr , netbsd32_size_t msg_len , unsigned msg_prio , const netbsd32_timespecp_t abs_timeout ) ; })",
	/* 433 */	"#433 (unimplemented { netbsd32_ssize_t netbsd32___mq_timedreceive50 ( mqd_t mqdes , netbsd32_charp msg_ptr , netbsd32_size_t msg_len , netbsd32_pointer_t msg_prio , const netbsd32_timespecp_t abs_timeout ) ; })",
	/* 434 */	"netbsd32____lwp_park50",
	/* 435 */	"netbsd32___kevent50",
	/* 436 */	"netbsd32___pselect50",
	/* 437 */	"netbsd32___pollts50",
	/* 438 */	"#438 (unimplemented { int netbsd32___aio_suspend50 ( const struct aiocb * const * list , int nent , const netbsd32_timespecp_t timeout ) ; })",
