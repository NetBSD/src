/* $NetBSD: netbsd32_syscalls.c,v 1.81.4.2 2009/01/04 01:56:02 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.81.4.2 2009/01/04 01:56:02 christos Exp $");
