/* $NetBSD: netbsd32_syscalls.c,v 1.121.2.2 2017/03/20 06:57:25 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.121.2.2 2017/03/20 06:57:25 pgoyette Exp $");
