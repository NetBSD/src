/* $NetBSD: netbsd32_syscalls.c,v 1.62.2.2 2007/03/12 05:52:33 rmind Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.62.2.2 2007/03/12 05:52:33 rmind Exp $");
