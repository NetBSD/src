/* $NetBSD: netbsd32_syscalls.c,v 1.29.2.5 2005/11/10 14:01:21 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.29.2.5 2005/11/10 14:01:21 skrll Exp $");
