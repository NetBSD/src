/* $NetBSD: netbsd32_syscalls.c,v 1.67.6.1 2007/11/13 16:00:42 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.67.6.1 2007/11/13 16:00:42 bouyer Exp $");
