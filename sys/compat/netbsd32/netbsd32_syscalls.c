/* $NetBSD: netbsd32_syscalls.c,v 1.29.2.3 2004/09/21 13:25:54 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.29.2.3 2004/09/21 13:25:54 skrll Exp $");
