/* $NetBSD: netbsd32_syscalls.c,v 1.53.2.1 2006/07/13 17:49:14 gdamore Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.53.2.1 2006/07/13 17:49:14 gdamore Exp $");
