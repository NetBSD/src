/* $NetBSD: netbsd32_syscalls.c,v 1.65.14.1 2007/08/09 02:37:05 jmcneill Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: netbsd32_syscalls.c,v 1.65.14.1 2007/08/09 02:37:05 jmcneill Exp $");
