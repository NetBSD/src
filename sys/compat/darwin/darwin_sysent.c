/* $NetBSD: darwin_sysent.c,v 1.26.2.1 2004/08/03 10:43:30 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: darwin_sysent.c,v 1.26.2.1 2004/08/03 10:43:30 skrll Exp $");
...
struct sysent darwin_sysent[] = {
	...
	{ 5, s(struct darwin_sys_getattrlist_args), 0,
	...
	{ 2, s(struct darwin_sys_utrace_args), 0,
	...
	{ 2, s(struct darwin_sys_audit_args), 0,
	    darwin_sys_audit },			/* 350 = audit */
	{ 3, s(struct darwin_sys_auditon_args), 0,
	    darwin_sys_auditon },		/* 351 = auditon */
	{ 0, 0, 0,
	    sys_nosys },			/* 352 = unimplemented */
	{ 1, s(struct darwin_sys_getauid_args), 0,
	    darwin_sys_getauid },		/* 353 = getauid */
	{ 1, s(struct darwin_sys_setauid_args), 0,
	    darwin_sys_setauid },		/* 354 = setauid */
	{ 1, s(struct darwin_sys_getauditinfo_args), 0,
	    darwin_sys_getauditinfo },		/* 355 = getauditinfo */
	{ 1, s(struct darwin_sys_setauditinfo_args), 0,
	    darwin_sys_setauditinfo },		/* 356 = setauditinfo */
	{ 2, s(struct darwin_sys_getaudit_addr_args), 0,
	    darwin_sys_getaudit_addr },		/* 357 = getaudit_addr */
	{ 2, s(struct darwin_sys_setaudit_addr_args), 0,
	    darwin_sys_setaudit_addr },		/* 358 = setaudit_addr */
	{ 1, s(struct darwin_sys_auditctl_args), 0,
