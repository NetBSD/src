/* $NetBSD: darwin_sysent.c,v 1.1 2002/11/12 22:04:09 manu Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: darwin_sysent.c,v 1.1 2002/11/12 22:04:09 manu Exp $");
...
struct sysent darwin_sysent[] = {
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 296 = unimplemented load_shared_file */
	{ 0, 0, 0,
