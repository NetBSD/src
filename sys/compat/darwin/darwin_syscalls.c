/* $NetBSD: darwin_syscalls.c,v 1.54.8.2 2008/11/01 21:22:25 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: darwin_syscalls.c,v 1.54.8.2 2008/11/01 21:22:25 christos Exp $");
