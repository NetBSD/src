/* $NetBSD: darwin_syscalls.c,v 1.50.24.1 2007/11/13 16:00:35 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: darwin_syscalls.c,v 1.50.24.1 2007/11/13 16:00:35 bouyer Exp $");
