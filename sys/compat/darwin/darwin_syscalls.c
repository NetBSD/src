/* $NetBSD: darwin_syscalls.c,v 1.25.2.5 2005/11/10 14:00:41 skrll Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: darwin_syscalls.c,v 1.25.2.5 2005/11/10 14:00:41 skrll Exp $");
...
const char *const darwin_syscallnames[] = {
	...
	"getauid",			/* 353 = getauid */
	"setauid",			/* 354 = setauid */
	"getauditinfo",			/* 355 = getauditinfo */
	"setauditinfo",			/* 356 = setauditinfo */
