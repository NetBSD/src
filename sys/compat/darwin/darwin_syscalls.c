/* $NetBSD: darwin_syscalls.c,v 1.55.4.1 2008/05/10 23:48:49 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: darwin_syscalls.c,v 1.55.4.1 2008/05/10 23:48:49 wrstuden Exp $");
