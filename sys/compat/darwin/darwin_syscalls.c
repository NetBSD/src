/* $NetBSD: darwin_syscalls.c,v 1.55.4.2 2008/05/14 01:35:02 wrstuden Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: darwin_syscalls.c,v 1.55.4.2 2008/05/14 01:35:02 wrstuden Exp $");
