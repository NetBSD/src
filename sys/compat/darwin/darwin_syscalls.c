/* $NetBSD: darwin_syscalls.c,v 1.54.8.1 2008/03/29 20:46:57 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: darwin_syscalls.c,v 1.54.8.1 2008/03/29 20:46:57 christos Exp $");
