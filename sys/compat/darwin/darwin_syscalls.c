/* $NetBSD: darwin_syscalls.c,v 1.1 2002/11/12 22:04:08 manu Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: darwin_syscalls.c,v 1.1 2002/11/12 22:04:08 manu Exp $");
...
const char *const darwin_syscallnames[] = {
	...
	"#296 (unimplemented load_shared_file)",		/* 296 = unimplemented load_shared_file */
