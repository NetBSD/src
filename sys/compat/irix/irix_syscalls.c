/* $NetBSD: irix_syscalls.c,v 1.13 2001/12/23 20:57:30 manu Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: irix_syscalls.c,v 1.13 2001/12/23 20:57:30 manu Exp $");
...
const char *const irix_syscallnames[] = {
	...
	"#78 (unimplemented lseek64)",		/* 78 = unimplemented lseek64 */
	"rmdir",			/* 79 = rmdir */
	"mkdir",			/* 80 = mkdir */
