/* $NetBSD: irix_sysent.c,v 1.13 2001/12/23 20:57:30 manu Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: irix_sysent.c,v 1.13 2001/12/23 20:57:30 manu Exp $");
...
struct sysent irix_sysent[] = {
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 78 = unimplemented lseek64 */
