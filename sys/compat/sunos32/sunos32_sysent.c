/* $NetBSD: sunos32_sysent.c,v 1.38.2.1 2018/09/06 06:55:47 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos32_sysent.c,v 1.38.2.1 2018/09/06 06:55:47 pgoyette Exp $");
...
const uint32_t sunos32_sysent_nomodbits[] = {
