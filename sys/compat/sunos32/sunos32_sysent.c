/* $NetBSD: sunos32_sysent.c,v 1.21.28.1 2008/01/02 21:53:26 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos32_sysent.c,v 1.21.28.1 2008/01/02 21:53:26 bouyer Exp $");
...
struct sysent sunos32_sysent[] = {
	...
	{ ns(struct compat_10_netbsd32_sys_semsys_args), 0,
	    (sy_call_t *)compat_10_netbsd32_sys_semsys },/* 169 = osemsys */
#else
	{ 0, 0, 0,
	...
	{ ns(struct compat_10_netbsd32_sys_msgsys_args), 0,
	    (sy_call_t *)compat_10_netbsd32_sys_msgsys },/* 170 = omsgsys */
#else
	{ 0, 0, 0,
	...
	{ ns(struct compat_10_netbsd32_sys_shmsys_args), 0,
	    (sy_call_t *)compat_10_netbsd32_sys_shmsys },/* 171 = oshmsys */
#else
	{ 0, 0, 0,
