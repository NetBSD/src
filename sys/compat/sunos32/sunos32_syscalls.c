/* $NetBSD: sunos32_syscalls.c,v 1.4.4.5 2002/05/29 21:48:56 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos32_syscalls.c,v 1.4.4.5 2002/05/29 21:48:56 nathanw Exp $");
