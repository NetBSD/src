/* $NetBSD: sunos32_syscalls.c,v 1.4.4.4 2002/02/28 04:13:00 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos32_syscalls.c,v 1.4.4.4 2002/02/28 04:13:00 nathanw Exp $");
