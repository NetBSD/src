/* $NetBSD: sunos32_syscalls.c,v 1.5.2.1 2002/01/10 19:52:14 thorpej Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos32_syscalls.c,v 1.5.2.1 2002/01/10 19:52:14 thorpej Exp $");
