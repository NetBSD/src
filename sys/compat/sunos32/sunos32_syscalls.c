/* $NetBSD: sunos32_syscalls.c,v 1.16.4.1 2006/09/09 02:46:23 rpaulo Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos32_syscalls.c,v 1.16.4.1 2006/09/09 02:46:23 rpaulo Exp $");
