/* $NetBSD: sunos32_syscalls.c,v 1.19.28.1 2008/01/02 21:53:26 bouyer Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos32_syscalls.c,v 1.19.28.1 2008/01/02 21:53:26 bouyer Exp $");
