/* $NetBSD: sunos32_syscalls.c,v 1.25.2.1 2010/04/30 14:43:02 uebayasi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos32_syscalls.c,v 1.25.2.1 2010/04/30 14:43:02 uebayasi Exp $");
