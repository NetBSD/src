/* $NetBSD: sunos32_syscalls.c,v 1.4.4.2 2001/11/14 19:13:24 nathanw Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: sunos32_syscalls.c,v 1.4.4.2 2001/11/14 19:13:24 nathanw Exp $");
