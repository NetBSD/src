/* $NetBSD: init_sysent.c,v 1.220.2.5 2008/11/20 20:45:39 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: init_sysent.c,v 1.220.2.5 2008/11/20 20:45:39 christos Exp $");
...
struct sysent sysent[] = {
	...
	{ ns(struct sys_ntp_gettime_args), 0,
	    (sy_call_t *)sys_ntp_gettime },	/* 175 = ntp_gettime */
