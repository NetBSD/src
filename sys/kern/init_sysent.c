/* $NetBSD: init_sysent.c,v 1.197.2.2 2007/11/08 10:59:59 matt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: init_sysent.c,v 1.197.2.2 2007/11/08 10:59:59 matt Exp $");
...
struct sysent sysent[] = {
	...
	{ 2, s(struct sys__lwp_setname_args), 0,
	    sys__lwp_setname },			/* 323 = _lwp_setname */
	{ 3, s(struct sys__lwp_getname_args), 0,
