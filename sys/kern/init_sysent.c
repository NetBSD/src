/* $NetBSD: init_sysent.c,v 1.181.2.1 2006/10/24 21:44:17 ad Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: init_sysent.c,v 1.181.2.1 2006/10/24 21:44:17 ad Exp $");
...
struct sysent sysent[] = {
	...
	{ 6, s(struct compat_10_sys_msgsys_args), SYCALL_MPSAFE | 0,
	    compat_10(sys_msgsys) },		/* 170 = compat_10 omsgsys */
#else
	{ 0, 0, 0,
	    sys_nosys },			/* 170 = excluded MPSAFE 1.0 msgsys */
#endif
...
#else
	{ 0, 0, 0,
	    sys_nosys },			/* 224 = excluded MPSAFE compat_14_msgctl */
	{ 0, 0, 0,
	    sys_nosys },			/* 225 = excluded MPSAFE msgget */
	{ 0, 0, 0,
	    sys_nosys },			/* 226 = excluded MPSAFE msgsnd */
	{ 0, 0, 0,
	    sys_nosys },			/* 227 = excluded MPSAFE msgrcv */
#endif
...
#else
	{ 0, 0, 0,
	    sys_nosys },			/* 302 = excluded MPSAFE __msgctl13 */
#endif
#if defined(SYSVSHM) || !defined(_KERNEL)
