/* $NetBSD: init_sysent.c,v 1.220.2.4 2008/11/09 23:29:58 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: init_sysent.c,v 1.220.2.4 2008/11/09 23:29:58 christos Exp $");
...
struct sysent sysent[] = {
	...
	{ ns(struct compat_50_sys___fhstat40_args), 0,
	    (sy_call_t *)compat_50(sys___fhstat40) },/* 398 = compat_50___fhstat40 */
