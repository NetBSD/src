...
#else
#endif
int	compat_09(getdomainname)();
int	compat_09(setdomainname)();
int	compat_09(uname)();
#if defined(SYSVSEM) && !defined(alpha)
#else
#endif
...
#endif
#if defined(SYSVSEM) && !defined(alpha)
int	compat_10(semsys)();
#else
#endif
#if defined(SYSVMSG) && !defined(alpha)
int	compat_10(msgsys)();
#else
#endif
#if defined(SYSVSHM) && !defined(alpha)
int	compat_10(shmsys)();
#else
#endif
#ifdef LFS
#else
...
struct sysent sysent[] = {
	...
	{ 0, 0,
	    compat_43(getdtablesize) },		/* 89 = compat_43 getdtablesize */
	...
	{ 2, s(struct compat_09_getdomainname_args),
	    compat_09(getdomainname) },		/* 162 = compat_09 getdomainname */
	{ 2, s(struct compat_09_setdomainname_args),
	    compat_09(setdomainname) },		/* 163 = compat_09 setdomainname */
	{ 1, s(struct compat_09_uname_args),
	    compat_09(uname) },			/* 164 = compat_09 uname */
	{ 2, s(struct sysarch_args),
	    sysarch },				/* 165 = sysarch */
	{ 0, 0,
	...
	{ 5, s(struct compat_10_semsys_args),
	    compat_10(semsys) },		/* 169 = compat_10 semsys */
#else
	{ 0, 0,
	    nosys },				/* 169 = unimplemented 1.0 semsys */
#endif
#if defined(SYSVMSG) && !defined(alpha)
	{ 6, s(struct compat_10_msgsys_args),
	    compat_10(msgsys) },		/* 170 = compat_10 msgsys */
#else
	{ 0, 0,
	    nosys },				/* 170 = unimplemented 1.0 msgsys */
#endif
#if defined(SYSVSHM) && !defined(alpha)
	{ 4, s(struct compat_10_shmsys_args),
	    compat_10(shmsys) },		/* 171 = compat_10 shmsys */
#else
	{ 0, 0,
	    nosys },				/* 171 = unimplemented 1.0 shmsys */
#endif
	{ 0, 0,
