/* $NetBSD: init_sysent.c,v 1.346.2.1 2026/08/25 20:04:58 martin Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: init_sysent.c,v 1.346.2.1 2026/08/25 20:04:58 martin Exp $");
...
struct sysent sysent[] = {
	...
	},		/* 172 = filler */
	{
		...
		.sy_flags = SYCALL_NARGS64_VAL(1) | SYCALL_ARG4_64 | SYCALL_ARG_PTR | SYCALL_RET_WIDE,
	...
	},		/* 196 = compat_12_getdirentries */
	{
		...
		.sy_flags = SYCALL_NARGS64_VAL(1) | SYCALL_ARG6_64 | SYCALL_ARG_PTR | SYCALL_RET_WIDE,
		.sy_call = (sy_call_t *)sys_mmap
	},		/* 197 = mmap */
	{
		ns(struct sys___syscall_args),
		.sy_flags = SYCALL_NARGS64_VAL(1) | SYCALL_ARG0_64 | SYCALL_RET_WIDE | SYCALL_RET_64 | SYCALL_INDIRECT,
		.sy_call = (sy_call_t *)sys___syscall
	},		/* 198 = __syscall */
	{
		ns(struct sys_lseek_args),
		.sy_flags = SYCALL_NARGS64_VAL(1) | SYCALL_ARG2_64 | SYCALL_RET_WIDE | SYCALL_RET_64,
