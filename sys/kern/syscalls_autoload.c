/* $NetBSD: syscalls_autoload.c,v 1.21.2.2 2017/03/20 06:57:47 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: syscalls_autoload.c,v 1.21.2.2 2017/03/20 06:57:47 pgoyette Exp $");
