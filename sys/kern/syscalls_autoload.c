...
static struct sc_autoload netbsd_syscalls_autoload[] = {
	    ...
	    { SYS_compat_60_sa_register, "compat" },
	    { SYS_compat_60_sa_stacks, "compat" },
	    { SYS_compat_60_sa_enable, "compat" },
	    { SYS_compat_60_sa_setconcurrency, "compat" },
	    { SYS_compat_60_sa_yield, "compat" },
	    { SYS_compat_60_sa_preempt, "compat" },
