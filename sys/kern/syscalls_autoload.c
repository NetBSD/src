/* $NetBSD: syscalls_autoload.c,v 1.23.6.1 2017/05/11 02:58:40 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: syscalls_autoload.c,v 1.23.6.1 2017/05/11 02:58:40 pgoyette Exp $");
