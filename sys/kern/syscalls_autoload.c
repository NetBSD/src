/* $NetBSD: syscalls_autoload.c,v 1.21.2.1 2016/11/04 14:49:17 pgoyette Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: syscalls_autoload.c,v 1.21.2.1 2016/11/04 14:49:17 pgoyette Exp $");
