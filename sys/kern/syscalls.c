/* $NetBSD: syscalls.c,v 1.190.2.2 2007/11/08 11:00:07 matt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: syscalls.c,v 1.190.2.2 2007/11/08 11:00:07 matt Exp $");
...
const char *const syscallnames[] = {
	...
	"_lwp_setname",			/* 323 = _lwp_setname */
	"_lwp_getname",			/* 324 = _lwp_getname */
