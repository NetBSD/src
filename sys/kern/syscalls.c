/*	$NetBSD: syscalls.c,v 1.73 1998/02/14 00:40:47 thorpej Exp $	*/
...
char *syscallnames[] = {
	...
	"#283 (unimplemented __posix_chown)",		/* 283 = unimplemented __posix_chown */
	"#284 (unimplemented __posix_fchown)",		/* 284 = unimplemented __posix_fchown */
	"#285 (unimplemented __posix_lchown)",		/* 285 = unimplemented __posix_lchown */
	"getsid",			/* 286 = getsid */
};
