/* $NetBSD: syscalls.c,v 1.159.2.8 2008/02/04 09:24:19 yamt Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: syscalls.c,v 1.159.2.8 2008/02/04 09:24:19 yamt Exp $");
