/* $NetBSD: secmodel_example.c,v 1.26.40.1 2019/06/10 22:05:39 christos Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: secmodel_example.c,v 1.26.40.1 2019/06/10 22:05:39 christos Exp $");
