/* $NetBSD: secmodel_example.c,v 1.23.2.1 2008/03/24 07:14:50 keiichi Exp $ */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: secmodel_example.c,v 1.23.2.1 2008/03/24 07:14:50 keiichi Exp $");
