#      $NetBSD: bsd.own.mk,v 1.1486 2026/09/21 23:24:49 christos Exp $
...
_LIBC_COMPILER_RT.mipseb=	yes
_LIBC_COMPILER_RT.mipsel=	yes
_LIBC_COMPILER_RT.mips64eb=	yes
_LIBC_COMPILER_RT.mips64el=	yes
...
.if ${HAVE_JEMALLOC} == 540 || ${HAVE_JEMALLOC} == 100
EXTERNAL_JEMALLOC_SUBDIR = jemalloc
.elif ${HAVE_JEMALLOC} == 531
...
#
# We want to build zfs only for aarch64{,be}, amd64, riscv64, and sparc64
# by default for now.
#
.if \
    ${MACHINE_ARCH:Maarch64*} || \
...
#
# DTrace works on aarch64, earm*, i386, and x86_64
#
.if \
...
#
# RELRO is enabled on aarch64, amd64, i386, and mip64 by default
#
...
_NEEDS_LIBCXX.mipseb=		yes
_NEEDS_LIBCXX.mipsel=		yes
_NEEDS_LIBCXX.mips64eb=		yes
_NEEDS_LIBCXX.mips64el=		yes
