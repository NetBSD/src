...
extern void ctf_get_ctt_info(const ctf_file_t *, const void *v, uint_t *kind,
    uint_t *vlen, uint_t *isroot);

extern void ctf_get_ctm_info(const ctf_file_t *fp, const void *v, ssize_t sz,
    ssize_t *incrementp, uint_t *typep, ulong_t *offsetp, const char **namep);
