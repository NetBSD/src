/*	$NetBSD: rsa_test.c,v 1.1.1.4 2026/08/29 14:32:15 christos Exp $	*/
...
ISC_TEST_ENTRY_CUSTOM(isc_rsa_fromdns_oversized_exponent, setup_test,
		      teardown_test)
ISC_TEST_ENTRY_CUSTOM(isc_rsa_fromdns_even_exponent, setup_test, teardown_test)
ISC_TEST_ENTRY_CUSTOM(isc_rsa_fromdns_oversized_modulus, setup_test,
		      teardown_test)
ISC_TEST_ENTRY_CUSTOM(isc_rsa_fromdns_short_modulus, setup_test, teardown_test)
ISC_TEST_LIST_END
