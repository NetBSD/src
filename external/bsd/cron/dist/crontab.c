/*	$NetBSD: crontab.c,v 1.3.6.2 2013/01/16 05:27:43 yamt Exp $	*/
...
#else
__RCSID("$NetBSD: crontab.c,v 1.3.6.2 2013/01/16 05:27:43 yamt Exp $");
#endif
#endif
...
replace_cmd(void) {
	...
	(void)fprintf(tmp, "# (Cron version %s -- %s)\n", CRON_VERSION, "$NetBSD: crontab.c,v 1.3.6.2 2013/01/16 05:27:43 yamt Exp $");
