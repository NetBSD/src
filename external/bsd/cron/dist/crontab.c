/*	$NetBSD: crontab.c,v 1.3.6.1 2012/04/17 00:03:05 yamt Exp $	*/
...
#else
__RCSID("$NetBSD: crontab.c,v 1.3.6.1 2012/04/17 00:03:05 yamt Exp $");
#endif
#endif
...
replace_cmd(void) {
	...
	(void)fprintf(tmp, "# (Cron version %s -- %s)\n", CRON_VERSION, "$NetBSD: crontab.c,v 1.3.6.1 2012/04/17 00:03:05 yamt Exp $");
