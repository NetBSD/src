/*	$NetBSD: crontab.c,v 1.5.2.1 2012/11/20 02:57:58 tls Exp $	*/
...
#else
__RCSID("$NetBSD: crontab.c,v 1.5.2.1 2012/11/20 02:57:58 tls Exp $");
#endif
#endif
...
replace_cmd(void) {
	...
	(void)fprintf(tmp, "# (Cron version %s -- %s)\n", CRON_VERSION, "$NetBSD: crontab.c,v 1.5.2.1 2012/11/20 02:57:58 tls Exp $");
