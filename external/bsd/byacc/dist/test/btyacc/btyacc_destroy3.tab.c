/*	$NetBSD: btyacc_destroy3.tab.c,v 1.1.1.9 2026/01/18 16:39:08 christos Exp $	*/
...
#line 504 "btyacc_destroy3.tab.c"
...
#line 523 "btyacc_destroy3.tab.c"
	break;
    }
}
...
#line 74 "btyacc_destroy3.y"
	{ yyval.tval = tREAL; }
#line 1226 "btyacc_destroy3.tab.c"
break;
case 6:
  if (!yytrial)
...
#line 1240 "btyacc_destroy3.tab.c"
break;
case 8:
  if (!yytrial)
...
#line 1248 "btyacc_destroy3.tab.c"
break;
case 9:
  if (!yytrial)
#line 89 "btyacc_destroy3.y"
	{ yyval.nlist = yystack.l_mark[-5].nlist; }
#line 1254 "btyacc_destroy3.tab.c"
break;
#line 1256 "btyacc_destroy3.tab.c"
    default:
        break;
    }
    yystack.s_mark -= yym;
