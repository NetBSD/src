/*	$NetBSD: inherit1.tab.c,v 1.1.1.9 2026/01/18 16:39:07 christos Exp $	*/
...
"namelist","locnamelist","class","type","$$1","$$2","illegal-symbol",
};
...
#line 1102 "inherit1.tab.c"
break;
case 2:
#line 46 "inherit1.y"
	{ yyval.nlist = yystack.l_mark[0].nlist; }
#line 1107 "inherit1.tab.c"
break;
case 3:
#line 49 "inherit1.y"
	{ yyval.cval = cGLOBAL; }
...
#line 1151 "inherit1.tab.c"
break;
case 11:
#line 71 "inherit1.y"
	{ yyval.nlist = yystack.l_mark[0].nlist; }
#line 1156 "inherit1.tab.c"
break;
#line 1158 "inherit1.tab.c"
    default:
        break;
    }
    yystack.s_mark -= yym;
