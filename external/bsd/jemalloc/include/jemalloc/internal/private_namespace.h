...
#define opt_pac_sec_opts JEMALLOC_N(opt_pac_sec_opts)
...
#define malloc_init_hard JEMALLOC_N(malloc_init_hard)
#define malloc_init_hard_a0 JEMALLOC_N(malloc_init_hard_a0)
#define malloc_init_state JEMALLOC_N(malloc_init_state)
#define malloc_is_initializer JEMALLOC_N(malloc_is_initializer)
...
#define arena_cache_bin_array_register JEMALLOC_N(arena_cache_bin_array_register)
#define arena_cache_bin_array_unregister JEMALLOC_N(arena_cache_bin_array_unregister)
#define arena_cache_bins_stats_merge JEMALLOC_N(arena_cache_bins_stats_merge)
...
#define arena_ind_is_huge JEMALLOC_N(arena_ind_is_huge)
#define arena_init_huge JEMALLOC_N(arena_init_huge)
#define arena_locality_hint JEMALLOC_N(arena_locality_hint)
...
#define arena_prof_demote JEMALLOC_N(arena_prof_demote)
...
#define a0ialloc JEMALLOC_N(a0ialloc)
#define a0idalloc JEMALLOC_N(a0idalloc)
...
#define arenas_management_boot JEMALLOC_N(arenas_management_boot)
#define arenas_management_postfork_child JEMALLOC_N(arenas_management_postfork_child)
#define arenas_management_postfork_parent JEMALLOC_N(arenas_management_postfork_parent)
#define arenas_management_prefork JEMALLOC_N(arenas_management_prefork)
#define iarena_cleanup JEMALLOC_N(iarena_cleanup)
#define manual_arena_base JEMALLOC_N(manual_arena_base)
#define manual_arena_base_set JEMALLOC_N(manual_arena_base_set)
#define narenas_auto JEMALLOC_N(narenas_auto)
#define narenas_auto_set JEMALLOC_N(narenas_auto_set)
#define narenas_total_get JEMALLOC_N(narenas_total_get)
#define narenas_total_inc JEMALLOC_N(narenas_total_inc)
#define narenas_total_set JEMALLOC_N(narenas_total_set)
#define background_thread_arena_reset_begin JEMALLOC_N(background_thread_arena_reset_begin)
#define background_thread_arena_reset_finish JEMALLOC_N(background_thread_arena_reset_finish)
...
#define background_thread_serialize_lock JEMALLOC_N(background_thread_serialize_lock)
#define background_thread_serialize_unlock JEMALLOC_N(background_thread_serialize_unlock)
...
#define bin_current_slab_addr JEMALLOC_N(bin_current_slab_addr)
...
#define extent_dalloc_wrapper_purged JEMALLOC_N(extent_dalloc_wrapper_purged)
...
#define hpa_alloc JEMALLOC_N(hpa_alloc)
#define hpa_dalloc JEMALLOC_N(hpa_dalloc)
#define hpa_hugify_style_names JEMALLOC_N(hpa_hugify_style_names)
...
#define hpa_time_until_deferred_work JEMALLOC_N(hpa_time_until_deferred_work)
...
#define hpdata_find_alloc_offsets JEMALLOC_N(hpdata_find_alloc_offsets)
#define hpdata_hugify JEMALLOC_N(hpdata_hugify)
#define hpdata_init JEMALLOC_N(hpdata_init)
#define hpdata_post_reserve_alloc_offsets JEMALLOC_N(hpdata_post_reserve_alloc_offsets)
...
#define hpdata_reserve_alloc_offset JEMALLOC_N(hpdata_reserve_alloc_offset)
...
#define malloc_dispatch_dalloc_promoted JEMALLOC_N(malloc_dispatch_dalloc_promoted)
#define malloc_dispatch_palloc JEMALLOC_N(malloc_dispatch_palloc)
#define malloc_dispatch_ralloc JEMALLOC_N(malloc_dispatch_ralloc)
...
#define pa_shard_handle_deferred_work JEMALLOC_N(pa_shard_handle_deferred_work)
...
#define pac_alloc JEMALLOC_N(pac_alloc)
#define pac_dalloc JEMALLOC_N(pac_dalloc)
#define pac_decay_all JEMALLOC_N(pac_decay_all)
#define pac_decay_all_now JEMALLOC_N(pac_decay_all_now)
...
#define pac_do_deferred_work JEMALLOC_N(pac_do_deferred_work)
#define pac_expand JEMALLOC_N(pac_expand)
...
#define pac_sec_flush JEMALLOC_N(pac_sec_flush)
#define pac_shrink JEMALLOC_N(pac_shrink)
#define pac_time_until_deferred_work JEMALLOC_N(pac_time_until_deferred_work)
#define pac_wake_bg_on_deferred JEMALLOC_N(pac_wake_bg_on_deferred)
#define init_system_thp_mode JEMALLOC_N(init_system_thp_mode)
#define mmap_flags JEMALLOC_N(mmap_flags)
#define opt_thp JEMALLOC_N(opt_thp)
#define os_overcommits JEMALLOC_N(os_overcommits)
...
#define prof_sample_te_handler JEMALLOC_N(prof_sample_te_handler)
...
#define sec_alloc JEMALLOC_N(sec_alloc)
#define sec_calc_nallocs_for_size JEMALLOC_N(sec_calc_nallocs_for_size)
...
#define sec_shard_pick JEMALLOC_N(sec_shard_pick)
#define sec_stats_merge JEMALLOC_N(sec_stats_merge)
#define sec_stats_merge_pszind JEMALLOC_N(sec_stats_merge_pszind)
...
#define tcache_bin_info_default_init JEMALLOC_N(tcache_bin_info_default_init)
...
#define tcache_gc_te_handler JEMALLOC_N(tcache_gc_te_handler)
#define tcache_postfork_arena_descriptor JEMALLOC_N(tcache_postfork_arena_descriptor)
...
#define test_hooks_safety_check_abort JEMALLOC_N(test_hooks_safety_check_abort)
