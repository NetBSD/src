...
base_new(tsdn_t *tsdn, unsigned ind, const extent_hooks_t *extent_hooks,
	 ...
	 */
	extent_hooks_t *e_hooks = metadata_use_hooks ?
	    (extent_hooks_t *)__UNCONST(extent_hooks) :
	    (extent_hooks_t *)__UNCONST(&ehooks_default_extent_hooks);
	ehooks_t fake_ehooks;
	ehooks_init(&fake_ehooks, e_hooks, ind);
	...
	ehooks_init(&base->ehooks, (extent_hooks_t *)__UNCONST(extent_hooks), ind);
	ehooks_init(&base->ehooks_base, e_hooks, ind);
...
base_boot(tsdn_t *tsdn) {
	b0 = base_new(tsdn, 0, (extent_hooks_t *)__UNCONST(&ehooks_default_extent_hooks),
