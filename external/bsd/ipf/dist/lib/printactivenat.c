/*	$NetBSD: printactivenat.c,v 1.1.1.2 2012/07/22 13:44:40 darrenr Exp $	*/
...
#if !defined(lint)
static const char rcsid[] = "@(#)$Id: printactivenat.c,v 1.1.1.2 2012/07/22 13:44:40 darrenr Exp $";
#endif
