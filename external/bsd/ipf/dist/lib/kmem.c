/*	$NetBSD: kmem.c,v 1.3 2018/02/04 08:19:42 mrg Exp $	*/
...
#if !defined(lint)
static __attribute__((__used__)) const char sccsid[] = "@(#)kmem.c	1.4 1/12/96 (C) 1992 Darren Reed";
static __attribute__((__used__)) const char rcsid[] = "@(#)Id: kmem.c,v 1.1.1.2 2012/07/22 13:44:39 darrenr Exp $";
#endif
