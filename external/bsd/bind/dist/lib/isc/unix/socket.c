/*	$NetBSD: socket.c,v 1.8.4.1.4.4 2017/04/25 22:02:00 snj Exp $	*/
...
#ifdef BIND9
void
isc__socket_setname(isc_socket_t *sock0, const char *name, void *tag);
ISC_SOCKETFUNC_SCOPE const char *
isc__socket_getname(isc_socket_t *sock0);
void *          
isc__socket_gettag(isc_socket_t *sock0);
ISC_SOCKETFUNC_SCOPE isc_result_t
