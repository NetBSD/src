/*	$NetBSD: cl_screen.c,v 1.4.12.1 2017/01/18 08:46:20 skrll Exp $ */
/*-
...
#endif /* not lint */
#else
__RCSID("$NetBSD: cl_screen.c,v 1.4.12.1 2017/01/18 08:46:20 skrll Exp $");
#endif
 ...
 *
 * PUBLIC: int cl_getcap __P((SCR *, const char *, char **));
 */
int
