...
#endif
  E_OImode,                /* config/rs6000/rs6000-modes.def:89 */
#define HAVE_OImode
#ifdef USE_ENUM_MODES
...
#endif
  E_XImode,                /* config/rs6000/rs6000-modes.def:90 */
#define HAVE_XImode
#ifdef USE_ENUM_MODES
...
#endif
  E_POImode,               /* config/rs6000/rs6000-modes.def:93 */
#define HAVE_POImode
#ifdef USE_ENUM_MODES
...
#endif
  E_PXImode,               /* config/rs6000/rs6000-modes.def:94 */
#define HAVE_PXImode
#ifdef USE_ENUM_MODES
#define PXImode E_PXImode
#else
#define PXImode (scalar_int_mode ((scalar_int_mode::from_int) E_PXImode))
#endif
...
#endif
  E_CPXImode,              /* machmode.def:263 */
#define HAVE_CPXImode
#ifdef USE_ENUM_MODES
#define CPXImode E_CPXImode
#else
#define CPXImode (complex_mode ((complex_mode::from_int) E_CPXImode))
#endif
...
#define V4DFmode ((void) 0, E_V4DFmode)
  ...
  MAX_MODE_PARTIAL_INT = E_PXImode,
