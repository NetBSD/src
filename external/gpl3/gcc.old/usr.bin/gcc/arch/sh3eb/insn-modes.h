...
#define HAVE_DCmode
  V2QImode,                /* config/sh/sh-modes.def:21 */
#define HAVE_V2QImode
  V4QImode,                /* config/sh/sh-modes.def:22 */
#define HAVE_V4QImode
  V2HImode,                /* config/sh/sh-modes.def:22 */
#define HAVE_V2HImode
  V8QImode,                /* config/sh/sh-modes.def:23 */
#define HAVE_V8QImode
  V4HImode,                /* config/sh/sh-modes.def:23 */
#define HAVE_V4HImode
  V2SImode,                /* config/sh/sh-modes.def:23 */
#define HAVE_V2SImode
  V16QImode,               /* config/sh/sh-modes.def:24 */
#define HAVE_V16QImode
  V8HImode,                /* config/sh/sh-modes.def:24 */
#define HAVE_V8HImode
  V4SImode,                /* config/sh/sh-modes.def:24 */
#define HAVE_V4SImode
  V2DImode,                /* config/sh/sh-modes.def:24 */
#define HAVE_V2DImode
  V4DImode,                /* config/sh/sh-modes.def:27 */
#define HAVE_V4DImode
  V8DImode,                /* config/sh/sh-modes.def:28 */
#define HAVE_V8DImode
  V2SFmode,                /* config/sh/sh-modes.def:25 */
#define HAVE_V2SFmode
  V4SFmode,                /* config/sh/sh-modes.def:26 */
#define HAVE_V4SFmode
  V2DFmode,                /* config/sh/sh-modes.def:26 */
#define HAVE_V2DFmode
  V16SFmode,               /* config/sh/sh-modes.def:29 */
