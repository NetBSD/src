  ...
  {
    {
      ...
      {
        isa_bit_armv5te, isa_bit_thumb, isa_bit_be8, isa_bit_armv5t, 
        isa_bit_armv4, isa_bit_quirk_armv6kz, isa_bit_armv6, isa_bit_notm, 
  ...
  {
    {
      ...
      {
        isa_bit_vfpv2, isa_bit_armv5te, isa_bit_thumb, isa_bit_be8, 
        isa_bit_armv5t, isa_bit_armv4, isa_bit_quirk_armv6kz, isa_bit_armv6, 
  ...
  {
    {
      ...
      cpu_opttab_cortexa55,
      {
        ...
        isa_bit_armv6, isa_bit_armv7, isa_bit_crc32, isa_bit_armv8, 
  ...
  {
    {
      ...
      {
        isa_bit_armv5te, isa_bit_thumb, isa_bit_be8, isa_bit_armv5t, 
        isa_bit_armv4, isa_bit_armv6, isa_bit_cmse, isa_bit_armv8, 
  ...
  {
    {
      ...
      cpu_opttab_cortexm33,
      {
        isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_vfpv4, isa_bit_armv5te, 
        isa_bit_thumb, isa_bit_be8, isa_bit_armv5t, isa_bit_armv4, 
        isa_bit_armv6, isa_bit_armv7em, isa_bit_armv7, isa_bit_cmse, 
        isa_bit_armv8, isa_bit_fpv5, isa_bit_tdiv, isa_bit_thumb2, 
...
const arch_option all_architectures[] =
{
  ...
  },
  {
    ...
    arch_opttab_armv8_3_a,
    {
      ...
      isa_bit_thumb2, isa_bit_notm, isa_bit_armv8_1, isa_bit_armv6k, 
      isa_bit_armv8_2, isa_bit_armv8_3, isa_bit_mp, isa_bit_sec, 
      isa_nobit
    },
    "8A", BASE_ARCH_8A,
    'A',
  ...
  },
  {
    ...
    {
      isa_bit_armv5te, isa_bit_thumb, isa_bit_be8, isa_bit_armv5t, 
      isa_bit_armv4, isa_bit_armv6, isa_bit_armv7, isa_bit_cmse, 
      isa_bit_armv8, isa_bit_tdiv, isa_bit_thumb2, isa_nobit
    },
