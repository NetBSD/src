...
G_INCLUDES=-I. -I${GNUHOSTDIST}/bfd -I${GNUHOSTDIST}/bfd/../include   -DHAVE_mips_elf32_trad_le_vec -DHAVE_mips_elf32_trad_be_vec -DHAVE_mips_elf64_trad_be_vec -DHAVE_mips_elf64_trad_le_vec -DHAVE_mips_ecoff_le_vec -DHAVE_mips_ecoff_be_vec -DHAVE_elf64_le_vec -DHAVE_elf64_be_vec -DHAVE_elf32_le_vec -DHAVE_elf32_be_vec -DHAVE_plugin_vec -I./../intl
G_TDEFAULTS=-DDEFAULT_VECTOR=mips_elf32_trad_le_vec -DSELECT_VECS='&mips_elf32_trad_le_vec,&mips_elf32_trad_be_vec,&mips_elf64_trad_be_vec,&mips_elf64_trad_le_vec,&mips_ecoff_le_vec,&mips_ecoff_be_vec,&elf64_le_vec,&elf64_be_vec,&elf32_le_vec,&elf32_be_vec,&plugin_vec' -DSELECT_ARCHITECTURES='&bfd_mips_arch,&bfd_plugin_arch'
