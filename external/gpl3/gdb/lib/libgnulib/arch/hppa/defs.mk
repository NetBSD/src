...
#
G_OBJS=canonicalize-lgpl.o chdir-long.o error.o fnmatch.o frexpl.o getcwd.o getcwd-lgpl.o getrandom.o glob.o glob_pattern_p.o globfree.o lc-charset-dispatch.o localtime-buffer.o mbrtowc.o mbsinit.o mbsrtowcs.o mbsrtowcs-state.o mbtowc-lock.o memmem.o mempcpy.o rawmemchr.o setlocale-lock.o strerror.o strerror-override.o strerror_r.o strstr.o wmempcpy.o
