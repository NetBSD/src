...
#define GDB_HOST_DOUBLE_FORMAT &floatformat_ieee_double_big

/* Host float floatformat */
#define GDB_HOST_FLOAT_FORMAT &floatformat_ieee_single_big

/* Host long double floatformat */
#define GDB_HOST_LONG_DOUBLE_FORMAT &floatformat_m68881_ext
