...
extern initialize_file_ftype _initialize_block;
...
extern initialize_file_ftype _initialize_break_cond_parse;
...
extern initialize_file_ftype _initialize_inline_frame;
