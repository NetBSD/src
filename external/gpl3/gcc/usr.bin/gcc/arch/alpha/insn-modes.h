...
#endif
  E_TFmode,                /* config/alpha/alpha-modes.def:22 */
#define HAVE_TFmode
#ifdef USE_ENUM_MODES
...
#endif
  E_V2QImode,              /* config/alpha/alpha-modes.def:27 */
...
#endif
  E_V4QImode,              /* config/alpha/alpha-modes.def:26 */
...
#endif
  E_V8QImode,              /* config/alpha/alpha-modes.def:25 */
...
#endif
  E_V4HImode,              /* config/alpha/alpha-modes.def:25 */
...
#endif
  E_V2SImode,              /* config/alpha/alpha-modes.def:25 */
