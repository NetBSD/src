...
static const cpu_arch_extension cpu_opttab_cortexa710[] = {
  {
    "crypto", false, false,
    {
      isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_vfpv4, isa_bit_neon, 
...
static const cpu_arch_extension cpu_opttab_cortexr52plus[] = {
  {
    "nofp.dp", true, false,
    {
      isa_bit_i8mm, isa_bit_fp16fml, isa_bit_dotprod, isa_bit_neon, 
  ...
  {
    {
      ...
      {
        isa_bit_vfpv2, isa_bit_adiv, isa_bit_vfpv3, isa_bit_vfpv4, 
        isa_bit_quirk_aes_1742098, isa_bit_armv5te, isa_bit_thumb, isa_bit_be8, 
        isa_bit_armv5t, isa_bit_lpae, isa_bit_armv4, isa_bit_neon, 
  ...
  {
    {
      ...
      cpu_opttab_cortexa710,
      {
        ...
        isa_bit_dotprod, isa_bit_lpae, isa_bit_armv4, isa_bit_neon, 
        isa_bit_armv6, isa_bit_crc32, isa_bit_armv7, isa_bit_armv8, 
        isa_bit_fpv5, isa_bit_armv9, isa_bit_tdiv, isa_bit_fp_d32, 
        isa_bit_thumb2, isa_bit_notm, isa_bit_fp16, isa_bit_armv8_1, 
        isa_bit_fp16conv, isa_bit_armv8_2, isa_bit_armv6k, isa_bit_armv8_3, 
        isa_bit_mp, isa_bit_armv8_4, isa_bit_armv8_5, isa_bit_fp_dbl, 
        isa_bit_sec, isa_bit_predres, isa_nobit
      }
    },
    NULL,
    TARGET_ARCH_armv9_a
...
static const struct cpu_arch_extension arch_opttab_armv9_a[] = {
  {
    "simd", false, false,
    {
      isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_vfpv4, isa_bit_dotprod, 
...
const arch_option all_architectures[] =
{
  ...
  },
  {
    ...
    arch_opttab_armv9_a,
    {
      ...
      isa_bit_be8, isa_bit_armv5t, isa_bit_lpae, isa_bit_armv4, 
      isa_bit_armv6, isa_bit_crc32, isa_bit_armv7, isa_bit_armv8, 
      isa_bit_armv9, isa_bit_tdiv, isa_bit_thumb2, isa_bit_notm, 
      isa_bit_armv8_1, isa_bit_armv8_2, isa_bit_armv6k, isa_bit_armv8_3, 
      isa_bit_mp, isa_bit_armv8_4, isa_bit_armv8_5, isa_bit_sec, 
      isa_bit_predres, isa_nobit
    },
    "9A", BASE_ARCH_9A,
    'A',
