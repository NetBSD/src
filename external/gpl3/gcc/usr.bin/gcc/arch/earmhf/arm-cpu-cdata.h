  ...
  {
    {
      ...
      cpu_opttab_cortexm33,
      {
        ...
        isa_bit_cmse, isa_bit_fpv5, isa_bit_tdiv, isa_bit_thumb2, 
  ...
  {
    {
      ...
      cpu_opttab_cortexm55,
      {
        ...
        isa_bit_fpv5, isa_bit_tdiv, isa_bit_thumb2, isa_bit_fp16, 
        isa_bit_fp16conv, isa_bit_fp_dbl, isa_bit_mve_float, isa_nobit
      }
    },
    NULL,
