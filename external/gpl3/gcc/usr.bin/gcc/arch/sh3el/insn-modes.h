...
#endif
  E_V2QImode,              /* config/sh/sh-modes.def:21 */
...
#endif
  E_V4QImode,              /* config/sh/sh-modes.def:22 */
...
#endif
  E_V2HImode,              /* config/sh/sh-modes.def:22 */
...
#endif
  E_V8QImode,              /* config/sh/sh-modes.def:23 */
...
#endif
  E_V4HImode,              /* config/sh/sh-modes.def:23 */
...
#endif
  E_V2SImode,              /* config/sh/sh-modes.def:23 */
...
#endif
  E_V16QImode,             /* config/sh/sh-modes.def:24 */
...
#endif
  E_V8HImode,              /* config/sh/sh-modes.def:24 */
...
#endif
  E_V4SImode,              /* config/sh/sh-modes.def:24 */
...
#endif
  E_V2DImode,              /* config/sh/sh-modes.def:24 */
...
#endif
  E_V4DImode,              /* config/sh/sh-modes.def:27 */
...
#endif
  E_V8DImode,              /* config/sh/sh-modes.def:28 */
...
#endif
  E_V2SFmode,              /* config/sh/sh-modes.def:25 */
...
#endif
  E_V4SFmode,              /* config/sh/sh-modes.def:26 */
...
#endif
  E_V2DFmode,              /* config/sh/sh-modes.def:26 */
...
#endif
  E_V16SFmode,             /* config/sh/sh-modes.def:29 */
...
#define V16SFmode ((void) 0, E_V16SFmode)
  ...
  MAX_MODE_VECTOR_FLOAT = E_V16SFmode,
