...
static const char configuration_arguments[] = "/usr/src/tools/gcc/../../external/gpl3/gcc/dist/configure --target=shle--netbsdelf --enable-long-long --enable-threads --with-bugurl=http://www.NetBSD.org/Misc/send-pr.html --with-pkgversion='NetBSD nb2 20111202' --with-system-zlib --enable-__cxa_atexit --with-mpc=/var/obj/mknative/hpcsh/usr/src/destdir.hpcsh/usr --with-mpfr=/var/obj/mknative/hpcsh/usr/src/destdir.hpcsh/usr --with-gmp=/var/obj/mknative/hpcsh/usr/src/destdir.hpcsh/usr --enable-tls --disable-multilib --disable-symvers --disable-libstdcxx-pch --build=x86_64-unknown-netbsd5.99.56 --host=shle--netbsdelf";
