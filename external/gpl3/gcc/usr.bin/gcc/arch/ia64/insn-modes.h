...
#endif
  E_CCImode,               /* config/ia64/ia64-modes.def:76 */
#define HAVE_CCImode
#ifdef USE_ENUM_MODES
#define CCImode E_CCImode
#else
#define CCImode ((void) 0, E_CCImode)
#endif
...
#endif
  E_OImode,                /* config/ia64/ia64-modes.def:68 */
#define HAVE_OImode
#ifdef USE_ENUM_MODES
...
#endif
  E_XFmode,                /* config/ia64/ia64-modes.def:29 */
#define HAVE_XFmode
#ifdef USE_ENUM_MODES
...
#endif
  E_RFmode,                /* config/ia64/ia64-modes.def:30 */
#define HAVE_RFmode
#ifdef USE_ENUM_MODES
#define RFmode E_RFmode
#else
#define RFmode (scalar_float_mode ((scalar_float_mode::from_int) E_RFmode))
#endif
  E_TFmode,                /* config/ia64/ia64-modes.def:31 */
#define HAVE_TFmode
#ifdef USE_ENUM_MODES
...
#endif
  E_RCmode,                /* machmode.def:264 */
#define HAVE_RCmode
#ifdef USE_ENUM_MODES
#define RCmode E_RCmode
#else
#define RCmode (complex_mode ((complex_mode::from_int) E_RCmode))
#endif
...
#endif
  E_V4QImode,              /* config/ia64/ia64-modes.def:79 */
...
#endif
  E_V2HImode,              /* config/ia64/ia64-modes.def:79 */
...
#endif
  E_V8QImode,              /* config/ia64/ia64-modes.def:80 */
...
#endif
  E_V4HImode,              /* config/ia64/ia64-modes.def:80 */
...
#endif
  E_V2SImode,              /* config/ia64/ia64-modes.def:80 */
...
#endif
  E_V16QImode,             /* config/ia64/ia64-modes.def:81 */
...
#endif
  E_V8HImode,              /* config/ia64/ia64-modes.def:82 */
...
#endif
  E_V4SImode,              /* config/ia64/ia64-modes.def:83 */
...
#endif
  E_V2SFmode,              /* config/ia64/ia64-modes.def:84 */
...
#endif
  E_V4SFmode,              /* config/ia64/ia64-modes.def:85 */
...
#define V4SFmode ((void) 0, E_V4SFmode)
  ...
  MAX_MODE_VECTOR_INT = E_V4SImode,
  ...
  MAX_MODE_VECTOR_FLOAT = E_V4SFmode,
