...
#
G_INCLUDES=-I. -I. -I${GNUHOSTDIST}/gcc -I${GNUHOSTDIST}/gcc/. -I${GNUHOSTDIST}/gcc/../include -I./../intl -I${GNUHOSTDIST}/gcc/../libcpp/include -I/var/obj/landisk/usr/src3/destdir.landisk/usr/include -I/var/obj/landisk/usr/src3/destdir.landisk/usr/include -I/var/obj/landisk/usr/src3/destdir.landisk/usr/include  -I${GNUHOSTDIST}/gcc/../libdecnumber -I${GNUHOSTDIST}/gcc/../libdecnumber/dpd -I../libdecnumber   -I/usr/include/libelf
