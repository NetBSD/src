...
#
G_INCLUDES=-I. -I. -I${GNUHOSTDIST}/gcc -I${GNUHOSTDIST}/gcc/. -I${GNUHOSTDIST}/gcc/../include -I./../intl -I${GNUHOSTDIST}/gcc/../libcpp/include -I/usr/src/tools/gcc/../../external/lgpl3/gmp/lib/libgmp/arch/earm -I/usr/src/tools/gcc/../../external/lgpl3/mpfr/dist -I/usr/src/tools/gcc/../../external/lgpl2/mpc/dist/src  -I${GNUHOSTDIST}/gcc/../libdecnumber -I${GNUHOSTDIST}/gcc/../libdecnumber/dpd -I../libdecnumber   -I/usr/include/libelf
G_CRTSTUFF_CFLAGS=-O2  -DIN_GCC   -W -Wall -Wwrite-strings -Wcast-qual -Wstrict-prototypes -Wmissing-prototypes -Wold-style-definition  -isystem ./include  -I. -I. -I${GNUHOSTDIST}/gcc -I${GNUHOSTDIST}/gcc/. -I${GNUHOSTDIST}/gcc/../include -I./../intl -I${GNUHOSTDIST}/gcc/../libcpp/include -I/usr/src/tools/gcc/../../external/lgpl3/gmp/lib/libgmp/arch/earm -I/usr/src/tools/gcc/../../external/lgpl3/mpfr/dist -I/usr/src/tools/gcc/../../external/lgpl2/mpc/dist/src  -I${GNUHOSTDIST}/gcc/../libdecnumber -I${GNUHOSTDIST}/gcc/../libdecnumber/dpd -I../libdecnumber   -I/usr/include/libelf  -g0 -finhibit-size-directive -fno-inline -fno-exceptions -fno-zero-initialized-in-bss -fno-toplevel-reorder -fno-tree-vectorize 
G_CRTSTUFF_T_CFLAGS=
