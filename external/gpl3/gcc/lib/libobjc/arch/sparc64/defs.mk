...
G_ALL_OPT_URL_FILES= ${GNUHOSTDIST}/gcc/fortran/lang.opt.urls  ${GNUHOSTDIST}/gcc/lto/lang.opt.urls  ${GNUHOSTDIST}/gcc/c-family/c.opt.urls  ${GNUHOSTDIST}/gcc/common.opt.urls  ${GNUHOSTDIST}/gcc/params.opt.urls  ${GNUHOSTDIST}/gcc/analyzer/analyzer.opt.urls  ${GNUHOSTDIST}/gcc/config/sparc/sparc.opt.urls  ${GNUHOSTDIST}/gcc/config/netbsd.opt.urls  ${GNUHOSTDIST}/gcc/config/netbsd-elf.opt.urls  ${GNUHOSTDIST}/gcc/config/sparc/long-double-switch.opt.urls
