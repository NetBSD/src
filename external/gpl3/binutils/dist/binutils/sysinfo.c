...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_top = 12,                       /* top  */
  YYSYMBOL_13_1 = 13,                      /* $@1  */
  YYSYMBOL_it_list = 14,                   /* it_list  */
  YYSYMBOL_it = 15,                        /* it  */
  YYSYMBOL_16_2 = 16,                      /* $@2  */
  YYSYMBOL_it_field_list = 17,             /* it_field_list  */
  YYSYMBOL_repeat_it_field = 18,           /* repeat_it_field  */
  YYSYMBOL_19_3 = 19,                      /* $@3  */
  YYSYMBOL_cond_it_field = 20,             /* cond_it_field  */
  YYSYMBOL_21_4 = 21,                      /* $@4  */
  YYSYMBOL_it_field = 22,                  /* it_field  */
  YYSYMBOL_23_5 = 23,                      /* $@5  */
  YYSYMBOL_attr_type = 24,                 /* attr_type  */
  YYSYMBOL_attr_desc = 25,                 /* attr_desc  */
  YYSYMBOL_attr_size = 26,                 /* attr_size  */
  YYSYMBOL_attr_id = 27,                   /* attr_id  */
  YYSYMBOL_enums = 28,                     /* enums  */
  YYSYMBOL_enum_list = 29                  /* enum_list  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "COND", "REPEAT",
  "'('", "')'", "TYPE", "NAME", "NUMBER", "UNIT", "$accept", "top", "$@1",
  "it_list", "it", "$@2", "it_field_list", "repeat_it_field", "$@3",
  "cond_it_field", "$@4", "it_field", "$@5", "attr_type", "attr_desc",
  "attr_size", "attr_id", "enums", "enum_list", YY_NULLPTR
};
...
#line 1283 "sysinfo.c"
  ...
  case 7: /* it: '(' NAME NUMBER $@2 it_field_list ')'  */
#line 150 "sysinfo.y"
{
  switch (writecode) {
  case 'd':
...
#line 1337 "sysinfo.c"
  ...
  case 13: /* repeat_it_field: '(' REPEAT NAME $@3 it_field_list ')'  */
#line 209 "sysinfo.y"
        {
	  free (repeat);
...
#line 1375 "sysinfo.c"
  ...
  case 15: /* cond_it_field: '(' COND NAME $@4 it_field_list ')'  */
#line 243 "sysinfo.y"
        {
	  switch (writecode)
	    {
...
#line 1396 "sysinfo.c"
  ...
  case 17: /* it_field: '(' attr_desc '(' attr_type attr_size ')' attr_id $@5 enums ')'  */
#line 259 "sysinfo.y"
        {
	  char *desc = (yyvsp[-8].s);
	  char *type = (yyvsp[-6].s);
...
#line 1504 "sysinfo.c"
  ...
  case 18: /* attr_type: TYPE  */
#line 367 "sysinfo.y"
              { (yyval.s) = (yyvsp[0].s); }
#line 1510 "sysinfo.c"
    break;

  case 19: /* attr_type: %empty  */
#line 368 "sysinfo.y"
           { (yyval.s) = "INT";}
#line 1516 "sysinfo.c"
    break;

  case 20: /* attr_desc: '(' NAME ')'  */
#line 373 "sysinfo.y"
        { (yyval.s) = (yyvsp[-1].s); }
#line 1522 "sysinfo.c"
    break;

  case 21: /* attr_size: NUMBER UNIT  */
#line 378 "sysinfo.y"
        { (yyval.i) = (yyvsp[-1].i) * (yyvsp[0].i); }
#line 1528 "sysinfo.c"
    break;

  case 22: /* attr_id: '(' NAME ')'  */
#line 383 "sysinfo.y"
                                { (yyval.s) = (yyvsp[-1].s); }
#line 1534 "sysinfo.c"
    break;

  case 23: /* attr_id: %empty  */
#line 384 "sysinfo.y"
                { (yyval.s) = strdup ("dummy");}
#line 1540 "sysinfo.c"
    break;

  case 27: /* enum_list: enum_list '(' NAME NAME ')'  */
#line 392 "sysinfo.y"
                                    {
	  switch (writecode)
	    {
