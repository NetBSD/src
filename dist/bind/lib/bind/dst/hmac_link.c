/*	$NetBSD: hmac_link.c,v 1.1.1.5.10.1 2010/04/21 05:19:38 matt Exp $	*/

#ifdef HMAC_MD5
#ifndef LINT
static const char rcsid[] = "Header: /proj/cvs/prod/bind9/lib/bind/dst/Attic/hmac_link.c,v 1.8 2007/09/24 17:18:25 each Exp";
#endif
/*
