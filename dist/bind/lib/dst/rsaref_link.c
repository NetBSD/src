/*	$NetBSD: rsaref_link.c,v 1.1.1.1.4.1 1999/12/27 18:27:30 wrstuden Exp $	*/

#ifdef RSAREF
static const char rcsid[] = "$Header: /cvsroot/src/dist/bind/lib/dst/Attic/rsaref_link.c,v 1.1.1.1.4.1 1999/12/27 18:27:30 wrstuden Exp $";
