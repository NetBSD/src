/*	$NetBSD: dst_api.c,v 1.1.1.1.4.1 1999/12/27 18:27:29 wrstuden Exp $	*/

#ifndef LINT
static const char rcsid[] = "$Header: /cvsroot/src/dist/bind/lib/dst/Attic/dst_api.c,v 1.1.1.1.4.1 1999/12/27 18:27:29 wrstuden Exp $";
#endif
