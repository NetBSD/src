/*	$NetBSD: ip_fil.h,v 1.1.1.4 2000/05/03 10:55:34 veego Exp $	*/
 ...
 * Id: ip_fil.h,v 2.29.2.1 2000/04/25 16:18:32 darrenr Exp
 */
...
extern	int	send_icmp_err __P((ip_t *, int, int, fr_info_t *, int));
#  endif
