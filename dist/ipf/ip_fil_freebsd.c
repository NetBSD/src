/*	$NetBSD: ip_fil_freebsd.c,v 1.1.1.1 2004/03/28 08:55:32 martti Exp $	*/
...
static const char rcsid[] = "@(#)Id: ip_fil_freebsd.c,v 2.53.2.4 2004/03/22 12:18:07 darrenr Exp";
#endif
