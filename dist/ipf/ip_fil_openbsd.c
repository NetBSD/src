/*	$NetBSD: ip_fil_openbsd.c,v 1.1.1.1 2004/03/28 08:55:35 martti Exp $	*/
...
static const char rcsid[] = "@(#)Id: ip_fil_openbsd.c,v 2.50.2.2 2004/03/22 12:18:09 darrenr Exp";
#endif
...
frdest_t *fdp;
{
	...
	*/
	...
	if (fin->fin_v == 6) {
		 ...
		 * for IPv6
		 */
		return ipfr_fastroute6(m, mpp, fin, fdp);
	}
#endif
	/*
	 * Route packet.
