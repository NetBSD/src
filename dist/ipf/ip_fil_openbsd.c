/*	$NetBSD: ip_fil_openbsd.c,v 1.1.1.4 2006/04/04 16:08:32 martti Exp $	*/
...
static const char rcsid[] = "@(#)Id: ip_fil_openbsd.c,v 2.50.2.23 2006/03/25 13:03:02 darrenr Exp";
#endif
