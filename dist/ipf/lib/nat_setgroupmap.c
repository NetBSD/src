/*	$NetBSD: nat_setgroupmap.c,v 1.1.1.3 2012/01/30 16:03:24 darrenr Exp $	*/
 ...
 */
#if !defined(lint)
static const char rcsid[] = "@(#)Id: nat_setgroupmap.c,v 1.5.2.1 2012/01/26 05:29:16 darrenr Exp";
#endif
