/*	$NetBSD: murmurhash.c,v 1.4.2.1 2014/08/19 23:45:14 tls Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: murmurhash.c,v 1.4.2.1 2014/08/19 23:45:14 tls Exp $");

#else

#if defined(LIBC_SCCS) && !defined(lint)
__RCSID("$NetBSD: murmurhash.c,v 1.4.2.1 2014/08/19 23:45:14 tls Exp $");
