/*	$NetBSD: murmurhash.c,v 1.4.4.3 2014/05/22 11:26:30 yamt Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: murmurhash.c,v 1.4.4.3 2014/05/22 11:26:30 yamt Exp $");

#else

#if defined(LIBC_SCCS) && !defined(lint)
__RCSID("$NetBSD: murmurhash.c,v 1.4.4.3 2014/05/22 11:26:30 yamt Exp $");
