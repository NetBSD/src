/*	$NetBSD: sha1.c,v 1.2.2.2 2006/10/27 21:25:22 christos Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: sha1.c,v 1.2.2.2 2006/10/27 21:25:22 christos Exp $");
...
__RCSID("$NetBSD: sha1.c,v 1.2.2.2 2006/10/27 21:25:22 christos Exp $");
