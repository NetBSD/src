/*	$NetBSD: sha1.c,v 1.6.48.2 2020/04/21 19:37:49 martin Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: sha1.c,v 1.6.48.2 2020/04/21 19:37:49 martin Exp $");
...
__RCSID("$NetBSD: sha1.c,v 1.6.48.2 2020/04/21 19:37:49 martin Exp $");
