/*	$NetBSD: sha1.c,v 1.2.4.1 2008/11/18 19:10:02 snj Exp $	*/
...
__KERNEL_RCSID(0, "$NetBSD: sha1.c,v 1.2.4.1 2008/11/18 19:10:02 snj Exp $");
...
__RCSID("$NetBSD: sha1.c,v 1.2.4.1 2008/11/18 19:10:02 snj Exp $");
