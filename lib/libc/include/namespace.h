/*	$NetBSD: namespace.h,v 1.2.4.8 1996/09/20 17:00:21 jtc Exp $	*/
...
#define iruserok		_iruserok
#define isatty			_isatty
#define iso_addr		_iso_addr
#define iso_ntoa		_iso_ntoa
