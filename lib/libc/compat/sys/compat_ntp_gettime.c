/* $NetBSD: compat_ntp_gettime.c,v 1.1.28.1 2008/11/08 21:45:38 christos Exp $ */

#include <sys/cdefs.h>
#if defined(LIBC_SCCS) && !defined(lint)
__RCSID("$NetBSD: compat_ntp_gettime.c,v 1.1.28.1 2008/11/08 21:45:38 christos Exp $");
