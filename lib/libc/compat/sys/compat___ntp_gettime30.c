/* $NetBSD: compat___ntp_gettime30.c,v 1.1.2.1 2008/11/10 00:13:02 christos Exp $ */

#include <sys/cdefs.h>
#if defined(LIBC_SCCS) && !defined(lint)
__RCSID("$NetBSD: compat___ntp_gettime30.c,v 1.1.2.1 2008/11/10 00:13:02 christos Exp $");
