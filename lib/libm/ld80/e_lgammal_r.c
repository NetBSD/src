...
#define	a0	(a0u.extu_ld)
#define	a1	(a1u.extu_ld)
#define	a2	(a2u.extu_ld)
#define	a3	(a3u.extu_ld)
#define	a4	(a4u.extu_ld)
#define	a5	(a5u.extu_ld)
#define	a6	(a6u.extu_ld)
#define	a7	(a7u.extu_ld)
#define	a8	(a8u.extu_ld)
#define	a9	(a9u.extu_ld)
#define	a10	(a10u.extu_ld)
#define	a11	(a11u.extu_ld)
#define	a12	(a12u.extu_ld)
#define	a13	(a13u.extu_ld)
/*
...
#define	tc	(tcu.extu_ld)
#define	tf	(tfu.extu_ld)
#define	tt	(ttu.extu_ld)
#define	t0	(t0u.extu_ld)
#define	t1	(t1u.extu_ld)
#define	t2	(t2u.extu_ld)
#define	t3	(t3u.extu_ld)
#define	t4	(t4u.extu_ld)
#define	t5	(t5u.extu_ld)
#define	t6	(t6u.extu_ld)
#define	t7	(t7u.extu_ld)
#define	t8	(t8u.extu_ld)
#define	t9	(t9u.extu_ld)
#define	t10	(t10u.extu_ld)
#define	t11	(t11u.extu_ld)
#define	t12	(t12u.extu_ld)
#define	t13	(t13u.extu_ld)
#define	t14	(t14u.extu_ld)
#define	t15	(t15u.extu_ld)
#define	t16	(t16u.extu_ld)
#define	t17	(t17u.extu_ld)
#define	t18	(t18u.extu_ld)
/*
...
#define	u0	(u0u.extu_ld)
#define	u1	(u1u.extu_ld)
#define	u2	(u2u.extu_ld)
#define	u3	(u3u.extu_ld)
#define	u4	(u4u.extu_ld)
#define	u5	(u5u.extu_ld)
#define	u6	(u6u.extu_ld)
#define	v1	(v1u.extu_ld)
#define	v2	(v2u.extu_ld)
#define	v3	(v3u.extu_ld)
#define	v4	(v4u.extu_ld)
#define	v5	(v5u.extu_ld)
#define	v6	(v6u.extu_ld)
/*
...
#define	s0	(s0u.extu_ld)
#define	s1	(s1u.extu_ld)
#define	s2	(s2u.extu_ld)
#define	s3	(s3u.extu_ld)
#define	s4	(s4u.extu_ld)
#define	s5	(s5u.extu_ld)
#define	s6	(s6u.extu_ld)
#define	r1	(r1u.extu_ld)
#define	r2	(r2u.extu_ld)
#define	r3	(r3u.extu_ld)
#define	r4	(r4u.extu_ld)
#define	r5	(r5u.extu_ld)
#define	r6	(r6u.extu_ld)
#define	r7	(r7u.extu_ld)
/*
...
#define	w0	(w0u.extu_ld)
#define	w1	(w1u.extu_ld)
#define	w2	(w2u.extu_ld)
#define	w3	(w3u.extu_ld)
#define	w4	(w4u.extu_ld)
#define	w5	(w5u.extu_ld)
#define	w6	(w6u.extu_ld)
#define	w7	(w7u.extu_ld)
#define	w8	(w8u.extu_ld)
