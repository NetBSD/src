...
#define	efx	(efxu.extu_ld)
#define	efx8	(efx8u.extu_ld)
#define	pp0	(pp0u.extu_ld)
#define	pp1	(pp1u.extu_ld)
#define	pp2	(pp2u.extu_ld)
#define	pp3	(pp3u.extu_ld)
#define	pp4	(pp4u.extu_ld)
#define	pp5	(pp5u.extu_ld)
#define	qq1	(qq1u.extu_ld)
#define	qq2	(qq2u.extu_ld)
#define	qq3	(qq3u.extu_ld)
#define	qq4	(qq4u.extu_ld)
#define	qq5	(qq5u.extu_ld)
#define	qq6	(qq6u.extu_ld)
static const union ieee_ext_u
...
#define qa1	(qa1u.extu_ld)
#define qa2	(qa2u.extu_ld)
#define qa3	(qa3u.extu_ld)
#define qa4	(qa4u.extu_ld)
#define qa5	(qa5u.extu_ld)
#define qa6	(qa6u.extu_ld)
#define qa7	(qa7u.extu_ld)
static const union ieee_ext_u
/*
...
#define ra0	(ra0u.extu_ld)
#define ra1	(ra1u.extu_ld)
#define ra2	(ra2u.extu_ld)
#define ra3	(ra3u.extu_ld)
#define ra4	(ra4u.extu_ld)
#define ra5	(ra5u.extu_ld)
#define ra6	(ra6u.extu_ld)
#define ra7	(ra7u.extu_ld)
#define ra8	(ra8u.extu_ld)
#define ra9	(ra9u.extu_ld)
#define sa1	(sa1u.extu_ld)
#define sa2	(sa2u.extu_ld)
#define sa3	(sa3u.extu_ld)
#define sa4	(sa4u.extu_ld)
#define sa5	(sa5u.extu_ld)
#define sa6	(sa6u.extu_ld)
#define sa7	(sa7u.extu_ld)
#define sa8	(sa8u.extu_ld)
#define sa9	(sa9u.extu_ld)
/*
...
#define rb0	(rb0u.extu_ld)
#define rb1	(rb1u.extu_ld)
#define rb2	(rb2u.extu_ld)
#define rb3	(rb3u.extu_ld)
#define rb4	(rb4u.extu_ld)
#define rb5	(rb5u.extu_ld)
#define rb6	(rb6u.extu_ld)
#define rb7	(rb7u.extu_ld)
#define sb1	(sb1u.extu_ld)
#define sb2	(sb2u.extu_ld)
#define sb3	(sb3u.extu_ld)
#define sb4	(sb4u.extu_ld)
#define sb5	(sb5u.extu_ld)
#define sb6	(sb6u.extu_ld)
#define sb7	(sb7u.extu_ld)
/*
...
#define rc0	(rc0u.extu_ld)
#define rc1	(rc1u.extu_ld)
#define rc2	(rc2u.extu_ld)
#define rc3	(rc3u.extu_ld)
#define rc4	(rc4u.extu_ld)
#define rc5	(rc5u.extu_ld)
#define sc1	(sc1u.extu_ld)
#define sc2	(sc2u.extu_ld)
#define sc3	(sc3u.extu_ld)
#define sc4	(sc4u.extu_ld)
#define sc5	(sc5u.extu_ld)

long double
erfl(long double x)
{
	long double ax,R,S,P,Q,s,y,z,r;
	uint64_t lx __unused;
	int32_t i;
	uint16_t hx;
