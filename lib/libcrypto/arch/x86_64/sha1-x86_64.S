...
.Lloop:
	...
	movl	%eax,40(%rsp)
	addl	%ebx,%edx
	leal	2400959708(%rax,%r11,1),%r12d
	movl	44(%rsp),%eax
	movl	%esi,%ebx
	movl	%esi,%ecx
	xorl	52(%rsp),%eax
	...
	movl	%eax,44(%rsp)
	addl	%ebx,%r12d
	leal	2400959708(%rax,%rbp,1),%r11d
	movl	48(%rsp),%eax
	movl	%edx,%ebx
	movl	%edx,%ecx
	xorl	56(%rsp),%eax
	...
	movl	%eax,48(%rsp)
	addl	%ebx,%edx
	leal	3395469782(%rax,%r11,1),%r12d
	movl	52(%rsp),%eax
	movl	%edi,%ebx
	movl	%edx,%r11d
	xorl	60(%rsp),%eax
	...
	roll	$1,%eax
	movl	%eax,52(%rsp)
	leal	3395469782(%rax,%rbp,1),%r11d
	movl	56(%rsp),%eax
	movl	%esi,%ebx
	movl	%r12d,%ebp
	xorl	0(%rsp),%eax
