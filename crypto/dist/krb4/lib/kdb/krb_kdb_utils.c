...
RCSID("$Id: krb_kdb_utils.c,v 1.1.1.1.4.2 2000/06/16 18:45:52 thorpej Exp $");
...
#else
  des_pcbc_encrypt((const void *)in,(void *)out,
		   sizeof(des_cblock),master_key_sched,master_key, e_d_flag);
#endif
}
