...
/* These are NetBSD added compat functions; note that they are
   "library internal" in the MIT doc, so don't use them unless you
   really have to. */

unsigned int
krb5_princ_size(krb5_context, krb5_principal);

NAME_TYPE
krb5_princ_type(krb5_context, krb5_principal);
