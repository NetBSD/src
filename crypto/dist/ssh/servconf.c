/*	$NetBSD: servconf.c,v 1.38.4.1 2008/01/09 01:22:45 matt Exp $	*/
...
#include "includes.h"
__RCSID("$NetBSD: servconf.c,v 1.38.4.1 2008/01/09 01:22:45 matt Exp $");
...
parse_flag:
	...
	case sLogFacility:
		intptr = (int *)(void *)&options->log_facility;
		arg = strdelim(&cp);
