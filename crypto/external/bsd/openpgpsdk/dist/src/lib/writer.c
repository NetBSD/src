...
void 
writer_info_delete(ops_writer_info_t * winfo)
{
...
void 
ops_writer_pop(ops_create_info_t * info)
{
 ...
 */
void           *
ops_writer_get_arg(ops_writer_info_t * winfo)
{
	return winfo->arg;
}
 ...
 */
void 
ops_writer_generic_destroyer(ops_writer_info_t * winfo)
{
