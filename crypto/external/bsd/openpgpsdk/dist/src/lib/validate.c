...
static int 
keydata_reader(void *dest, size_t length, ops_error_t ** errors,
...
static void 
free_signature_info(ops_signature_info_t * sig)
{
...
static void 
keydata_destroyer(ops_reader_info_t * rinfo)
{
...
*/
void 
ops_validate_result_free(ops_validate_result_t * result)
{
	if (!result)
		return;
