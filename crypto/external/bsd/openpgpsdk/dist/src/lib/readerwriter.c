...
*/
void 
ops_setup_memory_write(ops_create_info_t ** cinfo, ops_memory_t ** mem, size_t bufsz)
{
	/*
...
*/
void 
ops_teardown_memory_write(ops_create_info_t * cinfo, ops_memory_t * mem)
{
...
*/
void 
ops_teardown_memory_read(ops_parse_info_t * pinfo, ops_memory_t * mem)
{
...
*/
void 
ops_teardown_file_write(ops_create_info_t * cinfo, int fd)
{
...
*/
int 
ops_setup_file_append(ops_create_info_t ** cinfo, const char *filename)
{
	int             fd;
	/*
         * initialise needed structures for writing to file
...
*/
void 
ops_teardown_file_append(ops_create_info_t * cinfo, int fd)
{
...
*/
void 
ops_teardown_file_read(ops_parse_info_t * pinfo, int fd)
{
	close(fd);
	ops_parse_info_delete(pinfo);
}
