 ...
 */
static int 
limited_read_data(ops_data_t * data, unsigned int len,
 ...
 */
static int 
read_data(ops_data_t * data, ops_region_t * subregion,
...
static int 
read_unsigned_string(unsigned char **str, ops_region_t * subregion,
		     ops_parse_info_t * pinfo)
{
	int             len = 0;
...
static int 
read_string(char **str, ops_region_t * subregion, ops_parse_info_t * pinfo)
{
...
static int 
sub_base_read(void *dest, size_t length, ops_error_t ** errors,
...
int 
ops_stacked_read(void *dest, size_t length, ops_error_t ** errors,
		 ops_reader_info_t * rinfo, ops_parse_cb_info_t * cbinfo)
{
 ...
 */
static int 
limited_skip(unsigned length, ops_region_t * region,
	     ops_parse_info_t * pinfo)
{
 ...
 */
static int 
limited_read_time(time_t * dest, ops_region_t * region,
		  ops_parse_info_t * pinfo)
{
	/*
 ...
 */
static int 
limited_read_mpi(BIGNUM ** pbn, ops_region_t * region,
		 ops_parse_info_t * pinfo)
{
	unsigned        length;
	unsigned        nonzero;
	unsigned char   buf[8192] = "";	/* an MPI has a 2 byte length part.
 ...
 */
static int 
limited_read_new_length(unsigned *length, ops_region_t * region,
			ops_parse_info_t * pinfo)
{
	unsigned char   c[1] = "";
...
void 
ops_packet_free(ops_packet_t * packet)
{
	free(packet->raw);
	packet->raw = NULL;
}
...
*/
static void 
ops_headers_free(ops_headers_t * headers)
{
	unsigned        n;
...
*/
static void 
ops_signed_cleartext_trailer_free(ops_signed_cleartext_trailer_t * trailer)
{
	free(trailer->hash);
	trailer->hash = NULL;
}
...
*/
static void 
ops_cmd_get_passphrase_free(ops_secret_key_passphrase_t * skp)
{
...
void 
ops_parser_content_free(ops_parser_content_t * c)
{
	switch (c->tag) {
...
*/
void 
ops_pk_session_key_free(ops_pk_session_key_t * sk)
{
	switch (sk->algorithm) {
	case OPS_PKA_RSA:
...
void 
ops_public_key_free(ops_public_key_t * p)
{
	switch (p->algorithm) {
	case OPS_PKA_RSA:
...
*/
static int 
parse_public_key_data(ops_public_key_t * key, ops_region_t * region,
		      ops_parse_info_t * pinfo)
{
	unsigned char   c[1] = "";
 ...
 */
static int 
parse_public_key(ops_content_tag_t tag, ops_region_t * region,
		 ops_parse_info_t * pinfo)
{
...
void 
ops_ss_regexp_free(ops_ss_regexp_t * regexp)
{
...
/* ! Free the memory used when parsing this signature sub-packet type */
void 
ops_ss_policy_url_free(ops_ss_policy_url_t * policy_url)
{
...
/* ! Free the memory used when parsing this signature sub-packet type */
void 
ops_ss_preferred_key_server_free(ops_ss_preferred_key_server_t * preferred_key_server)
{
...
void 
ops_user_attribute_free(ops_user_attribute_t * user_att)
{
...
static int 
parse_user_attribute(ops_region_t * region, ops_parse_info_t * pinfo)
{
...
/* ! Free the memory used when parsing this packet type */
void 
ops_user_id_free(ops_user_id_t * id)
{
	free(id->user_id);
	id->user_id = NULL;
}
 ...
 */
static int 
parse_user_id(ops_region_t * region, ops_parse_info_t * pinfo)
{
	ops_parser_content_t content;
	...
	C.user_id.user_id = malloc(region->length + 1);	/* XXX should we not
							 * like check malloc's
							 * return value? */
 ...
 */
static void 
free_unknown_sig_pka(ops_unknown_signature_t * unknown_sig)
{
 ...
 */
void 
ops_signature_free(ops_signature_t * sig)
{
 ...
 */
static int 
parse_v3_signature(ops_region_t * region,
		   ops_parse_info_t * pinfo)
{
	unsigned char   c[1] = "";
	ops_parser_content_t content;
 ...
 */
static int 
parse_one_signature_subpacket(ops_signature_t * sig,
			      ops_region_t * region,
			      ops_parse_info_t * pinfo)
{
...
*/
void 
ops_ss_key_flags_free(ops_ss_key_flags_t * ss_key_flags)
{
...
*/
void 
ops_ss_features_free(ops_ss_features_t * ss_features)
{
...
*/
void 
ops_ss_key_server_prefs_free(ops_ss_key_server_prefs_t * ss_key_server_prefs)
{
 ...
 */
static int 
parse_signature_subpackets(ops_signature_t * sig,
			   ops_region_t * region,
			   ops_parse_info_t * pinfo)
{
	ops_region_t    subregion;
 ...
 */
static int 
parse_v4_signature(ops_region_t * region, ops_parse_info_t * pinfo)
{
	unsigned char   c[1] = "";
	ops_parser_content_t content;
 ...
 */
static int 
parse_signature(ops_region_t * region, ops_parse_info_t * pinfo)
{
	unsigned char   c[1] = "";
	ops_parser_content_t content;
...
*/
static int 
parse_compressed(ops_region_t * region, ops_parse_info_t * pinfo)
{
	unsigned char   c[1] = "";
	ops_parser_content_t content;
...
*/
static int 
parse_one_pass(ops_region_t * region, ops_parse_info_t * pinfo)
{
	unsigned char   c[1] = "";
	ops_parser_content_t content;
...
*/
void 
ops_ss_userdefined_free(ops_ss_userdefined_t * ss_userdefined)
{
...
*/
void 
ops_ss_reserved_free(ops_ss_unknown_t * ss_unknown)
{
...
*/
void 
ops_ss_notation_data_free(ops_ss_notation_data_t * ss_notation_data)
{
...
void 
ops_ss_embedded_signature_free(ops_ss_embedded_signature_t * ss_embedded_signature)
{
...
*/
void 
ops_ss_revocation_reason_free(ops_ss_revocation_reason_t * ss_revocation_reason)
{
...
*/
void 
ops_trust_free(ops_trust_t * trust)
{
...
*/
static int 
parse_literal_data(ops_region_t * region, ops_parse_info_t * pinfo)
{
	ops_parser_content_t content;
	unsigned char   c[1] = "";
...
void 
ops_secret_key_free(ops_secret_key_t * key)
{
 ...
 */
static int 
parse_secret_key(ops_region_t * region, ops_parse_info_t * pinfo)
{
	ops_parser_content_t content;
	unsigned char   c[1] = "";
	ops_crypt_t     decrypt;
	...
	if (ops_get_debug_level(__FILE__)) {
		...
		/*
		 * ops_print_secret_key_verbose(OPS_PTAG_CT_SECRET_KEY,
		 * &C.secret_key);
		 */
	}
...
*/
static int 
parse_pk_session_key(ops_region_t * region,
		     ops_parse_info_t * pinfo)
{
	unsigned char   c[1] = "";
	ops_parser_content_t content;
...
static int 
ops_decrypt_se_data(ops_content_tag_t tag, ops_region_t * region,
		    ops_parse_info_t * pinfo)
{
	int             r = 1;
...
static int 
ops_decrypt_se_ip_data(ops_content_tag_t tag, ops_region_t * region,
		       ops_parse_info_t * pinfo)
{
	int             r = 1;
	ops_crypt_t    *decrypt = ops_parse_get_decrypt(pinfo);
...
*/
static int 
parse_se_data(ops_region_t * region, ops_parse_info_t * pinfo)
{
	ops_parser_content_t content;
...
*/
static int 
parse_se_ip_data(ops_region_t * region, ops_parse_info_t * pinfo)
{
	unsigned char   c[1] = "";
	ops_parser_content_t content;
...
*/
static int 
parse_mdc(ops_region_t * region, ops_parse_info_t * pinfo)
{
	ops_parser_content_t content;
...
static int 
ops_parse_one_packet(ops_parse_info_t * pinfo,
...
int 
ops_parse(ops_parse_info_t * pinfo)
{
	int             r;
	unsigned long   pktlen;
...
int 
ops_parse_and_print_errors(ops_parse_info_t * pinfo)
{
	int             r;
	r = ops_parse(pinfo);
	ops_print_errors(pinfo->errors);
...
void 
ops_parse_options(ops_parse_info_t * pinfo,
...
*/
void 
ops_parse_info_delete(ops_parse_info_t * pinfo)
{
...
*/
ops_reader_info_t *
ops_parse_get_rinfo(ops_parse_info_t * pinfo)
{
	return &pinfo->rinfo;
}
...
void 
ops_parse_cb_set(ops_parse_info_t * pinfo, ops_parse_cb_t * cb, void *arg)
{
	pinfo->cbinfo.cb = cb;
...
*/
void           *
ops_parse_cb_get_arg(ops_parse_cb_info_t * cbinfo)
{
	return cbinfo->arg;
}
...
*/
void           *
ops_parse_cb_get_errors(ops_parse_cb_info_t * cbinfo)
{
...
*/
ops_error_t    *
ops_parse_info_get_errors(ops_parse_info_t * pinfo)
{
	return pinfo->errors;
}

ops_crypt_t    *
ops_parse_get_decrypt(ops_parse_info_t * pinfo)
{
