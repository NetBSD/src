...
static void 
push_back(dearmour_arg_t * arg, const unsigned char *buf,
	  unsigned length)
{
	unsigned        n;
...
static int 
set_lastseen_headerline(dearmour_arg_t * arg, char *buf, ops_error_t ** errors)
{
	  ...
	  ops_boolean_t skip)
{
	...
	do {
		...
		/*
		 * XXX: should ops_stacked_read exist? Shouldn't this be a
		 * limited_read?
		 */
...
static int 
read_and_eat_whitespace(dearmour_arg_t * arg,
			ops_error_t ** errors,
			ops_reader_info_t * rinfo,
			ops_parse_cb_info_t * cbinfo,
			ops_boolean_t skip)
...
static void 
flush(dearmour_arg_t * arg, ops_parse_cb_info_t * cbinfo)
{
 ...
 */
static const char *
ops_find_header(ops_headers_t * headers, const char *key)
{
	unsigned        n;
 ...
 */
static void 
ops_dup_headers(ops_headers_t * dest, const ops_headers_t * src)
{
	unsigned        n;
 ...
 */
static int 
process_dash_escaped(dearmour_arg_t * arg, ops_error_t ** errors,
		     ops_reader_info_t * rinfo,
		     ops_parse_cb_info_t * cbinfo)
{
	ops_parser_content_t content;
...
static int 
add_header(dearmour_arg_t * arg, const char *key, const char
	   *value)
{
	/*
...
static int 
parse_headers(dearmour_arg_t * arg, ops_error_t ** errors,
...
static int 
read4(dearmour_arg_t * arg, ops_error_t ** errors,
      ops_reader_info_t * rinfo, ops_parse_cb_info_t * cbinfo,
...
unsigned 
ops_crc24(unsigned checksum, unsigned char c)
{
	unsigned        i;
...
static int 
decode64(dearmour_arg_t * arg, ops_error_t ** errors,
	 ops_reader_info_t * rinfo, ops_parse_cb_info_t * cbinfo)
{
	unsigned        n;
	int             n2;
...
static int 
armoured_data_reader(void *dest_, size_t length, ops_error_t ** errors,
		     ops_reader_info_t * rinfo,
		     ops_parse_cb_info_t * cbinfo)
{
...
static void 
armoured_data_destroyer(ops_reader_info_t * rinfo)
{
 ...
 */
void 
ops_reader_push_dearmour(ops_parse_info_t * parse_info)
/*
 ...
 */
void 
ops_reader_pop_dearmour(ops_parse_info_t * pinfo)
{
