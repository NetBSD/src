 ...
 */
static void 
dash_escaped_destroyer(ops_writer_info_t * winfo)
{
	dash_escaped_arg_t *arg = ops_writer_get_arg(winfo);
...
*/
void 
ops_writer_push_armoured_message(ops_create_info_t * info)
/* ops_create_signature_t *sig) */
{
...
*/
void 
ops_writer_push_armoured(ops_create_info_t * info, ops_armor_type_t type)
{
