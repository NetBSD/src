...
static int 
encrypted_data_reader(void *dest, size_t length, ops_error_t ** errors,
...
static void 
encrypted_data_destroyer(ops_reader_info_t * rinfo)
{
 ...
 */
void 
ops_reader_pop_decrypt(ops_parse_info_t * pinfo)
{
