/*	$NetBSD: ssh-pkcs11-client.c,v 1.17.6.1 2023/11/02 22:15:22 sborrill Exp $	*/
 ...
 */
#include "includes.h"
__RCSID("$NetBSD: ssh-pkcs11-client.c,v 1.17.6.1 2023/11/02 22:15:22 sborrill Exp $");
...
{
	int pair[2];
	const char *prog, *verbosity = NULL;
	struct helper *helper;
	pid_t pid;
