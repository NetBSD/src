/*	$NetBSD: ssh-keygen.c,v 1.44.2.2 2023/11/02 22:15:22 sborrill Exp $	*/
...
#include "includes.h"
__RCSID("$NetBSD: ssh-keygen.c,v 1.44.2.2 2023/11/02 22:15:22 sborrill Exp $");
#include <sys/types.h>
...
static const char *sk_provider = NULL;
