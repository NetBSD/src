/*	$NetBSD: cipher-chachapoly-libcrypto.c,v 1.2.2.1 2023/11/02 22:15:21 sborrill Exp $	*/
...
#include "includes.h"
__RCSID("$NetBSD: cipher-chachapoly-libcrypto.c,v 1.2.2.1 2023/11/02 22:15:21 sborrill Exp $");
