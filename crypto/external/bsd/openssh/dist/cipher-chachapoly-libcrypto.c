/*	$NetBSD: cipher-chachapoly-libcrypto.c,v 1.3.6.1 2026/05/07 17:49:23 martin Exp $	*/
...
#include "includes.h"
__RCSID("$NetBSD: cipher-chachapoly-libcrypto.c,v 1.3.6.1 2026/05/07 17:49:23 martin Exp $");
