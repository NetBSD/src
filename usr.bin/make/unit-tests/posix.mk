# $NetBSD: posix.mk,v 1.4 2025/04/13 09:29:33 rillig Exp $
#
...
#
# When being included from another file, this ".POSIX:" line occurs too late,
# though, and would thus switch out of POSIX mode again.
#
#.POSIX:
