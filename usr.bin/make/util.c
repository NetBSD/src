/*	$NetBSD: util.c,v 1.39.8.1 2007/09/03 07:05:32 wrstuden Exp $	*/
...
#ifndef MAKE_NATIVE
static char rcsid[] = "$NetBSD: util.c,v 1.39.8.1 2007/09/03 07:05:32 wrstuden Exp $";
#else
#include <sys/cdefs.h>
#ifndef lint
__RCSID("$NetBSD: util.c,v 1.39.8.1 2007/09/03 07:05:32 wrstuden Exp $");
#endif
#endif
