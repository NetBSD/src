/*	$NetBSD: util.c,v 1.39.6.1 2007/06/05 20:53:31 bouyer Exp $	*/
...
#ifndef MAKE_NATIVE
static char rcsid[] = "$NetBSD: util.c,v 1.39.6.1 2007/06/05 20:53:31 bouyer Exp $";
#else
#include <sys/cdefs.h>
#ifndef lint
__RCSID("$NetBSD: util.c,v 1.39.6.1 2007/06/05 20:53:31 bouyer Exp $");
#endif
#endif
