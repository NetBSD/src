/*	$NetBSD: util.c,v 1.51.4.1 2012/10/30 19:00:23 yamt Exp $	*/
...
#ifndef MAKE_NATIVE
static char rcsid[] = "$NetBSD: util.c,v 1.51.4.1 2012/10/30 19:00:23 yamt Exp $";
#else
#include <sys/cdefs.h>
#ifndef lint
__RCSID("$NetBSD: util.c,v 1.51.4.1 2012/10/30 19:00:23 yamt Exp $");
#endif
#endif
