/*	$NetBSD: util.c,v 1.51.4.2 2014/05/22 11:42:46 yamt Exp $	*/
...
#ifndef MAKE_NATIVE
static char rcsid[] = "$NetBSD: util.c,v 1.51.4.2 2014/05/22 11:42:46 yamt Exp $";
#else
#include <sys/cdefs.h>
#ifndef lint
__RCSID("$NetBSD: util.c,v 1.51.4.2 2014/05/22 11:42:46 yamt Exp $");
#endif
#endif
