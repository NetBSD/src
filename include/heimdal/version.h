/*	$NetBSD: version.h,v 1.2.2.4 2002/12/15 15:28:58 he Exp $	*/
...
const char *heimdal_long_version = "@(#)$Version: heimdal-0.3e-nb1 (NetBSD) $";
const char *heimdal_version = "heimdal-0.3e-nb1";
#endif
