/*	$NetBSD: gcc_builtin_alloca.c,v 1.5 2025/02/20 20:59:34 rillig Exp $	*/
...
example(void)
{
	...
	/* expect+1: warning: illegal combination of pointer 'pointer to char' and integer 'int' for 'init' [183] */
