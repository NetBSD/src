...
G_HOST_PRINT=l-print-rtl.o
G_HOST_RTL=l-rtl.o l-bitmap.o
G_HOST_RTLANAL=l-rtlanal.o
G_INCLUDES=-I. -I${DIST}/gcc -I${DIST}/gcc/config -I${DIST}/gcc/../include
G_md_file=${DIST}/gcc/config/sh/sh.md
