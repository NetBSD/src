...
G_RTL_H=rtl.h rtl.def machmode.h machmode.def ${GNUHOSTDIST}/gcc/config/arm/arm-modes.def genrtl.h
G_TREE_H=tree.h tree.def machmode.h machmode.def ${GNUHOSTDIST}/gcc/config/arm/arm-modes.def tree-check.h version.h builtins.def  location.h
G_HCONFIG_H=hconfig.h auto-build.h ${GNUHOSTDIST}/gcc/../include/ansidecl.h ${GNUHOSTDIST}/gcc/config/dbxelf.h ${GNUHOSTDIST}/gcc/config/elfos.h ${GNUHOSTDIST}/gcc/config/netbsd.h ${GNUHOSTDIST}/gcc/config/netbsd-elf.h ${GNUHOSTDIST}/gcc/config/arm/elf.h ${GNUHOSTDIST}/gcc/config/arm/aout.h ${GNUHOSTDIST}/gcc/config/arm/arm.h ${GNUHOSTDIST}/gcc/config/arm/netbsd-elf.h
