...
G_ALL_CPPFLAGS=  
G_C_AND_OBJC_OBJS=attribs.o c-errors.o c-lex.o c-pragma.o c-decl.o c-typeck.o  c-convert.o c-aux-info.o c-common.o c-opts.o c-format.o c-semantics.o  c-objc-common.o c-dump.o libcpp.a rs6000-c.o
G_C_OBJS=c-parse.o c-lang.o c-pretty-print.o attribs.o c-errors.o c-lex.o c-pragma.o c-decl.o c-typeck.o  c-convert.o c-aux-info.o c-common.o c-opts.o c-format.o c-semantics.o  c-objc-common.o c-dump.o libcpp.a rs6000-c.o
G_CCCP_OBJS=
...
G_OBJC_OBJS=objc-lang.o objc-parse.o objc-act.o attribs.o c-errors.o c-lex.o c-pragma.o c-decl.o c-typeck.o  c-convert.o c-aux-info.o c-common.o c-opts.o c-format.o c-semantics.o  c-objc-common.o c-dump.o libcpp.a rs6000-c.o
...
G_RTL_H=rtl.h rtl.def machmode.h machmode.def ${GNUHOSTDIST}/gcc/config/rs6000/rs6000-modes.def genrtl.h
G_TREE_H=tree.h tree.def machmode.h machmode.def ${GNUHOSTDIST}/gcc/config/rs6000/rs6000-modes.def tree-check.h version.h builtins.def  location.h
G_HCONFIG_H=hconfig.h auto-build.h ${GNUHOSTDIST}/gcc/../include/ansidecl.h ${GNUHOSTDIST}/gcc/config/rs6000/rs6000.h ${GNUHOSTDIST}/gcc/config/dbxelf.h ${GNUHOSTDIST}/gcc/config/elfos.h ${GNUHOSTDIST}/gcc/config/netbsd.h ${GNUHOSTDIST}/gcc/config/netbsd-elf.h ${GNUHOSTDIST}/gcc/config/freebsd-spec.h ${GNUHOSTDIST}/gcc/config/rs6000/sysv4.h ${GNUHOSTDIST}/gcc/config/rs6000/netbsd.h
...
G_host_xm_file=auto-host.h ansidecl.h  rs6000/rs6000.h dbxelf.h elfos.h netbsd.h netbsd-elf.h freebsd-spec.h rs6000/sysv4.h rs6000/netbsd.h defaults.h
G_host_xm_defines=POSIX
G_tm_p_file=rs6000/rs6000-protos.h
...
G_CXX_C_OBJS=attribs.o c-common.o c-format.o c-pragma.o c-semantics.o c-lex.o  c-dump.o rs6000-c.o c-pretty-print.o c-opts.o
...
G_LIBCPP_H=
G_ENABLE_SHARED=yes
G_SHLIB_LINK= ./xgcc -B./ -B/usr/local/powerpc--netbsd/bin/ -isystem /usr/local/powerpc--netbsd/include -isystem /usr/local/powerpc--netbsd/sys-include -O2  -DIN_GCC   -W -Wall -Wwrite-strings -Wstrict-prototypes -Wmissing-prototypes -isystem ./include   -g -DHAVE_GTHR_DEFAULT -DIN_LIBGCC2 -D__GCC_FLOAT_NOT_NEEDED -shared -nodefaultlibs  -Wl,--soname=@shlib_so_name@.so.1  -Wl,--version-script=@shlib_map_file@  -o @shlib_dir@@shlib_so_name@.so.1 @multilib_flags@ @shlib_objs@ -lc &&  rm -f @shlib_base_name@.so &&  ln -s @shlib_dir@@shlib_so_name@.so.1 @shlib_base_name@.so
G_SHLIB_MULTILIB=
