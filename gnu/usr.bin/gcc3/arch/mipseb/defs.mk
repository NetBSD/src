...
G_md_file=${GNUHOSTDIST}/gcc/config/mips/mips.md
...
G_HCONFIG_H=hconfig.h auto-build.h ${GNUHOSTDIST}/gcc/../include/ansidecl.h ${GNUHOSTDIST}/gcc/config/elfos.h ${GNUHOSTDIST}/gcc/config/mips/mips.h ${GNUHOSTDIST}/gcc/config/mips/netbsd.h
...
G_host_xm_file=auto-host.h ansidecl.h  elfos.h mips/mips.h mips/netbsd.h defaults.h
G_host_xm_defines=POSIX
G_tm_p_file=mips/mips-protos.h
G_target_cpu_default=(MASK_GAS|MASK_ABICALLS|MASK_GAS)
...
G_LIBCPP_H=
G_ENABLE_SHARED=yes
G_SHLIB_LINK= ./xgcc -B./ -B/usr/local/mipseb--netbsd/bin/ -isystem /usr/local/mipseb--netbsd/include -isystem /usr/local/mipseb--netbsd/sys-include -O2  -DIN_GCC   -W -Wall -Wwrite-strings -Wstrict-prototypes -Wmissing-prototypes -isystem ./include   -g -DHAVE_GTHR_DEFAULT -DIN_LIBGCC2 -D__GCC_FLOAT_NOT_NEEDED -shared -nodefaultlibs  -Wl,--soname=@shlib_so_name@.so.1  -Wl,--version-script=@shlib_map_file@  -o @shlib_dir@@shlib_so_name@.so.1 @multilib_flags@ @shlib_objs@ -lc &&  rm -f @shlib_base_name@.so &&  ln -s @shlib_dir@@shlib_so_name@.so.1 @shlib_base_name@.so
G_SHLIB_MULTILIB=
