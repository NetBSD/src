...
G_host_xm_file=auto-host.h ansidecl.h  pa/pa.h dbxelf.h elfos.h svr4.h netbsd.h netbsd-elf.h 		 pa/pa-netbsd.h pa/pa32-regs.h pa/pa32-netbsd.h defaults.h
G_host_xm_defines=POSIX
G_tm_p_file=pa/pa-protos.h
G_target_cpu_default=(MASK_PA_11 | MASK_NO_SPACE_REGS|MASK_GAS|MASK_JUMP_IN_DELAY)
...
G_LIBCPP_H=
G_ENABLE_SHARED=yes
G_SHLIB_LINK= ./xgcc -B./ -B/usr/local/hppa--netbsd/bin/ -isystem /usr/local/hppa--netbsd/include -isystem /usr/local/hppa--netbsd/sys-include -O2  -DIN_GCC   -W -Wall -Wwrite-strings -Wstrict-prototypes -Wmissing-prototypes -isystem ./include  -fPIC -DELF=1 -DNETBSD=1 -g -DHAVE_GTHR_DEFAULT -DIN_LIBGCC2 -D__GCC_FLOAT_NOT_NEEDED -shared -nodefaultlibs  -Wl,--soname=@shlib_so_name@.so.1  -Wl,--version-script=@shlib_map_file@  -o @shlib_dir@@shlib_so_name@.so.1 @multilib_flags@ @shlib_objs@ -lc &&  rm -f @shlib_base_name@.so &&  ln -s @shlib_dir@@shlib_so_name@.so.1 @shlib_base_name@.so
G_SHLIB_MULTILIB=
