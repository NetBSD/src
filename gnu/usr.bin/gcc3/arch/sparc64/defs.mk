...
G_HCONFIG_H=hconfig.h auto-build.h ${GNUHOSTDIST}/gcc/../include/ansidecl.h ${GNUHOSTDIST}/gcc/config/sparc/biarch64.h ${GNUHOSTDIST}/gcc/config/sparc/sparc.h ${GNUHOSTDIST}/gcc/config/dbxelf.h ${GNUHOSTDIST}/gcc/config/elfos.h ${GNUHOSTDIST}/gcc/config/svr4.h ${GNUHOSTDIST}/gcc/config/sparc/sysv4.h ${GNUHOSTDIST}/gcc/config/netbsd.h ${GNUHOSTDIST}/gcc/config/netbsd-elf.h ${GNUHOSTDIST}/gcc/config/sparc/netbsd-elf.h
...
G_host_xm_file=auto-host.h ansidecl.h  sparc/biarch64.h sparc/sparc.h dbxelf.h elfos.h svr4.h sparc/sysv4.h netbsd.h netbsd-elf.h sparc/netbsd-elf.h defaults.h
G_host_xm_defines=POSIX
G_tm_p_file=sparc/sparc-protos.h
G_target_cpu_default=TARGET_CPU_sparc64
...
G_ENABLE_SHARED=yes
G_SHLIB_LINK= ./xgcc -B./ -B/usr/local/sparc64--netbsd/bin/ -isystem /usr/local/sparc64--netbsd/include -isystem /usr/local/sparc64--netbsd/sys-include -O2  -DIN_GCC   -W -Wall -Wwrite-strings -Wstrict-prototypes -Wmissing-prototypes -isystem ./include   -g -DHAVE_GTHR_DEFAULT -DIN_LIBGCC2 -D__GCC_FLOAT_NOT_NEEDED -shared -nodefaultlibs  -Wl,--soname=@shlib_so_name@.so.1  -Wl,--version-script=@shlib_map_file@  -o @shlib_dir@@shlib_so_name@.so.1 @multilib_flags@ @shlib_objs@ -lc &&  rm -f @shlib_base_name@.so &&  ln -s @shlib_dir@@shlib_so_name@.so.1 @shlib_base_name@.so
G_SHLIB_MULTILIB=
