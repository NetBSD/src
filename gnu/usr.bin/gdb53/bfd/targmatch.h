...
{ "alpha*-*-netbsd*", NULL },{ "alpha*-*-freebsd*", NULL },{ "alpha*-*-openbsd*",
&bfd_elf64_alpha_vec },
#endif
...
{ "sparc64-*-freebsd*", NULL },{ "sparc64-*-netbsd*", NULL },{ "sparc64-*-openbsd*",
&bfd_elf64_sparc_vec },
#endif
...
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_littlearmqnx_vec)
...
{ "hppa*-*-*elf*", NULL },{ "hppa*-*-lites*", NULL },{ "hppa*-*-netbsd*", NULL },{ "hppa*-*-sysv4*", NULL },{ "hppa*-*-rtems*", NULL },{ "hppa*-*-openbsd*",
&bfd_elf32_hppa_vec },
#endif
...
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_i386qnx_vec)
...
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_powerpcqnx_vec)
...
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_powerpcleqnx_vec)
...
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_shqnx_vec)
