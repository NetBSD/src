...
static void
hppanbsd_fetch_registers (int regnum)
{
  ...
  if (regnum == -1 || hppanbsd_fpregset_supplies_p (regnum))
	...
	perror_with_name (_("Couldn't get floating point status"));
      ...
      hppanbsd_supply_fpregset (current_regcache, &fpregs);
    }
}
...
static void
hppanbsd_store_registers (int regnum)
{
  if (regnum == -1 || hppanbsd_gregset_supplies_p (regnum))
    {
      struct reg regs;
      ...
      hppanbsd_collect_gregset (current_regcache, &regs, regnum);
  ...
  if (regnum == -1 || hppanbsd_fpregset_supplies_p (regnum))
	...
	perror_with_name (_("Couldn't get floating point status"));
      ...
      hppanbsd_collect_fpregset (current_regcache, &fpregs, regnum);
