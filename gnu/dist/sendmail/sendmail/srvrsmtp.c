...
#ifndef lint
# if SMTP
static char id[] = "@(#)$Id: srvrsmtp.c,v 1.1.1.1 2000/05/03 09:27:23 itojun Exp $ (with SMTP)";
# else /* SMTP */
static char id[] = "@(#)$Id: srvrsmtp.c,v 1.1.1.1 2000/05/03 09:27:23 itojun Exp $ (without SMTP)";
# endif /* SMTP */
#endif /* ! lint */
