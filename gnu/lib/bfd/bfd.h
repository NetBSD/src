...
** NOTE: bfd.h and bfd-in2.h are normally GENERATED files, BUT:
** on NetBSD the GENERATED bfd.h is "tweaked" slightly by hand to
** allow this file to be used AS-IS on all machines running NetBSD.
** In particular, see "by hand" below.
 ...
 * (it also breaks GDB 4.16 unless ints are 64 bits.)
*/
